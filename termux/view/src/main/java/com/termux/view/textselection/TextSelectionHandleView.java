...
public class TextSelectionHandleView extends View {
    ...
    public TextSelectionHandleView(TerminalView terminalView, CursorController cursorController, int initialOrientation) {
        ...
        mHandleLeftDrawable = getContext().getDrawable(drawable.text_select_handle_left_material);
        mHandleRightDrawable = getContext().getDrawable(drawable.text_select_handle_right_material);
