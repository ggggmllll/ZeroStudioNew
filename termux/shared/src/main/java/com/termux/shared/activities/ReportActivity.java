...
public class ReportActivity extends BaseIDEActivity {
  ...
  public boolean onOptionsItemSelected(final MenuItem item) {
    ...
    if (id == R.id.menu_item_share_report) {
      ShareUtils.shareText(this, getString(string.title_report_text),
    ...
    if (reportStringSize > ACTIVITY_TEXT_SIZE_LIMIT_IN_BYTES) {
      ...
      Logger.logVerbose(LOG_TAG,
          mReportInfo.reportTitle + " report string total size " + reportStringSize
              + " is greater than " + ACTIVITY_TEXT_SIZE_LIMIT_IN_BYTES + " and will be truncated");
      mReportActivityMarkdownString = this.getString(string.msg_report_truncated) +
      ...
      mReportActivityMarkdownString =
          this.getString(string.msg_report_truncated) + reportString.toString();
    } else {
