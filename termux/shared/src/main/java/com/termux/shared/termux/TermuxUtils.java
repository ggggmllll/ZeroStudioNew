...
public class TermuxUtils {
    ...
    public static String isTermuxAppAccessible(@NonNull final Context currentPackageContext) {
        ...
        if (errmsg == null) {
            ...
            if (termuxPackageContext == null)
                errmsg = currentPackageContext.getString(string.error_termux_app_package_context_not_accessible);
            ...
            if (errmsg == null) {
                ...
                if (error != null)
                    errmsg = currentPackageContext.getString(string.error_termux_prefix_dir_path_not_accessible,
                        PackageUtils.getAppNameForPackage(currentPackageContext));
            }
        }

        if (errmsg != null)
            return errmsg + " " + currentPackageContext.getString(string.msg_termux_app_required_by_app,
                PackageUtils.getAppNameForPackage(currentPackageContext));
        else
            return null;
    }
    ...
    public static String getReportIssueMarkdownString(@NonNull final Context context) {
        ...
        markdownString.append("\n\n").append(context.getString(string.msg_report_issue, TermuxConstants.TERMUX_WIKI_URL)).append("\n");
