...
public class ShareUtils {
    ...
    public static void shareText(final Context context, final String subject, final String text, @Nullable final String title) {
        ...
        openSystemAppChooser(context, shareTextIntent, DataUtils.isNullOrEmpty(title) ? context.getString(string.title_share_with) : title);
    }
    ...
    public static void openUrl(final Context context, final String url) {
        ...
        try {
            ...
            openSystemAppChooser(context, intent, context.getString(string.title_open_url_with));
        } catch (Exception e) {
    ...
    public static void saveTextToFile(final Context context, final String label, final String filePath, final String text, final boolean showToast, final int storagePermissionRequestCode) {
        ...
        if ((FileUtils.isPathInDirPath(filePath, Environment.getExternalStorageDirectory().getAbsolutePath(), true) ||
            ...
            Logger.logErrorAndShowToast(context, LOG_TAG, context.getString(string.msg_storage_permission_not_granted));
        ...
        if (error != null) {
            ...
            if (showToast)
                Logger.showToast(context, context.getString(string.msg_file_saved_successfully, label, filePath), true);
        }
    }
