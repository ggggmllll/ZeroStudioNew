...
public class Logger {
    ...
    public static String getLogLevelLabel(final Context context, final int logLevel, final boolean addDefaultTag) {
        String logLabel;
        switch (logLevel) {
            case LOG_LEVEL_OFF: logLabel = context.getString(string.log_level_off); break;
            case LOG_LEVEL_NORMAL: logLabel = context.getString(string.log_level_normal); break;
            case LOG_LEVEL_DEBUG: logLabel = context.getString(string.log_level_debug); break;
            case LOG_LEVEL_VERBOSE: logLabel = context.getString(string.log_level_verbose); break;
            default: logLabel = context.getString(string.log_level_unknown); break;
        }
    ...
    public static int setLogLevel(Context context, int logLevel) {
        ...
        if (context != null)
            showToast(context, context.getString(string.log_level_value, getLogLevelLabel(context, CURRENT_LOG_LEVEL, false)),true);
