...
import com.termux.R;
import android.zero.studio.terminal.event.SystemEventReceiver;
import android.zero.studio.terminal.terminal.TermuxTerminalSessionFragmentClient;
import android.zero.studio.terminal.terminal.TermuxTerminalSessionServiceClient;
...
public final class TermuxService extends Service implements AppShell.AppShellClient, TermuxSession.TermuxSessionClient {
   ...
   public static class LocalBinder extends Binder implements Closeable {
     ...
     */
    private TermuxTerminalSessionFragmentClient mTermuxTerminalSessionActivityClient;
     ...
     * Currently called by {@link TermuxTerminalSessionFragmentClient#addNewSession(boolean, String)} to add a new {@link TermuxSession}.
     */
    @Nullable
    ...
    public synchronized TermuxSession createTermuxSession(ExecutionCommand executionCommand) {
        ...
        TermuxFragment.updateTermuxActivityStyling(this, false);
     ...
     * {@link TermuxService#mTermuxTerminalSessionFragmentClient} so that further terminal sessions are directly
     * passed the {@link TermuxTerminalSessionFragmentClient} object which fully implements the
     * {@link TerminalSessionClient} interface.
     *
     * @return Returns the {@link TermuxTerminalSessionFragmentClient} if {@link TermuxActivity} has bound with
     ...
     * earlier.
     *
     * @param termuxTerminalSessionActivityClient The {@link TermuxTerminalSessionFragmentClient} object that fully
     * implements the {@link TerminalSessionClient} interface.
     */
    public synchronized void setTermuxTerminalSessionClient(TermuxTerminalSessionFragmentClient termuxTerminalSessionActivityClient) {
