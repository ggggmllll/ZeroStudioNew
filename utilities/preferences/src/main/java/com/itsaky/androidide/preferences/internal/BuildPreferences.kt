 ...
 * @author android_zero
 *
 * This file centralizes all preference keys and accessors for build and run configurations.
 * - Added 'Clear Logcat before Run' preference key and accessor.
 */
...
object BuildPreferences {
  ...
  var clearLogcatBeforeRun: Boolean
    get() = prefManager.getBoolean(CLEAR_LOGCAT_BEFORE_RUN, true) // Default to true
    set(value) {
      prefManager.putBoolean(CLEAR_LOGCAT_BEFORE_RUN, value)
    }
}