...
package com.itsaky.androidide.templates.impl.cppDemo
...
internal fun AndroidModuleTemplateBuilder.cppDemoSrcKt(): String {
  return """
...
internal fun AndroidModuleTemplateBuilder.cppDemoSrcJava(): String {
  return """
package ${data.packageName};
