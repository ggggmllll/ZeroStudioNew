 ...
 *
 * Useful when rendering UI according to templates (e.g. visibility may depend on [isNewModule]). It
 * is not passed to the template renderer, in contrast to [TemplateData].
 *
