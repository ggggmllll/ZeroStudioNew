...
/**
 * Identifies special properties of the template. Downstream code often needs to treat certain
 * templates differently; this provides a mechanism for that, to avoid bending other fields (such as
 * name or category) to that purpose.
 */
