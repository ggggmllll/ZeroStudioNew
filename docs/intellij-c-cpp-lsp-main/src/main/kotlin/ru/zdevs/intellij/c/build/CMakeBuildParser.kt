...
class CMakeBuildParser(ctx: CBuildContext, private val path: String?) :
  ...
  override fun parse(
    ...
    messageConsumer.accept(
        OutputBuildEventImpl(getBuildId(), MakeBuildParser.withNewLine(line), true)
    )
  ...
  override fun getFilePath(file: String): File {
    return if (file.startsWith("/")) File(file) else File(path ?: "/", file)
  }
}
