...
open class CBuildAdapter(
  ...
  private val instantReader =
      BuildOutputInstantReaderImpl(ctx.buildId, ctx.buildId, buildProgressListener, listOf(parser))
  ...
  private fun onBuildOutputReaderFinish(
    ...
    val buildFinished =
        FinishBuildEventImpl(ctx.buildId, null, System.currentTimeMillis(), status, result)
