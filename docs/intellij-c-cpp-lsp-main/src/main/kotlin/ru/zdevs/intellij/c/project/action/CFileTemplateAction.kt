...
class CFileTemplateAction :
    CreateFileFromTemplateAction("C/C++ File", "Create new C/C++ File", Icons.C) {
  ...
  override fun createFileFromTemplate(
    ...
    if (template.name == "class") {
      val templateCpp =
          FileTemplateManager.getInstance(dir.project).getInternalTemplate("class.cpp")
