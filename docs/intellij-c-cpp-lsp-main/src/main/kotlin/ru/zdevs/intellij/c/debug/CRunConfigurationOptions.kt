...
class CRunConfigurationOptions : DAPRunConfigurationOptions() {
  private val stopAtMainProp: StoredProperty<Boolean> =
      property(true).provideDelegate(this, "stopAtMain")
  private val launchArgumentsProp: StoredProperty<String?> =
      string(null).provideDelegate(this, "launchArguments")
