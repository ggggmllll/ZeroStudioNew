...
/**
 * A powerful code formatter for Kotlin files that uses the 'ktfmt' library from Facebook. complex
 * reflowing and chained calls gracefully.
 */
class KotlinFormatter(private val options: KotlinFormatOptions = KotlinFormatOptions()) :
    CodeFormatter {
