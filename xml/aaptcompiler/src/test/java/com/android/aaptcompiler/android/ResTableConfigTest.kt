...
class ResTableConfigTest {
  ...
  fun testLocaleIsMoreSpecificThan() {
    ...
    val localeVariant =
        ResTableConfig(localeVariant = byteArrayOf(0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08))
    val scriptComputed =
        ResTableConfig(
  ...
  fun testLocaleCompare() {
    ...
    val localeNoCountryWithScript1 =
        ResTableConfig(language = ResTableConfig.ENGLISH, localeScript = byteArrayOf(1, 2, 3, 4))
    val localeNoCountryWithScript2 =
        ResTableConfig(language = ResTableConfig.ENGLISH, localeScript = byteArrayOf(1, 2, 3, 5))
  ...
  fun testIsBetterThan() {
    ...
    val screenSize2 =
        ResTableConfig(screenWidth = requested.screenWidth, screenHeight = requested.screenHeight)
    ...
    val gamut =
        ResTableConfig(
            colorMode =
                (requested.colorMode.toInt() and ResTableConfig.COLOR_MODE.WIDE_GAMUT_MASK).toByte()
        )
    val round =
        ResTableConfig(
            screenLayout2 =
                (requested.screenLayout2.toInt() and ResTableConfig.SCREEN_LAYOUT2.SCREENROUND_MASK)
                    .toByte()
        )
    val long =
        ResTableConfig(
            screenLayout =
                (requested.screenLayout.toInt() and ResTableConfig.SCREEN_LAYOUT.SCREENLONG_MASK)
                    .toByte()
        )
    val sizeFlag =
        ResTableConfig(
            screenLayout =
                (requested.screenLayout.toInt() and ResTableConfig.SCREEN_LAYOUT.SIZE_MASK).toByte()
        )
    ...
    val screenDir =
        ResTableConfig(
            screenLayout =
                (requested.screenLayout.toInt() and ResTableConfig.SCREEN_LAYOUT.DIR_MASK).toByte()
        )
    ...
    val config9 =
        ResTableConfig(
            ...
            (ResTableConfig.SCREEN_LAYOUT.DIR_LTR.toInt() or
                    ...
                    ResTableConfig.SCREEN_LAYOUT.SCREENLONG_YES.toInt())
                .toByte(),
            (ResTableConfig.UI_MODE.NIGHT_NO.toInt() or ResTableConfig.UI_MODE.TYPE_DESK.toInt())
                .toByte(),
            480,
            480,
            640,
