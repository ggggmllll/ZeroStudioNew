...
class FloatParsingTest {
   ...
   *
   * This tests goes over ~2 billion different float values, and takes ~1 hour for full computation.
   * As such this test is set to be ignored, but should be enabled if float parsing is modified
   * significantly.
   */
  @Test
  @Ignore("b/303076368")
