package android.zero.studio.layouteditor.vectormaster.models;
...
import android.zero.studio.layouteditor.vectormaster.DefaultValues;
import android.zero.studio.layouteditor.vectormaster.utilities.Utils;
import android.zero.studio.layouteditor.vectormaster.utilities.parser.PathParser;
...
public class PathModel {
    ...
    public void buildPath(boolean useLegacyParser) {
        if (pathData != null) {
            if (useLegacyParser) {
                originalPath =
                    android.zero.studio.layouteditor.vectormaster.utilities.legacyparser.PathParser
