...
object DefaultValues {
  ...
  @JvmField val PATH_STROKE_LINE_CAP: Cap = Cap.BUTT

  @JvmField val PATH_STROKE_LINE_JOIN: Join = Join.ROUND
  ...
  @JvmField val PATH_FILL_TYPE: FillType = FillType.WINDING
  ...
  var PATH_ATTRIBUTES: Array<String> =
      arrayOf(
          "name",
          "fillAlpha",
          "fillColor",
