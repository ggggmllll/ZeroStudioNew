...
object Timeout {
  ...
  init {
    Timeouts.entries.forEach { timeouts[it] = it.defaultTimeout }
  }

  /**
   * Get the timeout for a request. The [type] is the request type and the result is the timeout in
   * milliseconds
   */
  ...
  /**
   * Set the timeout for a request. The [type] is the request type and the [time] is the timeout in
   * milliseconds
   */
