...
internal fun List<Diagnostic>.transformToEditorDiagnostics(
    editor: CodeEditor
...
fun ServerCapabilities.merge(other: ServerCapabilities?) {
  ...
  setIfMissing(
      ServerCapabilities::getPositionEncoding,
      ServerCapabilities::setPositionEncoding,
      other.getPositionEncoding(),
  )
  setIfMissing(
      ServerCapabilities::getTextDocumentSync,
      ServerCapabilities::setTextDocumentSync,
      other.getTextDocumentSync(),
  )
  setIfMissing(
      ServerCapabilities::getNotebookDocumentSync,
      ServerCapabilities::setNotebookDocumentSync,
      other.getNotebookDocumentSync(),
  )
  setIfMissing(
      ServerCapabilities::getHoverProvider,
      ServerCapabilities::setHoverProvider,
      other.getHoverProvider(),
  )
  setIfMissing(
      ServerCapabilities::getCompletionProvider,
      ServerCapabilities::setCompletionProvider,
      other.getCompletionProvider(),
  )
  setIfMissing(
      ServerCapabilities::getSignatureHelpProvider,
      ServerCapabilities::setSignatureHelpProvider,
      other.getSignatureHelpProvider(),
  )
  setIfMissing(
      ServerCapabilities::getDefinitionProvider,
      ServerCapabilities::setDefinitionProvider,
      other.getDefinitionProvider(),
  )
  setIfMissing(
      ServerCapabilities::getTypeDefinitionProvider,
      ServerCapabilities::setTypeDefinitionProvider,
      other.getTypeDefinitionProvider(),
  )
  setIfMissing(
      ServerCapabilities::getImplementationProvider,
      ServerCapabilities::setImplementationProvider,
      other.getImplementationProvider(),
  )
  setIfMissing(
      ServerCapabilities::getReferencesProvider,
      ServerCapabilities::setReferencesProvider,
      other.getReferencesProvider(),
  )
  setIfMissing(
      ServerCapabilities::getDocumentHighlightProvider,
      ServerCapabilities::setDocumentHighlightProvider,
      other.getDocumentHighlightProvider(),
  )
  setIfMissing(
      ServerCapabilities::getDocumentSymbolProvider,
      ServerCapabilities::setDocumentSymbolProvider,
      other.getDocumentSymbolProvider(),
  )
  setIfMissing(
      ServerCapabilities::getWorkspaceSymbolProvider,
      ServerCapabilities::setWorkspaceSymbolProvider,
      other.getWorkspaceSymbolProvider(),
  )
  setIfMissing(
      ServerCapabilities::getCodeActionProvider,
      ServerCapabilities::setCodeActionProvider,
      other.getCodeActionProvider(),
  )
  setIfMissing(
      ServerCapabilities::getCodeLensProvider,
      ServerCapabilities::setCodeLensProvider,
      other.getCodeLensProvider(),
  )
  setIfMissing(
      ServerCapabilities::getDocumentFormattingProvider,
      ServerCapabilities::setDocumentFormattingProvider,
      other.getDocumentFormattingProvider(),
  )
  setIfMissing(
      ServerCapabilities::getDocumentRangeFormattingProvider,
      ServerCapabilities::setDocumentRangeFormattingProvider,
      other.getDocumentRangeFormattingProvider(),
  )
  setIfMissing(
      ServerCapabilities::getDocumentOnTypeFormattingProvider,
      ServerCapabilities::setDocumentOnTypeFormattingProvider,
      other.getDocumentOnTypeFormattingProvider(),
  )
  setIfMissing(
      ServerCapabilities::getRenameProvider,
      ServerCapabilities::setRenameProvider,
      other.getRenameProvider(),
  )
  setIfMissing(
      ServerCapabilities::getDocumentLinkProvider,
      ServerCapabilities::setDocumentLinkProvider,
      other.getDocumentLinkProvider(),
  )
  setIfMissing(
      ServerCapabilities::getColorProvider,
      ServerCapabilities::setColorProvider,
      other.getColorProvider(),
  )
  setIfMissing(
      ServerCapabilities::getFoldingRangeProvider,
      ServerCapabilities::setFoldingRangeProvider,
      other.getFoldingRangeProvider(),
  )
  setIfMissing(
      ServerCapabilities::getDeclarationProvider,
      ServerCapabilities::setDeclarationProvider,
      other.getDeclarationProvider(),
  )
  setIfMissing(
      ServerCapabilities::getExecuteCommandProvider,
      ServerCapabilities::setExecuteCommandProvider,
      other.getExecuteCommandProvider(),
  )
  setIfMissing(
      ServerCapabilities::getWorkspace,
      ServerCapabilities::setWorkspace,
      other.getWorkspace(),
  )
  setIfMissing(
      ServerCapabilities::getTypeHierarchyProvider,
      ServerCapabilities::setTypeHierarchyProvider,
      other.getTypeHierarchyProvider(),
  )
  setIfMissing(
      ServerCapabilities::getCallHierarchyProvider,
      ServerCapabilities::setCallHierarchyProvider,
      other.getCallHierarchyProvider(),
  )
  setIfMissing(
      ServerCapabilities::getSelectionRangeProvider,
      ServerCapabilities::setSelectionRangeProvider,
      other.getSelectionRangeProvider(),
  )
  setIfMissing(
      ServerCapabilities::getLinkedEditingRangeProvider,
      ServerCapabilities::setLinkedEditingRangeProvider,
      other.getLinkedEditingRangeProvider(),
  )
  setIfMissing(
      ServerCapabilities::getSemanticTokensProvider,
      ServerCapabilities::setSemanticTokensProvider,
      other.getSemanticTokensProvider(),
  )
  setIfMissing(
      ServerCapabilities::getMonikerProvider,
      ServerCapabilities::setMonikerProvider,
      other.getMonikerProvider(),
  )
  setIfMissing(
      ServerCapabilities::getInlayHintProvider,
      ServerCapabilities::setInlayHintProvider,
      other.getInlayHintProvider(),
  )
  setIfMissing(
      ServerCapabilities::getInlineValueProvider,
      ServerCapabilities::setInlineValueProvider,
      other.getInlineValueProvider(),
  )
  setIfMissing(
      ServerCapabilities::getDiagnosticProvider,
      ServerCapabilities::setDiagnosticProvider,
      other.getDiagnosticProvider(),
  )
  setIfMissing(
      ServerCapabilities::getExperimental,
      ServerCapabilities::setExperimental,
      other.getExperimental(),
  )
}
