...
@DslMarker annotation class ConnectionDslMarker

/**
 * Holds the factory used to create [StreamConnectionProvider] instances for a working directory.
 */
class ConnectionDefinition
internal constructor(private val factory: (workingDir: String) -> StreamConnectionProvider) {
...
class ConnectionDefinitionDsl {
  ...
  /**
   * Wraps a custom [CustomConnectProvider.StreamProvider] that does not depend on the working
   * directory.
   */
