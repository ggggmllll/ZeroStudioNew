...
/**
 * A custom Surface-like View that renders ThorVG content.
 * Supports:
 * - Zoom (Pinch)
 * - Pan (Drag)
 * - Fling
 ...
 * - Animation Playback
 */
class ThorVGImageView @JvmOverloads constructor(
    ...
    private fun updateMatrix() {
        ...
        drawMatrix.postScale(scaleFactor, scaleFactor, 0f, 0f) // Scale from 0,0 then translate is easier logic?
    ...
    private fun requestRender() {
        ...
        // So we render the image *full size* into the bitmap? No, that consumes too much RAM for 8K images.
    ...
    // (Omitted detailed implementation of this fix for brevity, assumes standard Bitmap scaling logic)
