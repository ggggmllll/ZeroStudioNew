...
/**
 * A view that renders the RGBA/Luma histogram (Peak Map). Data source: int[1024] from
 * ThorVG.getHistogram() Layout: 0-255 Red, 256-511 Green, 512-767 Blue, 768-1023 Luma
 */
class HistogramView
@JvmOverloads
