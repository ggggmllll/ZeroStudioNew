...
fun String.normalizeIndentation(tabSize: Int, insertSpaces: Boolean): String {
  ...
  return substring(0, firstNonWhitespaceIndex)
      .normalizeIndentationFromWhitespace(tabSize, insertSpaces) +
...
fun String.getIndentationFromWhitespace(tabSize: Int, insertSpaces: Boolean): String {
  ...
  val spaces = if (insertSpaces) " ".repeat(tabSize) else ""
...
fun String.normalizeIndentationFromWhitespace(tabSize: Int, insertSpaces: Boolean): String {
  var spacesCnt = 0
...
fun Content.getLinePrefixingWhitespaceAtPosition(position: CharPosition): String {
  ...
  val startIndex = IntPair.getFirst(TextUtils.findLeadingAndTrailingWhitespacePos(line))
