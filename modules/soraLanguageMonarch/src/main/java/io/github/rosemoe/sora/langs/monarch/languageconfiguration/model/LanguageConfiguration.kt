...
data class LanguageConfiguration(
    ...
    /**
     * The language's word definition. If the language supports Unicode identifiers (e.g.
     * JavaScript), it is preferable to provide a word definition that uses exclusion of known
     * separators. e.g.: A regex that matches anything except known separators (and dot is allowed
    ...
    /**
     * Defines a list of bracket pairs that are colorized depending on their nesting level. If not
     ...
     * when using the \'languageDefined\' autoclosing setting.
     *
     * This is typically the set of characters which can not start an expression, such as
     * whitespace, closing brackets, non-unary operators, etc.
     */
