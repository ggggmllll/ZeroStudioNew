 ...
 * It represents the essential contract a project module must fulfill to provide information for the
 * Kotlin compiler environment. Any class like `ModuleProject` can implement this.
 */
interface KotlinModule {
  ...
  /**
   * The path to the `android.jar` for this module's compile SDK version. Null for non-Android
   * modules.
   */
