...
class DisclaimerFragment :
    FragmentWithBinding<FragmentOnboardingDisclaimerBinding>(
        FragmentOnboardingDisclaimerBinding::inflate
    ),
    SlidePolicy {
  ...
  override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
    ...
    binding.agreeCheckbox.setOnCheckedChangeListener { _, isChecked -> isAgreed = isChecked }
  }
  ...
  override fun onUserIllegallyRequestedNextPage() {
    Toast.makeText(
            requireContext(),
            "Please read and agree to the Disclaimer and Privacy Agreement first.",
            Toast.LENGTH_SHORT,
        )
        .show()
  }
