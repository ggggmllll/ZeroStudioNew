...
class FileTreeViewHolder(context: Context) : TreeNode.BaseNodeViewHolder<File>(context) {
    ...
    private fun initColors() {
        ...
        highlightColor = if (context.theme.resolveAttribute(
    ...
    override fun toggle(active: Boolean) {
        binding?.filetreeChevron?.animate()
    ...
    private fun applyPadding(node: TreeNode, binding: LayoutRecyclerviewFiletreeItemBinding, padding: Int): View {
