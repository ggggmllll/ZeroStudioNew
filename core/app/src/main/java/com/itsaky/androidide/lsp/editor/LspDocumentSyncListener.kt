...
/**
 * LSP 文档同步监听器。 负责捕获 Sora 编辑器的文本变更事件并转发给 LSP 服务器（didChange）。
 *
 * 工作流程： [Editor ContentChangeEvent] -> [Check Connection] -> [Launch IO Scope] ->
 ...
 * @author android_zero
 */
class LspDocumentSyncListener(private val connector: BaseLspConnector, private val file: File) :
