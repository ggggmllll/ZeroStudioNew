...
/** 搜索结果列表适配器 */
class AdvancedSearchResultsAdapter(private val onItemClick: (SearchResultItem) -> Unit) :
  ...
  override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
    ...
    return when (viewType) {
      TYPE_FILE_HEADER ->
          FileHeaderHolder(ItemSearchFileHeaderBinding.inflate(inflater, parent, false))
      TYPE_TEXT_MATCH ->
          TextMatchHolder(ItemSearchTextMatchBinding.inflate(inflater, parent, false))
  ...
  class FileHeaderHolder(val binding: ItemSearchFileHeaderBinding) :
  ...
  class TextMatchHolder(val binding: ItemSearchTextMatchBinding) :
      RecyclerView.ViewHolder(binding.root) {
