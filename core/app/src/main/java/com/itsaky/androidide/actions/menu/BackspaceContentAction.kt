...
/**
 * 中文注释: 像软键盘删除键一样删除内容。如果有选区，则删除选区内容；如果没有选区，则删除光标前的一个字符。 English annotation: Delete content like the
 * soft keyboard delete key. If there is a selection, delete the selection; otherwise, delete the
