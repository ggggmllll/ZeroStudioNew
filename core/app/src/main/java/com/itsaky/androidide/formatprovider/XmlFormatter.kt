...
class XmlFormatter(
  ...
  private val indentRuleEngine =
      mapOf(
          "LinearLayout" to defaultRule,
          "RelativeLayout" to defaultRule,
          "FrameLayout" to defaultRule,
          "ConstraintLayout" to defaultRule,
          "CoordinatorLayout" to defaultRule,
          "MotionLayout" to defaultRule,
          "ScrollView" to defaultRule,
          "HorizontalScrollView" to defaultRule,
          "manifest" to defaultRule,
          "application" to defaultRule,
          "activity" to defaultRule,
          "service" to defaultRule,
          "receiver" to defaultRule,
          "provider" to defaultRule,
          "intent-filter" to defaultRule,
          ...
          "TextView" to defaultRule,
          "ImageView" to defaultRule,
          "Button" to defaultRule,
          "EditText" to defaultRule,
          "View" to defaultRule,
          "ProgressBar" to defaultRule,
          ...
          "dimen" to
              IndentRule(indentChildren = false, keepSpaceWithin = true, isBlockElement = false),
          "color" to
              IndentRule(indentChildren = false, keepSpaceWithin = true, isBlockElement = false),
          "integer" to
              IndentRule(indentChildren = false, keepSpaceWithin = true, isBlockElement = false),
  ...
  override fun format(source: String): String {
    ...
    val isAndroidXml =
        source.contains("http://schemas.android.com/apk/res/android") ||
  ...
  private val attributeComparator =
      Comparator<Attribute> { a1, a2 ->
        val order1 = getAttributeOrder(a1)
        val order2 = getAttributeOrder(a2)
