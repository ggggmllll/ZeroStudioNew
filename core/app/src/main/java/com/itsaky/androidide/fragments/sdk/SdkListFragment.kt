...
/**
 * A fragment that displays a list of SDK packages, allowing users to install or remove them. It
 * observes a shared [SdkManagerViewModel] for data and communicates with [SdkManagerService] to
...
class SdkListFragment : Fragment(R.layout.fragment_sdk_list) {
  ...
  override fun onResume() {
    ...
    LocalBroadcastManager.getInstance(requireContext())
        .registerReceiver(
            broadcastReceiver,
            IntentFilter(SdkManagerService.ACTION_SDK_MANAGER_UPDATE),
        )
  }
