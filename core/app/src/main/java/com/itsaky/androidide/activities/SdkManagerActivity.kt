...
/**
 * SdkManagerActivity is the main screen for managing Android SDK components. It uses a ViewPager2
 * with a TabLayout to display different categories of SDK packages.
 *
 * @author android_zero
 */
