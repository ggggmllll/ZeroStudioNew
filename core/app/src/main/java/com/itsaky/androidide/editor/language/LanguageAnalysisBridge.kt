...
object LanguageAnalysisBridge {
  ...
  private fun resetAnalyzeManagerWithoutReference(manager: TsAnalyzeManager, content: Content) {
    try {
      val method = manager.javaClass.getMethod("reset", Content::class.java, Bundle::class.java)
      ...
      val method = manager.javaClass.getMethod("reset", referenceClass, Bundle::class.java)
