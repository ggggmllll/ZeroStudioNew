 ...
 *
 * @param name The user-friendly name displayed in the selection dialog (e.g., "Public Static
 *   Method").
 * @param template The code template itself. Uses %s for name substitution and $0 for final cursor
 *   position.
