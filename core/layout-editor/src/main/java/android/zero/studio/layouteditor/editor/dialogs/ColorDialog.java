package android.zero.studio.layouteditor.editor.dialogs;
...
import android.zero.studio.layouteditor.databinding.LayoutColorDialogBinding;
import android.zero.studio.layouteditor.views.ColorView;
...
public class ColorDialog extends AttributeDialog
    ...
    public ColorDialog(Context context, String savedValue) {
        ...
        android.zero.studio.layouteditor.databinding.LayoutColorDialogBinding binding = LayoutColorDialogBinding.inflate(getDialog().getLayoutInflater());
