...
import android.zero.studio.layouteditor.databinding.LayoutSelectDpiItemBinding
...
class DPIsListAdapter(private val image: Drawable) : RecyclerView.Adapter<DPIsListAdapter.VH>() {
  ...
  override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): VH {
    return VH(
        LayoutSelectDpiItemBinding.inflate(LayoutInflater.from(parent.context), parent, false)
    )
  }
