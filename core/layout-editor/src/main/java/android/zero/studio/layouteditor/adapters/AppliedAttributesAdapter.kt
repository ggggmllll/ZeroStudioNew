...
import android.zero.studio.layouteditor.databinding.ShowAttributeItemBinding
...
class AppliedAttributesAdapter(
  ...
  class VH(var binding: ShowAttributeItemBinding) : RecyclerView.ViewHolder(binding.root) {
  ...
  override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): VH {
    return VH(ShowAttributeItemBinding.inflate(LayoutInflater.from(parent.context), parent, false))
  }
