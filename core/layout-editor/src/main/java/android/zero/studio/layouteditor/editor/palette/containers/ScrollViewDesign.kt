package android.zero.studio.layouteditor.editor.palette.containers
...
class ScrollViewDesign @JvmOverloads constructor(context: Context, attrs: AttributeSet? = null) :
