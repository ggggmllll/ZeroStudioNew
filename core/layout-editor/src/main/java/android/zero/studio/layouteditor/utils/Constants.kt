...
object Constants {
  ...
  @JvmField val gravityMap = HashMap<String, Int>()

  @JvmField val inputTypes = HashMap<String, Int>()

  @JvmField val imeOptions = HashMap<String, Int>()

  @JvmField val visibilityMap = HashMap<String, Int>()

  @JvmField val textStyleMap = HashMap<String, Int>()
  ...
  @JvmField val BLUEPRINT_BACKGROUND_COLOR = Color.parseColor("#235C6F")

  @JvmField val DESIGN_DASH_COLOR = Color.parseColor("#1689F6")
  ...
  init {
    ...
    inputTypes["date"] = InputType.TYPE_DATETIME_VARIATION_DATE
    ...
    inputTypes["numberSigned"] = InputType.TYPE_NUMBER_FLAG_SIGNED
    inputTypes["numberPassword"] = InputType.TYPE_NUMBER_VARIATION_PASSWORD
    ...
    inputTypes["textPassword"] = InputType.TYPE_TEXT_VARIATION_PASSWORD
    inputTypes["textPersonName"] = InputType.TYPE_TEXT_VARIATION_PERSON_NAME
    inputTypes["textPhonetic"] = InputType.TYPE_TEXT_VARIATION_PHONETIC
    ...
    inputTypes["textUri"] = InputType.TYPE_TEXT_VARIATION_URI
    inputTypes["textVisiblePassword"] = InputType.TYPE_TEXT_VARIATION_VISIBLE_PASSWORD
    inputTypes["textWebEditText"] = InputType.TYPE_TEXT_VARIATION_WEB_EDIT_TEXT
    inputTypes["textWebEmailAddress"] = InputType.TYPE_TEXT_VARIATION_WEB_EMAIL_ADDRESS
    inputTypes["textWebPassword"] = InputType.TYPE_TEXT_VARIATION_WEB_PASSWORD
    inputTypes["time"] = InputType.TYPE_DATETIME_VARIATION_TIME
