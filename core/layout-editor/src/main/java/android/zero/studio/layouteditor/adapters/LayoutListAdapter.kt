...
class LayoutListAdapter(val project: ProjectFile) : RecyclerView.Adapter<LayoutListAdapter.VH>() {
  ...
  private val sessionGradientColors: IntArray by lazy {
    ...
    IntArray(colorCount) {
      ...
      Color.rgb(random.nextInt(220), random.nextInt(220), random.nextInt(220))
    }
  }
  ...
  override fun onBindViewHolder(holder: VH, position: Int) {
    ...
    val gradientDrawable =
        GradientDrawable(GradientDrawable.Orientation.BL_TR, sessionGradientColors).apply {
          cornerRadius = 8f
        }
