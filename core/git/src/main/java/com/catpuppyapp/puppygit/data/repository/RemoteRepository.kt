...
interface RemoteRepository {
  ...
  //    suspend fun updateByRepoIdAndRemoteName(repoId: String, remoteName: String, item:
  // RemoteEntity)
  ...
  suspend fun updateFetchAndPushCredentialIdByRemoteId(
      remoteId: String,
      fetchCredentialId: String,
      pushCredentialId: String,
  )

  suspend fun updateFetchAndPushCredentialIdByCredentialId(
