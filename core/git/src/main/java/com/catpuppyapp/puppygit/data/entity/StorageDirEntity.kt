...
data class StorageDirEntity(
    @PrimaryKey var id: String = getShortUUID(), // 用途：例如仓库页面的设置、commit页面的设置、changelist页面的设置，等
    ...
    @Embedded var baseFields: BaseFields = BaseFields(baseStatus = StorageDirCons.Status.ok),
)
