...
fun DiffCommitsDialog(
  ...
  ConfirmDialog(
      ...
      textCompose = {
        ...
        ScrollableColumn {
          MySelectionContainer { Text(text = stringResource(R.string.compare_left_to_right)) }
          ...
          MySelectionContainer {
            Text(
                text =
                    stringResource(
                        R.string.note_leave_commit_hash_empty_to_compare_with_local_worktree
                    ),
          ...
          TextField(
              modifier = Modifier.fillMaxWidth().focusRequester(commit1FocusRequest),
              value = commit1.value,
              singleLine = true,
              onValueChange = { commit1.value = it },
          ...
          TextField(
              modifier = Modifier.fillMaxWidth().focusRequester(commit2FocusRequest),
              value = commit2.value,
              singleLine = true,
              onValueChange = { commit2.value = it },
              label = { Text(stringResource(R.string.right)) },
              placeholder = { Text(stringResource(R.string.hash_branch_tag)) },
          )
        }
      },
