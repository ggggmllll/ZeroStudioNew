...
// See also
// https://android.googlesource.com/platform/frameworks/base.git/+/master/core/java/com/android/internal/util/MimeIconUtils.java
// See also
...
val MimeType.icon: MimeTypeIcon
  get() =
      mimeTypeToIconMap[this]
          ?: typeToIconMap[type]
          ?: suffix?.let { suffixToIconMap[it] }
          ?: MimeTypeIcon.GENERIC

// See also https://mimesniff.spec.whatwg.org/#mime-type-groups
private val mimeTypeToIconMap =
    mapOf(
            ...
            "application/vnd.openxmlformats-officedocument.wordprocessingml.document" to
                MimeTypeIcon.WORD,
            "application/vnd.openxmlformats-officedocument.wordprocessingml.template" to
                MimeTypeIcon.WORD,
            "application/vnd.ms-excel" to MimeTypeIcon.EXCEL,
            "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet" to
                MimeTypeIcon.EXCEL,
            "application/vnd.openxmlformats-officedocument.spreadsheetml.template" to
                MimeTypeIcon.EXCEL,
            ...
            "application/vnd.openxmlformats-officedocument.presentationml.slideshow" to
                MimeTypeIcon.POWERPOINT,
            "application/vnd.openxmlformats-officedocument.presentationml.template" to
                MimeTypeIcon.POWERPOINT,
        )
...
private val suffixToIconMap =
    mapOf("json" to MimeTypeIcon.CODE, "xml" to MimeTypeIcon.CODE, "zip" to MimeTypeIcon.ARCHIVE)
