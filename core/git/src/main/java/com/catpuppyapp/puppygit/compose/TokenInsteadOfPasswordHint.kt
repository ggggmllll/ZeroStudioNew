    ...
    DefaultPaddingRow {
      Text(
          buildAnnotatedString {
            ...
            withLink(
                LinkAnnotation.Url("https://docs.gitlab.com/user/profile/personal_access_tokens/")
            ) {
              withStyle(
                  style =
                      SpanStyle(
            ...
            withLink(
                LinkAnnotation.Url(
                    "https://confluence.atlassian.com/bitbucketserver076/personal-access-tokens-1026534797.html"
                )
            ) {
              withStyle(
                  style =
