...
private fun AcceptButtons_LongPressedIcon(
  ...
  Row(
    ...
    LongPressAbleIconBtn(
        ...
        iconModifier =
            Modifier.border(width = borderWidth, color = acceptOursColor, shape = iconShape),
    ) {
    ...
    LongPressAbleIconBtn(
        ...
        iconModifier =
            Modifier.border(width = borderWidth, color = acceptTheirsColor, shape = iconShape),
    ) {
    ...
    LongPressAbleIconBtn(
        ...
        iconModifier =
            Modifier.border(width = borderWidth, color = acceptBothColor, shape = iconShape),
    ) {
    ...
    LongPressAbleIconBtn(
        ...
        iconModifier =
            Modifier.border(width = borderWidth, color = rejectBothColor, shape = iconShape),
    ) {
