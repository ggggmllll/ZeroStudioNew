...
fun FileHistoryItem(
  ...
  Column(
    ...
    Row(
      ...
      InLineIcon(icon = Icons.Filled.Commit, tooltipText = stringResource(R.string.commit_id))
        ...
        Text(
            text =
                if (shouldShowTimeZoneInfo)
                    TimeZoneUtil.appendUtcTimeZoneText(dto.dateTime, dto.originTimeOffsetInMinutes)
                else dto.dateTime,
            maxLines = 1,
            overflow = TextOverflow.Ellipsis,
            fontWeight = defaultFontWeight,
