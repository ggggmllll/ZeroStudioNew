...
class EditorPreviewNavStackItem(
    val path: String = "",
    val scrollState: ScrollState = newScrollState(),
) {
...
class EditorPreviewNavStack internal constructor(var root: String) {
  ...
  // after a stack action(e.g. ahead/back) finished, this value should same as page state
  // `previewPath` and  `previewNavStack.getCurrent()`
