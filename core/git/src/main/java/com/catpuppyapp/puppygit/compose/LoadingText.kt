...
fun LoadingTextSimple(
  ...
  LoadingText(contentPadding = contentPadding, text = { Text(text = text) })
}
...
fun LoadingTextUnScrollable(
  ...
  LoadingText(contentPadding = contentPadding, scrollState = null, text = { Text(text = text) })
}
  ...
  LoadingText(
      ...
      text = {
        ...
        if (showCancel) {
          ...
          SingleLineClickableText(cancelText) { onCancel() }
        }
      },
  )
}
