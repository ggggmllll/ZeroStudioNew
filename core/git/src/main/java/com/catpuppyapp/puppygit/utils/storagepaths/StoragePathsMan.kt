...
object StoragePathsMan {
  ...
  fun init(
      saveDir: File,
      oldSettingsStoragePaths: List<String>?,
      oldSettingsLastSelectedPath: String?,
  ) {
  ...
  private fun readFromFile() {
    ...
    try {
      ...
      MyLog.e(
          TAG,
          "#readFromFile: read err, file content empty or corrupted, will return a new object, err is: ${e.localizedMessage}",
      )
    }
  }
  ...
  private fun migrateFromOldSettings(
      oldSettingsStoragePaths: List<String>,
      oldSettingsLastSelectedPath: String,
  ) {
    try {
