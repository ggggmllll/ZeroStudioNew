...
/**
 * Repository that provides insert, update, delete, and retrieve of [StorageDirEntity] from a given
 * data source.
 */
...
interface StorageDirRepository {
  ...
  //     */
  //    suspend fun delete(item: StorageDirEntity, requireDelFilesOnDisk:Boolean=false,
  ...
  //    suspend fun getByNameOrFullPathExcludeId(name: String, fullPath: String, excludeId:String):
  // StorageDirEntity?
  //    suspend fun isNameOrFullPathAlreadyUsedByOtherItem(name: String, fullPath: String,
