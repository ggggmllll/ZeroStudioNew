...
data class DevSettings(
    ...
    /** 在按单词匹配失败时降级为按字符匹配。 对非空格分隔的语言友好，反之不好 */
    ...
    /**
     * 若为true，使用之前加载changelist的方法，多jni，少数据拷贝，循环一次； 若为false，使用少jni调用，多数据拷贝，多循环一次的方法。
     *
    ...
    /**
     * if true, will treat no words matched as non-matched when diff contents and enabled match by
     * words
     */
