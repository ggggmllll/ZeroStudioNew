...
fun SoftkeyboardVisibleListener(
  ...
  DisposableEffect(view) {
    val callback = ViewTreeObserver.OnGlobalLayoutListener cb@{
      ...
      isKeyboardCoveredComponent.value =
          (componentHeight.intValue > 0) &&
              (view.height - keyboardHeightPx < componentHeight.intValue)

      keyboardPaddingDp.intValue =
    ...
    onDispose { view.viewTreeObserver.removeOnGlobalLayoutListener(callback) }
  }
}
