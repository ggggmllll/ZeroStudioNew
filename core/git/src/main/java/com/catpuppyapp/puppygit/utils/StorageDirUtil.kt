...
object StorageDirUtil {
  ...
  //    private var cachedAllSdsCopy = cachedAllSds.toList()  // for avoid concurrent modified
  // exception
  //
  //    suspend fun init() {
  ...
  //
  //        //log
  //        MyLog.d(TAG, "gen virtual path for '${target.name}' success, path is
  // '$virtualPathForTarget'")
  //
  ...
  //     */
  //    private fun recursiveGenParentVirtualPath(parentId:String, root:StorageDirEntity,
  // allMap:Map<String, StorageDirEntity>):String {
  ...
  //        }
  //
  //        return recursiveGenParentVirtualPath(parent.parentId, root, allMap) +
  // StorageDirCons.separator + parent.name
  //    }
  //
