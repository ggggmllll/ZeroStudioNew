...
@Composable
fun Modifier.addTopPaddingIfIsFirstLine(
    index: Int,
    topPadding: Dp = MyStyleKt.Padding.firstLineTopPaddingValuesInDp,
): Modifier {
...
private fun Modifier.basePageModifier(contentPadding: PaddingValues): Modifier {
  ...
  return fillMaxSize().padding(contentPadding)
}

fun Modifier.baseVerticalScrollablePageModifier(
