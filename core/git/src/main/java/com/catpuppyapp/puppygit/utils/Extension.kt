...
// I am not sure, maybe this will cause a NPE? check the log file
// "API31_12_20250617_TextInputServiceAndroid NPE.logcat"
...
fun String.pairClosed(openSign: String, closeSign: String) =
    (this.countSub(openSign).let { open ->
...
fun Collection<Uri>.createSendStreamIntent(
    context: Context,
    ...
    ShareCompat.IntentBuilder(context)
        ...
        .apply {
          @Suppress("DEPRECATION") removeFlagsCompat(Intent.FLAG_ACTIVITY_CLEAR_WHEN_TASK_RESET)
        }
