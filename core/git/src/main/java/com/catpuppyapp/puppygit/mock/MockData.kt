  ...
  companion object {
    fun getCommitList(repoId: String?, branch: String?, start: Int, end: Int): List<CommitDto> {
      ...
      for (i in start..end) {
        //                if(i%3==0) {
        //                    list.add(
        //                        CommitDto(""+i,"abc1234db12decafa1234928d8c1aef29838289",
        // listOf("dev"),"2024-01-13 11:12:12","author1","abfffffffffffc@123.com","commit
        // msg:bug1\nbug2,fixabcdefghikjkdjljgkjkkdjkdjf"),
        //                    )
        //                }else {
        //
        //                    list.add(
        //                        CommitDto(""+i,"abc1234fde111223455544333", if(i==1)
        // listOf("main", "Origin/main")else listOf(),"2024-01-13
        // 11:12:12","author1","abfffffffffffc@123.com","commit msg"),
        //                    )
        //                }
