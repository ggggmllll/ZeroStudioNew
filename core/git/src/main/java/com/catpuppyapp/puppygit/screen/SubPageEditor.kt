...
fun SubPageEditor(
  ...
  // (Cache.getByType<String>(filePathKey))?:"")
  ...
  val editorPageShowingFilePath = rememberSaveable {
    mutableStateOf(FilePath(NaviCache.getByType<String>(filePathKey) ?: ""))
  ...
  val editorPageLastScrollEvent =
      mutableCustomStateOf<ScrollEvent?>(stateKeyTag, "editorPageLastScrollEvent") {
        null
  ...
  val editorPagePatchMode =
      rememberSaveable(settings.editor.patchModeOn) { mutableStateOf(settings.editor.patchModeOn) }
  ...
  val editorDisableSoftKb = rememberSaveable {
    mutableStateOf(settings.editor.disableSoftwareKeyboard)
  }
  ...
  val editorLineNumFontSize = rememberSaveable {
    mutableIntStateOf(settingsTmp.editor.lineNumFontSize)
  }
  ...
  val closeDialogCallback =
      mutableCustomStateOf<(Boolean) -> Unit>(
          keyTag = stateKeyTag,
        ...
        TopAppBar(
            ...
            navigationIcon = {
              if (
                ...
                val (tooltipText, icon, iconContentDesc) =
                    if (editorNeedSave()) {
                      Triple(
                ...
                LongPressAbleIconBtn(
                  ...
                  doJobThenOffLoading {
                    ...
                    // navi back
                    withContext(Dispatchers.Main) { naviUp() }
            ...
            actions = {
              if (!editorOpenFileErr.value) {
                val notOpenFile =
                    !editorPageShowingFileIsReady.value && editorPageShowingFilePath.value.isBlank()
