...
interface CredentialRepository {
  ...
  suspend fun getAllWithDecrypt(
      includeNone: Boolean = false,
      includeMatchByDomain: Boolean = false,
  ...
  suspend fun updateWithEncrypt(
      item: CredentialEntity,
      touchTime: Boolean = true,
      masterPassword: String = AppModel.masterPassword.value,
  )
  ...
  suspend fun getByIdWithDecrypt(
      id: String,
      masterPassword: String = AppModel.masterPassword.value,
  ): CredentialEntity?

  /**
   * if id is `SpecialCredential.MatchByDomain.credentialId` will try match credential by url's
   * domain if you are sure id is not match by domain id, just simple passing empty str as url
   */
  suspend fun getByIdWithDecryptAndMatchByDomain(
      id: String,
      url: String,
      masterPassword: String = AppModel.masterPassword.value,
  ): CredentialEntity?
  ...
  //    suspend fun getHttpList(includeNone:Boolean = false, includeMatchByDomain:Boolean = false):
  // List<CredentialEntity>
