...
object CommitMsgTemplateUtil {
  ...
  val fileNamesPlaceHolder =
      PlaceHolder(pattern = "{{fileNames}}", example = "file1.txt, file2.txt")
  ...
  fun replace(
    ...
    return msgTemplate
        .replace(datePlaceHolder.pattern, getFormatTimeFromSec(now, dateFormatter))
