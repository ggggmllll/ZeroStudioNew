...
val MIGRATION_22_23 =
    object : Migration(22, 23) {
      override fun migrate(db: SupportSQLiteDatabase) {
        ...
        val createTableSql =
            "CREATE TABLE IF NOT EXISTS `${TABLE_NAME}` (`id` TEXT NOT NULL, `domain` TEXT NOT NULL, `credentialId` TEXT NOT NULL, `baseStatus` INTEGER NOT NULL, `baseCreateTime` INTEGER NOT NULL, `baseUpdateTime` INTEGER NOT NULL, `baseIsDel` INTEGER NOT NULL, PRIMARY KEY(`id`))"
...
val MIGRATION_23_24 =
    object : Migration(23, 24) {
      override fun migrate(db: SupportSQLiteDatabase) {
        db.execSQL(
            "ALTER TABLE domain_credential ADD COLUMN sshCredentialId TEXT NOT NULL DEFAULT ''"
        )
      }
    }
