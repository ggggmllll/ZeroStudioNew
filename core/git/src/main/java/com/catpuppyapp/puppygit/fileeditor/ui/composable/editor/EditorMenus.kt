...
fun EditorMenus(
  ...
  val getColor = { enabled: Boolean -> if (enabled) null else disableColor }
      ...
      EditorMenu(
          ...
          label = {
            if (hasLinesSelected) {
              ...
              Text(text = stringResource(R.string.delete), color = disableColor)
            }
          },
          modifier =
              Modifier.weight(elementCommonWeight)
      ...
      EditorMenu(
          ...
          label = {
            if (hasLinesSelected) {
              ...
              Text(text = stringResource(R.string.copy), color = disableColor)
            }
          },
          modifier =
              Modifier.weight(elementCommonWeight)
