...
fun SubscriptionPage(
  ...
  Column(
    ...
    //        if(Billing.productDetailsList==null || Billing.productDetailsList?.value?.isEmpty() ==
    // true) {
    //            Row(modifier = Modifier.padding(10.dp)) {
    //                Text(text = stringResource(R.string.err_query_product_details_failed), color =
    // MyStyleKt.TextColor.error)
    //            }
    //        }else {
    ...
    //                        Text(text = price+"/"+AppModel.getStringByResKey(appContext,
    // product.purchasePeriodResKey))
    //                    }
    //                    Row(modifier = Modifier.padding(10.dp)) {  //卖点
    //                        Text(text = AppModel.getStringByResKey(appContext,
    // product.benefitsResKey), textAlign = TextAlign.Center)
    //                    }
    ...
    ////                            colors = ButtonDefaults.elevatedButtonColors().copy(contentColor
    ...
    // ->
    //                                    // exceptionHandler
    //                                    Msg.requireShowLongDuration("buy err:
    // "+e.localizedMessage)
    ...
    //                        ) {
    //                            Text(
    //                                text = if(UserUtil.isPro())
    // stringResource(R.string.you_already_is_pro) else stringResource(R.string.buy_now),
