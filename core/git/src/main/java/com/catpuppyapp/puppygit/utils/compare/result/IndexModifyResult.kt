...
data class IndexModifyResult(
  ...
  //        return "IndexModifyResult(matched=$matched,
  // matchedByReverseSearch=$matchedByReverseSearch, add=$add, del=$del)"
  //    }
