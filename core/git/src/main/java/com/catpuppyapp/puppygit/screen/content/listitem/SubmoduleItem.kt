...
fun SubmoduleItem(
  ...
  Column(
    ...
    Row(
      ...
      InLineIcon(icon = Icons.Outlined.GridView, tooltipText = stringResource(R.string.submodule))
    ...
    Row(
      ...
      InLineIcon(icon = Icons.Outlined.Cloud, tooltipText = stringResource(R.string.url))

      //            Text(text = stringResource(R.string.url) +": ")

      ScrollableRow {
        Text(
            text = thisObj.remoteUrl,
            maxLines = 1,
            overflow = TextOverflow.Ellipsis,
            fontWeight = defaultFontWeight,
        )
    ...
    Row(
      ...
      InLineIcon(icon = Icons.Outlined.Folder, tooltipText = stringResource(R.string.path))

      //            Text(text = stringResource(R.string.path) +": ")
      ScrollableRow {
        Text(
            text = thisObj.relativePathUnderParent,
            maxLines = 1,
            overflow = TextOverflow.Ellipsis,
            fontWeight = defaultFontWeight,
        )
    ...
    Row(
      ...
      Text(
          text = thisObj.getShortTargetHashCached(),
          maxLines = 1,
          overflow = TextOverflow.Ellipsis,
          fontWeight = defaultFontWeight,
      )
    ...
    Row(
      ...
      InLineIcon(icon = Icons.Outlined.LocationOn, tooltipText = stringResource(R.string.location))

      //            Text(text = stringResource(R.string.location) +": ")

      ScrollableRow {
        Text(
            text = thisObj.location.toString(),
            maxLines = 1,
            overflow = TextOverflow.Ellipsis,
            fontWeight = defaultFontWeight,
        )
    ...
    Row(
      ...
      ScrollableRow {
        Text(
            text = thisObj.getStatus(activityContext),
            maxLines = 1,
            overflow = TextOverflow.Ellipsis,
            fontWeight = defaultFontWeight,
