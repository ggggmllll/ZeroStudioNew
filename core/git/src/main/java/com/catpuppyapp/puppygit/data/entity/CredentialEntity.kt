...
data class CredentialEntity(
  ...
  //            activityContext.getString(if(type == Cons.dbCredentialTypeHttp) R.string.http_https
  // else R.string.ssh)
  //        }
  //    }
