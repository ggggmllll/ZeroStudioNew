...
fun TTSProviderConfigure(
  ...
  Column(
                  ...
                  val newSetting =
                      when (providerClass) {
                        TTSProviderSetting.OpenAI::class ->
                            TTSProviderSetting.OpenAI(id = setting.id, name = "OpenAI TTS")

                        TTSProviderSetting.Gemini::class ->
                            TTSProviderSetting.Gemini(id = setting.id, name = "Gemini TTS")

                        TTSProviderSetting.SystemTTS::class ->
                            TTSProviderSetting.SystemTTS(id = setting.id, name = "System TTS")

                        TTSProviderSetting.MiniMax::class ->
                            TTSProviderSetting.MiniMax(id = setting.id, name = "MiniMax TTS")

                        TTSProviderSetting.Qwen::class ->
                            TTSProviderSetting.Qwen(id = setting.id, name = "Qwen TTS")

                        TTSProviderSetting.Groq::class ->
                            TTSProviderSetting.Groq(id = setting.id, name = "Groq TTS")

                        TTSProviderSetting.XAI::class ->
                            TTSProviderSetting.XAI(id = setting.id, name = "xAI TTS")

                        TTSProviderSetting.MiMo::class ->
                            TTSProviderSetting.MiMo(id = setting.id, name = "MiMo TTS")
    ...
    FormItem(
      ...
      OutlinedTextField(
          value = setting.name,
          onValueChange = { newName -> onValueChange(setting.copyProvider(name = newName)) },
...
private fun OpenAITTSConfiguration(
  ...
  FormItem(
    ...
    OutlinedTextField(
        ...
        modifier = Modifier.fillMaxWidth(),
        placeholder = {
          Text(stringResource(R.string.setting_tts_page_api_key_placeholder_openai))
        },
    )
  }
  ...
  FormItem(
    ...
    ExposedDropdownMenuBox(
      ...
      OutlinedTextField(
          ...
          modifier = Modifier.fillMaxWidth().menuAnchor(MenuAnchorType.PrimaryEditable),
          trailingIcon = { ExposedDropdownMenuDefaults.TrailingIcon(expanded = voiceIdExpanded) },
      )
      ExposedDropdownMenu(
          expanded = voiceIdExpanded,
  ...
  FormItem(
    ...
    ExposedDropdownMenuBox(
      ...
      OutlinedTextField(
          ...
          onValueChange = { newEmotion -> onValueChange(setting.copy(emotion = newEmotion)) },
          modifier = Modifier.fillMaxWidth().menuAnchor(MenuAnchorType.PrimaryEditable),
...
private fun GeminiTTSConfiguration(
  ...
  FormItem(
    ...
    OutlinedTextField(
        ...
        modifier = Modifier.fillMaxWidth(),
        placeholder = {
          Text(stringResource(R.string.setting_tts_page_api_key_placeholder_gemini))
        },
    )
  }
  ...
  FormItem(
    ...
    OutlinedTextField(
        ...
        onValueChange = { newVoiceName -> onValueChange(setting.copy(voiceName = newVoiceName)) },
        modifier = Modifier.fillMaxWidth(),
...
private fun XAITTSConfiguration(
  ...
  var voiceExpanded by remember { mutableStateOf(false) }
  val voices =
      listOf("eve" to "Eve", "ara" to "Ara", "rex" to "Rex", "sal" to "Sal", "leo" to "Leo")
  ...
  FormItem(
    ...
    ExposedDropdownMenuBox(
      ...
      OutlinedTextField(
          ...
          onValueChange = { newLanguage -> onValueChange(setting.copy(language = newLanguage)) },
          modifier = Modifier.fillMaxWidth().menuAnchor(MenuAnchorType.PrimaryEditable),
          trailingIcon = { ExposedDropdownMenuDefaults.TrailingIcon(expanded = languageExpanded) },
      )
      ExposedDropdownMenu(
