...
/**
 * A simple thread-safe cache implementation with expiration support. This is a lightweight
 * alternative to Guava Cache to avoid concurrency issues.
 */
class SimpleCache<K, V>(private val expireAfterWriteMillis: Long) {
