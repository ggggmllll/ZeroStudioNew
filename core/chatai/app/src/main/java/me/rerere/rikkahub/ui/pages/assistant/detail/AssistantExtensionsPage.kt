        ...
        when (page) {
              ...
              Column {
                QuickMessagesContent(
                    ...
                    onToggle = { quickMessageId, checked ->
                      val newIds =
                          if (checked) assistant.quickMessageIds + quickMessageId
          ...
          1 -> {
            if (settings.modeInjections.isEmpty()) {
              ExtensionEmptyState(
                  message =
                      stringResource(R.string.assistant_extensions_page_empty_mode_injections),
              ...
              Column {
                ModeInjectionsContent(
                    ...
                    onToggle = { injId, checked ->
                      val newIds =
                          if (checked) assistant.modeInjectionIds + injId
            ...
            if (settings.lorebooks.isEmpty()) {
              ...
              Column {
                LorebooksContent(
                    ...
                    onToggle = { injId, checked ->
                      val newIds =
                          if (checked) assistant.lorebookIds + injId
              ...
              Column {
                SkillsContent(
                    ...
                    onToggle = { name, checked ->
                      val newSkills =
                          if (checked) assistant.enabledSkills + name
