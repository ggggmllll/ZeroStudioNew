...
/**
 * Remembers the current Lifecycle.State of the application's LifecycleOwner (usually the Activity
 * or Fragment hosting the Compose UI).
 *
 * The returned State object will update whenever the lifecycle state changes (e.g., from STARTED to
 * RESUMED).
 *
