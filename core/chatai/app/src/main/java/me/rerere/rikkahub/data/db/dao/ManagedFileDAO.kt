...
interface ManagedFileDAO {
  @Insert(onConflict = OnConflictStrategy.REPLACE) suspend fun insert(file: ManagedFileEntity): Long

  @Update suspend fun update(file: ManagedFileEntity)
  ...
  @Query("DELETE FROM managed_files WHERE id = :id") suspend fun deleteById(id: Long): Int
