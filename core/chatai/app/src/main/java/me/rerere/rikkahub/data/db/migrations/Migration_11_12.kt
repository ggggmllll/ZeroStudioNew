...
val Migration_11_12 =
    object : Migration(11, 12) {
      override fun migrate(db: SupportSQLiteDatabase) {
        Log.i(
            TAG,
            "migrate: start migrate from 11 to 12 (extracting message nodes to separate table)",
        )
          ...
          while (cursor.moveToNext()) {
            ...
            try {
              ...
              try {
                ...
                val nodesArray =
                    runCatching { JsonInstant.parseToJsonElement(nodesJson) as? JsonArray }
                ...
                nodesArray.forEachIndexed { index, nodeElement ->
                  ...
                  val selectIndex =
                      runCatching { nodeObject["selectIndex"]?.jsonPrimitive?.int ?: 0 }
                          .getOrDefault(0)
