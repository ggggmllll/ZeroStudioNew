  ...
  private fun incrementLaunchCount() {
    get<AppScope>().launch {
      runCatching {
          ...
          .onFailure { Log.e(TAG, "incrementLaunchCount failed", it) }
    }
  }
    ...
    get<AppScope>().launch {
      runCatching {
            ...
            if (settings.webServerEnabled) {
              ...
              val intent =
                  Intent(this@RikkaHubApp, WebServerService::class.java).apply {
          ...
          .onFailure { Log.e(TAG, "startWebServerIfEnabled failed", it) }
    }
  }

  private fun createNotificationChannel() {
    val notificationManager = NotificationManagerCompat.from(this)
    val chatCompletedChannel =
