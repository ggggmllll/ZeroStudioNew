    ...
    ModalBottomSheet(
      ...
      Column(
        ...
        SearchPicker(
            ...
            onUpdateSearchService = { index -> onUpdateSearchService(index) },
...
private fun AppSearchSettings(
  ...
  Card {
    Row(
      ...
      Switch(checked = enableSearch, onCheckedChange = onToggleSearch)
    }
  }
      ...
      Card(
        ...
        Row(
          ...
          Column(
            ...
            SearchAbilityTagLine(options = service, modifier = Modifier)
          }
        }
      }
    }
                      ...
                      providers =
                          settings.providers.map { providerSetting ->
                            providerSetting.editModel(
                                model.copy(
                                    tools =
                                        if (checked) model.tools + BuiltInTools.Search
