...
fun SettingWebPage() {
  ...
  var portText by
      remember(settings.webServerPort) { mutableStateOf(settings.webServerPort.toString()) }
  var accessPasswordText by
      remember(settings.webServerAccessPassword) {
  ...
  fun startWebServer() {
    ...
    scope.launch { settingsStore.update { it.copy(webServerEnabled = true) } }
  }
        ...
        ExtendedFloatingActionButton(
            onClick = {
              ...
              if (!serverState.isRunning) {
                ...
                scope.launch { settingsStore.update { it.copy(webServerEnabled = false) } }
              }
            },
            icon = {
      ...
      item {
        CardGroup(
          ...
          item(
              ...
              supportingContent = {
                Text(stringResource(R.string.setting_page_web_server_port_desc))
              },
              trailingContent = {
                TextField(
                    value = portText,
                    onValueChange = { value ->
                      ...
                      if (port != null && port in 1024..65535) {
                        scope.launch { settingsStore.update { it.copy(webServerPort = port) } }
                      }
                    },
          ...
          item(
              headlineContent = {
                Text(stringResource(R.string.setting_page_web_server_localhost_only))
              },
              supportingContent = {
                Text(stringResource(R.string.setting_page_web_server_localhost_only_desc))
              },
              trailingContent = {
                Switch(
          ...
          item(
              headlineContent = {
                Text(stringResource(R.string.setting_page_web_server_jwt_enable))
              },
              supportingContent = {
                Text(stringResource(R.string.setting_page_web_server_jwt_enable_desc))
              },
              trailingContent = {
                Switch(
          ...
          item(
              ...
              supportingContent = {
                Text(stringResource(R.string.setting_page_web_server_password_desc))
              },
              trailingContent = {
                TextField(
          ...
          if (serverState.isRunning) {
            ...
            if (!serverState.localhostOnly) {
              ...
              item(
                  ...
                  headlineContent = {
                    Text(stringResource(R.string.setting_page_web_server_lan_address))
                  },
              ...
              if (serverState.hostname != null) {
                ...
                item(
                    ...
                    headlineContent = {
                      Text(stringResource(R.string.setting_page_web_server_mdns_address))
                    },
            ...
            item(
                ...
                headlineContent = {
                  Text(stringResource(R.string.setting_page_web_server_local_address))
                },
          ...
          if (serverState.error != null) {
            item(
                ...
                supportingContent = {
                  Text(text = serverState.error ?: "", color = MaterialTheme.colorScheme.error)
                },
            )
          }
        }
