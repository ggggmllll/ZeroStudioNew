      ...
      RikkahubTheme {
        ...
        Scaffold(
          ...
          Column(
            ...
            Button(onClick = { showAssistantPicker = true }, modifier = Modifier.fillMaxWidth()) {
            ...
            if (stackTrace != null) {
              ...
              Card(
                ...
                Text(
                    text = stackTrace,
                    modifier =
                        Modifier.padding(12.dp).verticalScroll(vScroll).horizontalScroll(hScroll),
      ...
      LazyColumn(
        ...
        items(filteredAssistants, key = { it.id }) { assistant ->
          ...
          Card(
            ...
            Text(
                text =
                    assistant.name.ifEmpty { stringResource(R.string.safe_mode_default_assistant) },
