...
class GenerationHandler(
  ...
  fun generateText(
      ...
      flow {
            ...
            for (stepIndex in 0 until maxSteps) {
              ...
              val pendingTools =
                  messages.lastOrNull()?.getTools()?.filter {
                    !it.isExecuted &&
              ...
              if (pendingTools.isEmpty()) {
                ...
                messages =
                    messages.slice(0 until messages.lastIndex) +
                        messages
                            .last()
                            .copy(
                                finishedAt =
                ...
                when (tool.approvalState) {
                  ...
                  is ToolApprovalState.Pending -> {
                    ...
                    runCatching {
                          ...
                          Log.i(
                              TAG,
                              "generateText: executing tool ${toolDef.name} with args: $args",
                          )
  ...
  private suspend fun generateInternal(
    ...
    if (stream) {
      ...
      providerImpl
          .streamText(providerSetting = provider, messages = internalMessages, params = params)
          .collect {
  ...
  fun translateText(
      ...
      flow {
            val model =
                settings.providers.findModelById(settings.translateModeId)
