...
class RouteActivity : ComponentActivity() {
  ...
  override fun onNewIntent(intent: Intent) {
    ...
    intent.getStringExtra("conversationId")?.let { text -> navStack?.add(Screen.Chat(text)) }
  }
              ...
              entryProvider =
                  entryProvider {
                    ...
                    entry<Screen.ShareHandler> { key ->
                      ShareHandlerPage(text = key.text, image = key.streamUri)
                    }
                    ...
                    entry<Screen.SettingTTS> { SettingTTSPage() }
...
sealed interface Screen : NavKey {
  ...
  @Serializable data object SettingTTS : Screen
