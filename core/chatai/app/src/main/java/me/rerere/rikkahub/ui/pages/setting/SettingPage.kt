...
fun SettingPage(vm: SettingVM = koinViewModel()) {
  ...
  if (
      settings.launchCount > 100 && (settings.launchCount - settings.sponsorAlertDismissedAt) >= 50
  ) {
    AlertDialog(
        onDismissRequest = {
        ...
        LargeFlexibleTopAppBar(
            ...
            actions = {
              if (settings.developerMode) {
                IconButton(onClick = { navController.navigate(Screen.Developer) }) {
      ...
      item("generalSettings") {
        ...
        CardGroup(
          ...
          item(
              ...
              supportingContent = {
                Text(stringResource(R.string.setting_page_display_setting_desc))
              },
      ...
      item("modelServices") {
        CardGroup(
          ...
          item(
              ...
              supportingContent = {
                Text(stringResource(R.string.setting_page_default_model_desc))
              },
          ...
          item(
              ...
              supportingContent = {
                Text(stringResource(R.string.setting_page_search_service_desc))
              },
      ...
      item("aboutSettings") {
        ...
        CardGroup(
          ...
          item(
              ...
              trailingContent = {
                Row(
                  ...
                  IconButton(
                      onClick = { context.joinQQGroup("wMdqlDETtzIz6o49HrBR2TeQlwcX6RH9") }
                  ) {
                    Icon(
                  ...
                  IconButton(onClick = { context.openUrl("https://discord.gg/9weBqxe5c4") }) {
                    Icon(
          ...
          item(
              ...
              supportingContent = {
                Text(stringResource(R.string.setting_page_documentation_desc))
              },
