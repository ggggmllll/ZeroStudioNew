      ...
      item {
        CardGroup(
          ...
          item(
              ...
              supportingContent = {
                Text(stringResource(R.string.assistant_detail_extensions_desc))
              },
          ...
          item(
              ...
              supportingContent = {
                Text(stringResource(R.string.assistant_detail_local_tools_desc))
              },
...
@Composable
private fun AssistantHeader(assistant: Assistant, modifier: Modifier = Modifier) {
  Column(
    ...
    if (assistant.systemPrompt.isNotBlank()) {
      Text(
          text =
              assistant.systemPrompt.take(100) +
