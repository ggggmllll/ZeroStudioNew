...
fun AssistantPicker(
  ...
  NavigationDrawerItem(
      icon = { Icon(HugeIcons.LookTop, contentDescription = null) },
      label = {
        Row(
...
@Composable
private fun AssistantItem(assistant: Assistant, defaultAssistantName: String, onEdit: () -> Unit) {
  ListItem(
      headlineContent = {
        Text(
      ...
      trailingContent = {
        IconButton(onClick = { onEdit() }) {
          Icon(imageVector = HugeIcons.Edit03, contentDescription = null)
        }
      },
