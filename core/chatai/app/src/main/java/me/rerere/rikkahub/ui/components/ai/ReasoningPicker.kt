  ...
  ModalBottomSheet(
    ...
    Column(
      ...
      ReasoningLevelCard(
          ...
          icon = { Icon(HugeIcons.Idea, null) },
          title = { Text(stringResource(id = R.string.reasoning_off)) },
          description = { Text(stringResource(id = R.string.reasoning_off_desc)) },
          onClick = { onUpdateReasoningTokens(0) },
      )
      ReasoningLevelCard(
          selected = currentLevel == ReasoningLevel.AUTO,
          icon = { Icon(HugeIcons.Idea01, null) },
          title = { Text(stringResource(id = R.string.reasoning_auto)) },
          description = { Text(stringResource(id = R.string.reasoning_auto_desc)) },
          onClick = { onUpdateReasoningTokens(-1) },
      )
      ReasoningLevelCard(
          selected = currentLevel == ReasoningLevel.LOW,
          icon = { Icon(ReasoningLow, null) },
          title = { Text(stringResource(id = R.string.reasoning_light)) },
          description = { Text(stringResource(id = R.string.reasoning_light_desc)) },
          onClick = { onUpdateReasoningTokens(1024) },
      )
      ReasoningLevelCard(
          selected = currentLevel == ReasoningLevel.MEDIUM,
          icon = { Icon(ReasoningMedium, null) },
          title = { Text(stringResource(id = R.string.reasoning_medium)) },
          description = { Text(stringResource(id = R.string.reasoning_medium_desc)) },
          onClick = { onUpdateReasoningTokens(16_000) },
      )
      ReasoningLevelCard(
          selected = currentLevel == ReasoningLevel.HIGH,
          icon = { Icon(ReasoningHigh, null) },
          title = { Text(stringResource(id = R.string.reasoning_heavy)) },
          description = { Text(stringResource(id = R.string.reasoning_heavy_desc)) },
      ...
      Card(
        ...
        Column(
          ...
          var input by remember(reasoningTokens) { mutableStateOf(reasoningTokens.toString()) }
          OutlinedTextField(
              value = input,
...
private fun ReasoningPickerPreview() {
  MaterialTheme {
    ...
    ReasoningPicker(
        onDismissRequest = {},
        reasoningTokens = reasoningTokens,
        onUpdateReasoningTokens = { reasoningTokens = it },
    )
  }
}
