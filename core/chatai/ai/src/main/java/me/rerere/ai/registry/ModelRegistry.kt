...
object ModelRegistry {
  ...
  val GEMINI_LATEST = defineGroup { add(GEMINI_FLASH_LATEST, GEMINI_PRO_LATEST) }
  ...
  private val DEEPSEEK_V3 = defineGroup { add(DEEPSEEK_V3_MODEL, DEEPSEEK_CHAT) }
  ...
  private val DEEPSEEK_R1 = defineGroup { add(DEEPSEEK_R1_MODEL, DEEPSEEK_REASONER) }
  ...
  val QWEN_MT = defineModel { tokens("qwen", "mt") }
  ...
  private fun resolveModalities(
    ...
    val modalities = resolveModels(modelId).flatMap { selector(it) }.toSet()
