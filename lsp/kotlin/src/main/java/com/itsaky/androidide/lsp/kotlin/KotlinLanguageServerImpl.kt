...
class KotlinLanguageServerImpl(
  ...
  private val rpcClient = KotlinRpcClient(inStream, outStream) { msg ->
  ...
  override fun didClose(params: DidCloseTextDocumentParams) {
    rpcClient.sendNotification("textDocument/didClose", mapOf(
      "textDocument" to mapOf("uri" to params.file.toUri().toString())
    ))
  }

  override fun didSave(params: DidSaveTextDocumentParams) {
    rpcClient.sendNotification("textDocument/didSave", mapOf(
      "textDocument" to mapOf("uri" to params.file.toUri().toString()),
      "text" to params.text
    ))
  }
  ...
  override fun complete(params: CompletionParams?): CompletionResult {
    ...
    return runBlocking(Dispatchers.IO) {
       ...
       try {
         val response = rpcClient.sendRequest("textDocument/completion", req) ?: return@runBlocking CompletionResult.EMPTY
         
         val itemsJson = if (response.isJsonObject) {
