    ...
    companion object {
        fun fromPreferences(preferences: SharedPreferences): ClangdServerSettings {
            return ClangdServerSettings(
                ...
                clangdPath = preferences.getString(ClangdPreferenceKeys.CLANGD_PATH, "clangd") ?: "clangd",
                completionLimit = preferences
                    .getInt(ClangdPreferenceKeys.COMPLETION_LIMIT, 100)
                    .coerceIn(10, 200),
                ...
                smartSelection = preferences.getBoolean(ClangdPreferenceKeys.ENABLE_SMART_SELECTION, true),
                codeActions = preferences.getBoolean(ClangdPreferenceKeys.ENABLE_CODE_ACTIONS, true),
                matchLowercase = preferences.getBoolean(ClangdPreferenceKeys.ENABLE_LOWERCASE_MATCH, true),
                fuzzyMatchRatio = preferences
                    .getInt(ClangdPreferenceKeys.FUZZY_MATCH_RATIO, 59)
                    .coerceIn(0, 100),
                requestTimeoutMs = preferences
