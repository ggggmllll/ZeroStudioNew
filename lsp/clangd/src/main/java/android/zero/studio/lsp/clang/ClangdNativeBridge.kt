...
object ClangdNativeBridge {
    ...
    @JvmStatic external fun nativeInitialize(clangdPath: String, workDir: String, completionLimit: Int): Boolean
    ...
    @JvmStatic external fun nativeRequestCompletion(fileUri: String, line: Int, character: Int, triggerCharacter: String?): Long
    @JvmStatic external fun nativeRequestDefinition(fileUri: String, line: Int, character: Int): Long
    @JvmStatic external fun nativeRequestReferences(fileUri: String, line: Int, character: Int, includeDeclaration: Boolean): Long
