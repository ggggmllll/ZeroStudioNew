...
object LspResultCache {
  ...
  private val completionCache =
      object : LinkedHashMap<CompletionKey, CompletionEntry>(32, 0.75f, true) {
        override fun removeEldestEntry(
            eldest: MutableMap.MutableEntry<CompletionKey, CompletionEntry>?
        ): Boolean {
  ...
  fun getCompletion(
    ...
    val mismatchedContext =
        entry.identifierSnapshot != identifierSnapshot || entry.scopeSignature != scopeSignature
