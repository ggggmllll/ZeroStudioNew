 ...
 * ManagementFactory#getOperatingSystemMXBean} method or from the {@link
 * ManagementFactory#getPlatformMBeanServer platform <tt>MBeanServer</tt>} method.
 *
 * <p>The <tt>ObjectName</tt> for uniquely identifying the MXBean for the operating system within an
 * MBeanServer is:
 *
 * <blockquote>
 *
 ...
 *
 * <p>This interface defines several convenient methods for accessing system properties about the
...
public interface OperatingSystemMXBean extends PlatformManagedObject {
   ...
   *     checkPropertiesAccess</code> method doesn't allow access to this system property.
   ...
   * number of runnable entities queued to the {@linkplain #getAvailableProcessors available
   ...
   *
   * <p>If the load average is not available, a negative value is returned.
   *
   * <p>This method is designed to provide a hint about the system load and may be queried
   * frequently. The load average may be unavailable on some platform where it is expensive to
