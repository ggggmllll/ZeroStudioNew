...
public interface EventTarget {
   ...
   * If multiple identical <code>EventListener</code>s are registered on the same <code>EventTarget
   * </code> with the same parameters the duplicate instances are discarded. They do not cause the
   * <code>EventListener</code> to be called twice and since they are discarded they do not need to
   ...
   *     the registered <code>EventListener</code> before being dispatched to any <code>EventTargets
   *     </code> beneath them in the tree. Events which are bubbling upward through the tree will
   ...
   *     as a capturing listener or not. If a listener was registered twice, one with capture and
