...
public interface DOMImplementationList {
   ...
   * or equal to the number of <code>DOMImplementation</code>s in the list, this returns <code>null
   * </code>.
   *
   * @param index Index into the collection.
   * @return The <code>DOMImplementation</code> at the <code>index</code> th position in the <code>
   *     DOMImplementationList</code>, or <code>null</code> if that is not a valid index.
   */
