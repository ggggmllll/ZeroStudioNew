...
public abstract class DatatypeFactory {
   ...
   * (JAXP) 1.3</em>.
   *
   * <p>Implementers should specify the name of an appropriate class to be instantiated if no other
   * implementation resolution mechanism succeeds.
   *
   ...
   * @throws org.openjdk.javax.xml.datatype.DatatypeConfigurationException If the implementation is
   ...
   *     class.
   * @return New instance of a <code>DatatypeFactory</code>
   * @throws org.openjdk.javax.xml.datatype.DatatypeConfigurationException if <code>factoryClassName
   *     </code> is <code>null</code>, or the factory class cannot be loaded, instantiated.
   * @see #newInstance()
   * @since 1.6
   */
   ...
   * <blockquote>
   *
   * duration represents a duration of time. The value space of duration is a six-dimensional space
   * where the coordinates designate the Gregorian year, month, day, hour, minute, and second
   * components defined in Section 5.5.3.2 of [ISO 8601], respectively. These components are ordered
   * in their significance by their order of appearance i.e. as year, month, day, hour, minute, and
   * second.
   *
   * </blockquote>
   *
   ...
   * month = {@link java.util.Calendar#FEBRUARY} so the result of {@link
   ...
   *     Duration</code>: if all the fields (years, months, ...) are null or if any of the fields is
   *     negative.
   * @throws UnsupportedOperationException If implementation cannot support requested values.
   */
  public abstract org.openjdk.javax.xml.datatype.Duration newDuration(
   ...
   * resides in the namespace <code>http://www.w3.org/2003/11/xpath-datatypes</code>.
   *
   ...
   */
  public org.openjdk.javax.xml.datatype.Duration newDurationDayTime(
      final boolean isPositive, final int day, final int hour, final int minute, final int second) {
  ...
  /**
   * Create a <code>Duration</code> of type <code>xdt:yearMonthDuration</code> by parsing its <code>
   * String</code> representation, "<em>PnYnM</em>", <a
   ...
   * the namespace {@link XMLConstants#W3C_XPATH_DATATYPE_NS_URI}.
   *
   ...
   * @return New <code>Duration</code> created using the specified <code>year</code> and <code>month
   *     </code>.
   * @throws IllegalArgumentException If the values are not a valid representation of a <code>
  ...
  /**
   * Constructor allowing for complete value spaces allowed by W3C XML Schema 1.0 recommendation for
   * xsd:dateTime and related builtin datatypes. Note that <code>year</code> parameter supports
   ...
   *     org.openjdk.javax.xml.datatype.XMLGregorianCalendar} or if the composite values constitute
   *     an invalid <code>XMLGregorianCalendar</code> instance as determined by {@link
  ...
  /**
   * Constructor of value spaces that a <code>java.util.GregorianCalendar</code> instance would need
   * to convert to an <code>XMLGregorianCalendar</code> instance.
   *
  ...
  public org.openjdk.javax.xml.datatype.XMLGregorianCalendar newXMLGregorianCalendar(
    ...
    if (millisecond != org.openjdk.javax.xml.datatype.DatatypeConstants.FIELD_UNDEFINED) {
      if (millisecond < 0 || millisecond > 1000) {
        throw new IllegalArgumentException(
            "javax.xml.datatype.DatatypeFactory#newXMLGregorianCalendar(int year, int month, int"
                + " day, int hour, int minute, int second, int millisecond, int timezone)with"
                + " invalid millisecond: "
                + millisecond);
      }
   ...
   *     org.openjdk.javax.xml.datatype.DatatypeConstants#FIELD_UNDEFINED} indicates optional field
   *     is not set.
