...
public class PropertyException extends JAXBException {
  ...
  /**
   * Construct a PropertyException with the specified detail message. The errorCode and
  ...
  /**
   * Construct a PropertyException with a linkedException. The detail message and vendor specific
  ...
  /**
   * Construct a PropertyException with the specified detail message and linkedException. The
   * errorCode will default to null.
   *
   * @param message a description of the exception
   * @param exception the linked exception
  ...
  /**
   * Construct a PropertyException with the specified detail message, vendor specific errorCode, and
   * linkedException.
   *
   * @param message a description of the exception
   * @param errorCode a string specifying the vendor specific error code
  ...
  /**
   * Construct a PropertyException whose message field is set based on the name of the property and
   * value.toString().
   *
