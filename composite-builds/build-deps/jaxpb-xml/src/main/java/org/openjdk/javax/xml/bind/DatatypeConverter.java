...
/**
 * The javaType binding declaration can be used to customize the binding of an XML schema datatype
 * to a Java datatype. Customizations can involve writing a parse and print method for parsing and
 * printing lexical representations of a XML schema datatype respectively. However, writing parse
 * and print methods requires knowledge of the lexical representations ( <a
 * href="http://www.w3.org/TR/xmlschema-2/">XML Schema Part2: Datatypes specification </a>) and
 * hence may be difficult to write.
 *
 * <p>This class makes it easier to write parse and print methods. It defines static parse and print
 * methods that provide access to a JAXB provider's implementation of parse and print methods. These
 * methods are invoked by custom parse and print methods. For example, the binding of xsd:dateTime
 ...
 * </blockquote>
 *
 * <p>There is a static parse and print method corresponding to each parse and print method
 * respectively in the {@link DatatypeConverterInterface DatatypeConverterInterface}.
 *
 * <p>The static methods defined in the class can also be used to specify a parse or a print method
 * in a javaType binding declaration.
 *
 * <p>JAXB Providers are required to call the {@link
 * #setDatatypeConverter(DatatypeConverterInterface) setDatatypeConverter} api at some point before
 * the first marshal or unmarshal operation (perhaps during the call to JAXBContext.newInstance).
 * This step is necessary to configure the converter that should be used to perform the print and
 * parse functionality.
 *
...
public final class DatatypeConverter {
   ...
   *
   * <p>JAXB Providers are required to call this method at some point before allowing any of the
   * JAXB client marshal or unmarshal operations to occur. This is necessary to configure the
   * datatype converter that should be used to perform the print and parse conversions.
   *
   * <p>Calling this api repeatedly will have no effect - the DatatypeConverterInterface instance
   ...
   */
  public static org.openjdk.javax.xml.namespace.QName parseQName(
      String lexicalXSDQName, NamespaceContext nsc) {
    if (theConverter == null) {
      initConverter();
    }
   ...
   */
  public static String printQName(org.openjdk.javax.xml.namespace.QName val, NamespaceContext nsc) {
    if (theConverter == null) {
      initConverter();
    }
