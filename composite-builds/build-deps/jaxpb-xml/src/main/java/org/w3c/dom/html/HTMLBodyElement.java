...
public interface HTMLBodyElement extends HTMLElement {
  ...
  /**
   * URI of the background texture tile image. See the background attribute definition in HTML 4.0.
  ...
  /**
   * Document background color. See the bgcolor attribute definition in HTML 4.0. This attribute is
