...
public class InputSource {
   ...
   *
   * <p>If the system identifier is a URL, it must be fully resolved (it may not be a relative URL).
   *
   ...
   *
   * <p>Application writers should use setSystemId() to provide a base for resolving relative URIs,
   * may use setPublicId to include a public identifier, and may use setEncoding to specify the
   ...
   *
   * <p>Application writers should use setSystemId() to provide a base for resolving relative URIs,
   * and may use setPublicId to include a public identifier.
   *
