 ...
 *
 * <p>When client applications specify the use of the static print/parse methods in {@link
 * DatatypeConverter}, it will delegate to this class.
 *
 * <p>This class is responsible for whitespace normalization.
 *
 * @author
 *     <ul>
...
final class DatatypeConverterImpl implements DatatypeConverterInterface {
  ...
  /**
   * Just return the string passed as a parameter but installs an instance of this class as the
   * DatatypeConverter implementation. Used from static fixed value initializers.
   */
