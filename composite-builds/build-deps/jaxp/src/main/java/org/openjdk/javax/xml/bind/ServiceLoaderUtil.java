...
/**
 * Shared ServiceLoader/FactoryFinder Utils shared among SAAJ, JAXB and JAXWS - this class must be
 * duplicated to all those projects, but it's basically generic code and we want to have it
 * everywhere same.
 *
...
class ServiceLoaderUtil {
  ...
  static Object lookupUsingOSGiServiceLoader(String factoryId, Logger logger) {
    ...
    try {
      ...
      if (iter.hasNext()) {
        ...
        logger.fine(
            "Found implementation using OSGi facility; returning object ["
  ...
  static Class nullSafeLoadClass(String className, ClassLoader classLoader)
