...
abstract class InlayHintRenderer() {
  ...
  fun measure(inlayHint: InlayHint, paint: Paint, params: InlayHintRenderParams): Float =
      onMeasure(inlayHint, paint, params)
   ...
   * careful that the given objects should not be modified, especially [paint] and [params]. They
   ...
   */
  abstract fun onMeasure(inlayHint: InlayHint, paint: Paint, params: InlayHintRenderParams): Float

  /**
   * Render the inlay hint on the given canvas. The [Canvas.translate] is called in advance so you
   * do not need to consider the exact line index. The left of the given canvas is where you should
   * start render your content and the top of the given canvas is the top of target line.
   *
   * Your measured width previously generated is passed to you. You are expected to make your
   * content in range, according to the [measuredWidth] and given line height in [params].
   *
