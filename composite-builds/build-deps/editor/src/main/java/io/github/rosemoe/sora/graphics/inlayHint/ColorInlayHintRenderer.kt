...
open class ColorInlayHintRenderer(val borderColor: ResolvableColor = ConstColor(Color.WHITE)) :
    InlayHintRenderer() {
  ...
  override fun onRender(
    ...
    localPaint.color = (inlayHint as? ColorInlayHint?)?.color?.resolve(colorScheme) ?: Color.WHITE
