...
interface DiagnosticTooltipLayout {
  ...
  /**
   * Render diagnostic information with its associated region metadata. The default implementation
   * delegates to the legacy overload for backwards compatibility.
   */
  ...
  /**
   * Notify the layout that the editor text size changed (values are in pixels). Default
   * implementation is a no-op for backwards compatibility.
   */
