...
/**
 * Container that keeps track of text highlight ranges (line/column pairs) and updates them
 * according to document insert/delete operations.
 */
class HighlightTextContainer {
  ...
  fun updateOnInsertion(startLine: Int, startColumn: Int, endLine: Int, endColumn: Int) {
    ...
    for (highlight in highlights) {
      ...
      if (
          comparePositions(startLine, startColumn, highlight.startLine, highlight.startColumn) < 0
      ) {
        val newStart =
            shiftForInsertion(
                highlight.startLine,
  ...
  fun updateOnDeletion(startLine: Int, startColumn: Int, endLine: Int, endColumn: Int) {
    ...
    while (iterator.hasNext()) {
      ...
      val startsBefore =
          comparePositions(highlight.startLine, highlight.startColumn, startLine, startColumn) < 0
      val endsAfter =
  ...
  private fun isNoOp(startLine: Int, startColumn: Int, endLine: Int, endColumn: Int): Boolean {
  ...
  companion object {
    private val highlightComparator =
        Comparator<HighlightText> { o1, o2 ->
          val startCompare =
              comparePositions(o1.startLine, o1.startColumn, o2.startLine, o2.startColumn)
          if (startCompare != 0) {
    ...
    private fun comparePositions(line1: Int, column1: Int, line2: Int, column2: Int): Int {
      if (line1 != line2) {
        return line1 - line2
      }
