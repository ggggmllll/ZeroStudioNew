  ...
  public Object[][] getContents() {
    return new Object[][] {
       ...
       */
      {
        ...
        "Impossible de convertir le type de retour/d''argument dans l''appel de la m\u00E9thode"
            + " ''{0}''"
      },
       ...
       */
      {
        ...
        "Op\u00E9ration import/include circulaire. La feuille de style ''{0}'' est d\u00E9j\u00E0"
            + " charg\u00E9e."
      },
       ...
       */
      {
        ...
        "Les fragments de l'arborescence de r\u00E9sultats ne peuvent pas \u00EAtre tri\u00E9s (les"
            + " \u00E9l\u00E9ments <xsl:sort> ne sont pas pris en compte). Vous devez trier les"
            + " noeuds lorsque vous cr\u00E9ez l'arborescence de r\u00E9sultats."
      },
       ...
       * in the stylesheet.
       */
      {ErrorMsg.STRAY_WHEN_ERR, "<xsl:when> ne peut \u00EAtre utilis\u00E9 que dans <xsl:choose>."},
       ...
       */
      {
        ...
        "Seuls les \u00E9l\u00E9ments <xsl:when> et <xsl:otherwise> sont autoris\u00E9s dans"
            + " <xsl:choose>."
      },
       ...
       */
      {
        ...
        "Le document d'entr\u00E9e n'est pas une feuille de style (l'espace de noms XSL n'est pas"
            + " d\u00E9clar\u00E9 dans l'\u00E9l\u00E9ment racine)."
      },
       ...
       */
      {
        ...
        "Impossible de lire la cible de feuille de style ''{0}'' car l''acc\u00E8s \u00E0 ''{1}''"
            + " n''est pas autoris\u00E9 en raison d''une restriction d\u00E9finie par la"
            + " propri\u00E9t\u00E9 accessExternalStylesheet."
      },
       ...
       */
      {ErrorMsg.JAXP_NO_SOURCE_ERR, "L''objet Source transmis \u00E0 ''{0}'' n''a pas de contenu."},
       ...
       */
      {
        ...
        "SYNTAXE\n"
            ...
            + "                  n'est pas prise en compte lors de la compilation de plusieurs"
            + " feuilles de style.\n"
            ...
            + "   -n             active le mode INLINE du mod\u00E8le (comportement par d\u00E9faut"
            + " am\u00E9lior\u00E9\n"
            + "                  en moyenne).\n"
            + "   -x             active la sortie de messages de d\u00E9bogage"
            + " suppl\u00E9mentaires\n"
            + "   -u             interpr\u00E8te les arguments <stylesheet> comme des URL\n"
            + "   -i             force le compilateur \u00E0 lire la feuille de style \u00E0 partir"
            + " de STDIN\n"
       ...
       */
      {
        ...
        "SYNTAXE \n"
            ...
            + "   la variable d'environnement CLASSPATH de l'utilisateur, soit dans un fichier"
            + " <jarfile> indiqu\u00E9 en option.\n"
            + "OPTIONS\n"
       ...
       */
      {
        ...
        "L''encodage de sortie ''{0}'' n''est pas pris en charge sur cette Java Virtual Machine"
            + " (JVM)."
      },
       ...
       */
      {
        ...
        "Impossible d''utiliser le nom ''{0}'' comme nom de classe de translet car il contient des"
            + " caract\u00E8res non autoris\u00E9s dans le nom de la classe Java. Le nom ''{1}'' a"
       ...
       */
      {
        ...
        "L''attribut \"method\" d''un \u00E9l\u00E9ment <xsl:output> avait la valeur ''{0}''. La"
            + " valeur doit \u00EAtre l''une des suivantes : ''xml'', ''html'', ''text'' ou"
      ...
      },
      {
        ...
        "FEATURE_SECURE_PROCESSING : impossible de d\u00E9finir la fonctionnalit\u00E9 sur False en"
            + " pr\u00E9sence du gestionnaire de s\u00E9curit\u00E9."
      },
       ...
       */
      {
        ...
        "Erreur XSLTC interne : le code ex\u00E9cutable g\u00E9n\u00E9r\u00E9 contient un bloc"
            + " try-catch-finally et ne peut pas \u00EAtre d\u00E9limit\u00E9."
      },
       ...
       */
      {
        ...
        "Erreur XSLTC interne : les marqueurs OutlineableChunkStart et OutlineableChunkEnd doivent"
            + " \u00EAtre \u00E9quilibr\u00E9s et correctement imbriqu\u00E9s."
      },
       ...
       */
      {
        ...
        "Erreur XSLTC interne : une instruction ayant fait partie d'un bloc de code ex\u00E9cutable"
            + " d\u00E9limit\u00E9 est toujours r\u00E9f\u00E9renc\u00E9e dans la m\u00E9thode"
            + " d'origine."
      },
       ...
       */
      {
        ...
        "Erreur XSLTC interne : une m\u00E9thode dans le translet d\u00E9passe la limite de la JVM"
            + " concernant la longueur d'une m\u00E9thode de 64 kilo-octets. En g\u00E9n\u00E9ral,"
            + " ceci est d\u00FB \u00E0 de tr\u00E8s grands mod\u00E8les dans une feuille de style."
            + " Essayez de restructurer la feuille de style pour utiliser des mod\u00E8les plus"
            + " petits."
      },
      {
