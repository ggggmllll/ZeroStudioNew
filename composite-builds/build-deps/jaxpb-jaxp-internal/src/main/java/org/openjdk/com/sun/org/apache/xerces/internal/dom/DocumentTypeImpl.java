...
public class DocumentTypeImpl extends ParentNode implements DocumentType {
  ...
  public DocumentTypeImpl(
      CoreDocumentImpl ownerDocument, String qualifiedName, String publicID, String systemID) {
  ...
  /**
   * Access the collection of general Entities, both external and internal, defined in the DTD. For
   * example, in:
   *
   * <p>
   *
   ...
   * </pre>
   *
   * <p>The Entities map includes foo and bar, but not baz. It is promised that only Nodes which are
   * Entities will exist in this NamedNodeMap.
   *
  ...
  /**
   * Access the collection of Notations defined in the DTD. A notation declares, by name, the format
   * of an XML unparsed entity or is used to formally declare a Processing Instruction target.
   */
