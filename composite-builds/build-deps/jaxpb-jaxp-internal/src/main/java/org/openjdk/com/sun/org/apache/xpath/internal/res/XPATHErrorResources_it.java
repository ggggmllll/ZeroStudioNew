  ...
  private static final Object[][] _contents =
      new Object[][] {
        ...
        {ER_ERROR_OCCURED, "Si \u00E8 verificato un errore."},
        {
          ...
          "Il valore di VariableReference specificato per la variabile \u00E8 fuori contesto o"
              + " senza definizione. Nome = {0}"
        },
        {
          ER_AXES_NOT_ALLOWED,
        ...
        {ER_UNSUPPORTED_ENCODING, "Codifica non supportata: {0}"},
        {
          ...
          "Si \u00E8 verificato un problema in DTM in getNextSibling... Tentativo di recupero in"
              + " corso."
        },
        {
          ER_CANNOT_WRITE_TO_EMPTYNODELISTIMPL,
        ...
        // the characters specified by the substitution text were encountered instead.
        {
          ...
          "\u00C8 previsto un percorso di posizione, ma \u00E8 stato trovato il seguente token: "
              + " {0}"
        },
        ...
        // to a value of type boolean.
        {
          ...
          "XPathResult dell''espressione XPath ''{0}'' a un valore di XPathResultType pari a {1}"
              + " che non pu\u00F2 essere convertito in un valore booleano."
        },
        ...
        // FIRST_ORDERED_NODE_TYPE.
        {
          ...
          "XPathResult dell''espressione XPath ''{0}'' a un valore di XPathResultType pari a {1}"
              + " che non pu\u00F2 essere convertito in un nodo singolo. Il metodo"
              + " getSingleNodeValue \u00E8 valido solo per i tipi ANY_UNORDERED_NODE_TYPE e"
              + " FIRST_ORDERED_NODE_TYPE."
        },
        ...
        // ORDERED_NODE_SNAPSHOT_TYPE.
        {
          ...
          "Impossibile richiamare il metodo getSnapshotLength nell''XPathResult dell''espressione"
              + " XPath ''{0}'' poich\u00E9 il valore di XPathResultType \u00E8 {1}. Questo metodo"
              + " \u00E8 valido solo per i tipi UNORDERED_NODE_SNAPSHOT_TYPE e"
              + " ORDERED_NODE_SNAPSHOT_TYPE."
        },
        {
          ER_NON_ITERATOR_TYPE,
          "Impossibile richiamare il metodo iterateNext nell''XPathResult dell''espressione XPath"
              + " ''{0}'' poich\u00E9 il valore di XPathResultType \u00E8 {1}. Questo metodo \u00E8"
              + " valido solo per i tipi UNORDERED_NODE_ITERATOR_TYPE e ORDERED_NODE_ITERATOR_TYPE."
        },
        ...
        {
          ER_DOC_MUTATED,
          "Il documento \u00E8 cambiato da quando \u00E8 stato restituito l'ultimo risultato."
              + " L'iteratore non \u00E8 valido."
        },
        ...
        {ER_EMPTY_XPATH_RESULT, "Oggetto risultati XPath vuoto"},
        {
          ...
          "XPathResult dell''espressione XPath ''{0}'' a un valore di XPathResultType pari a {1}"
              + " che non pu\u00F2 essere convertito forzatamente nel valore XPathResultType {2}."
        },
        ...
        // to a value of type string.
        {
          ...
          "XPathResult dell''espressione XPath ''{0}'' a un valore di XPathResultType pari a {1}"
              + " che non pu\u00F2 essere convertito in una stringa."
        },
        ...
        // UNORDERED_NODE_SNAPSHOT_TYPE and ORDERED_NODE_SNAPSHOT_TYPE.
        {
          ...
          "Impossibile richiamare il metodo snapshotItem nell''XPathResult dell''espressione XPath"
              + " ''{0}'' poich\u00E9 il valore di XPathResultType \u00E8 {1}. Questo metodo \u00E8"
              + " valido solo per i tipi UNORDERED_NODE_SNAPSHOT_TYPE e ORDERED_NODE_SNAPSHOT_TYPE."
        },
        ...
        {ER_XPATH_ERROR, "Errore sconosciuto nell'XPath."},
        {
          ER_CANT_CONVERT_XPATHRESULTTYPE_TO_NUMBER,
          "XPathResult dell''espressione XPath ''{0}'' a un valore di XPathResultType pari a {1}"
              + " che non pu\u00F2 essere convertito in un numero."
        },
        ...
        /** Field ER_OBJECT_MODEL_NULL */
        {
          ...
          "{0}#isObjectModelSupported( String objectModel ) non pu\u00F2 essere richiamato se"
              + " objectModel == null"
        },
        ...
        },
        {
          ...
          "FEATURE_SECURE_PROCESSING: impossibile impostare la funzione su false se \u00E8 presente"
              + " Security Manager: {1}#setFeature({0},{2})"
        },
...

        {
          ...
          "il nome di impostazioni nazionali nella funzione format-number non \u00E8 ancora"
              + " gestito."
        },
