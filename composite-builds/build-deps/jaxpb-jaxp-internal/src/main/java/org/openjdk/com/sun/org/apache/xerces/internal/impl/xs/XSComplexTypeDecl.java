...
public class XSComplexTypeDecl implements XSComplexTypeDefinition, TypeInfo {
  ...
  /**
   * A boolean that specifies if the type definition is anonymous. Convenience attribute. This is a
   * field is not part of XML Schema component model.
   */
  ...
  /**
   * {final} For complex type definition it is a subset of {extension, restriction}. For simple type
   * definition it is a subset of {extension, list, restriction, union}.
   *
  ...
  /**
   * {abstract} A boolean. Complex types for which {abstract} is true must not be used as the {type
   * definition} for the validation of element information items.
   */
