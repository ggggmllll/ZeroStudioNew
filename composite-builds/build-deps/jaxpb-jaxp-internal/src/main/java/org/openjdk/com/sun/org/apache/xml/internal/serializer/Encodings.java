...
public final class Encodings extends Object {
   ...
   * UTF-8 or UTF-16 instead. The XSLT processor must not use an encoding whose name does not match
   * the EncName production of the XML Recommendation [XML]. If no encoding attribute is specified,
   * then the XSLT processor should use either UTF-8 or UTF-16."
   *
  ...
  private static final class EncodingInfos {
     ...
     *
     * <p>System property "encodings" formatted using URL syntax may define an external encodings
     * list. Thanks to Sergey Ushakov for the code contribution!
     */
