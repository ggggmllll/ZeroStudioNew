...
public class XSSimpleTypeDecl implements XSSimpleType, TypeInfo {
  ...
  protected XSSimpleTypeDecl setRestrictionValues(
      XSSimpleTypeDecl base, String name, String uri, short finalSet, XSObjectList annotations) {
    ...
    if (fVariety == VARIETY_ATOMIC && fValidationDV != DV_ANYSIMPLETYPE) {
      if (fValidationDV == DV_ID || fValidationDV == DV_IDREF || fValidationDV == DV_ENTITY) {
        ...
        return DV_DECIMAL;
          ...
          && (fValidationDV == DV_YEARMONTHDURATION || fValidationDV == DV_DAYTIMEDURATION)) {
        return DV_DURATION;
      } else {
   ...
   * if this simple type is a built-in derived type integer the <code>INTEGER_DV</code> is returned.
   */
  ...
  /**
   * If variety is <code>atomic</code> the primitive type definition (a built-in primitive datatype
   * definition or the simple ur-type definition) is available, otherwise <code>null</code>.
   */
  ...
  void applyFacets(
    ...
    if ((presentFacet & FACET_MAXINCLUSIVE) != 0) {
      if ((allowedFacet & FACET_MAXINCLUSIVE) == 0) {
        ...
        try {
          ...
          reportError(
              "FacetValueFromBase",
              new Object[] {fTypeName, facets.maxInclusive, "maxInclusive", fBase.getName()});
        }
    ...
    if ((presentFacet & FACET_MAXEXCLUSIVE) != 0) {
      if ((allowedFacet & FACET_MAXEXCLUSIVE) == 0) {
        ...
        try {
          ...
          reportError(
              "FacetValueFromBase",
              new Object[] {fTypeName, facets.maxExclusive, "maxExclusive", fBase.getName()});
        }
    ...
    if ((presentFacet & FACET_MINEXCLUSIVE) != 0) {
      if ((allowedFacet & FACET_MINEXCLUSIVE) == 0) {
        ...
        try {
          ...
          reportError(
              "FacetValueFromBase",
              new Object[] {fTypeName, facets.minExclusive, "minExclusive", fBase.getName()});
        }
    ...
    if ((presentFacet & FACET_MININCLUSIVE) != 0) {
      if ((allowedFacet & FACET_MININCLUSIVE) == 0) {
        ...
        try {
          ...
          reportError(
              "FacetValueFromBase",
              new Object[] {fTypeName, facets.minInclusive, "minInclusive", fBase.getName()});
        }
          ...
          if ((fBase.fFixedFacet & FACET_MININCLUSIVE) != 0) {
            if (fDVs[fValidationDV].compare(fMinInclusive, fBase.fMinInclusive) != 0)
              reportError(
                  "FixedFacetValue",
                  new Object[] {
                    "minInclusive", facets.minInclusive, fBase.fMinInclusive, fTypeName
                  });
          }
        }
    ...
    if (fFacetsDefined != 0) {
      ...
      if (((fFacetsDefined & FACET_MAXEXCLUSIVE) != 0)
        ...
        reportError(
            "maxInclusive-maxExclusive", new Object[] {fMaxInclusive, fMaxExclusive, fTypeName});
      }
      ...
      if (((fFacetsDefined & FACET_MINEXCLUSIVE) != 0)
        ...
        reportError(
            "minInclusive-minExclusive", new Object[] {fMinInclusive, fMinExclusive, fTypeName});
      }
      ...
      if (((fFacetsDefined & FACET_FRACTIONDIGITS) != 0)
        ...
        if (fFractionDigits > fTotalDigits)
          reportError(
              ...
              new Object[] {
                Integer.toString(fFractionDigits), Integer.toString(fTotalDigits), fTypeName
              });
      }
      ...
      if ((fFacetsDefined & FACET_LENGTH) != 0) {
        if ((fBase.fFacetsDefined & FACET_MINLENGTH) != 0 && fLength < fBase.fMinLength) {
          ...
          reportError(
              ...
              new Object[] {
                fTypeName, Integer.toString(fLength), Integer.toString(fBase.fMinLength)
              });
        }
        if ((fBase.fFacetsDefined & FACET_MAXLENGTH) != 0 && fLength > fBase.fMaxLength) {
          ...
          reportError(
              ...
              new Object[] {
                fTypeName, Integer.toString(fLength), Integer.toString(fBase.fMaxLength)
              });
        }
        if ((fBase.fFacetsDefined & FACET_LENGTH) != 0) {
          ...
          if (fLength != fBase.fLength)
            reportError(
                ...
                new Object[] {
                  Integer.toString(fLength), Integer.toString(fBase.fLength), fTypeName
                });
        }
      }
        ...
        if ((fFacetsDefined & FACET_MINLENGTH) != 0) {
          if (fBase.fLength < fMinLength) {
            ...
            reportError(
                "length-minLength-maxLength.1.1",
                new Object[] {
                  fTypeName, Integer.toString(fBase.fLength), Integer.toString(fMinLength)
                });
          }
          ...
          if (fMinLength != fBase.fMinLength) {
            reportError(
                ...
                new Object[] {
                  fTypeName, Integer.toString(fMinLength), Integer.toString(fBase.fMinLength)
                });
          }
        }
        if ((fFacetsDefined & FACET_MAXLENGTH) != 0) {
          if (fBase.fLength > fMaxLength) {
            ...
            reportError(
                "length-minLength-maxLength.2.1",
                new Object[] {
                  fTypeName, Integer.toString(fBase.fLength), Integer.toString(fMaxLength)
                });
          }
          ...
          if (fMaxLength != fBase.fMaxLength) {
            reportError(
                ...
                new Object[] {
                  fTypeName, Integer.toString(fMaxLength), Integer.toString(fBase.fBase.fMaxLength)
                });
          }
        }
      }
        ...
        if ((fBase.fFacetsDefined & FACET_MAXLENGTH) != 0) {
          if (fMinLength > fBase.fMaxLength) {
            reportError(
                "minLength-less-than-equal-to-maxLength",
                new Object[] {
                  Integer.toString(fMinLength), Integer.toString(fBase.fMaxLength), fTypeName
                });
          }
          ...
          if (fMinLength < fBase.fMinLength) {
            reportError(
                ...
                new Object[] {
                  Integer.toString(fMinLength), Integer.toString(fBase.fMinLength), fTypeName
                });
          }
        }
      }
        ...
        if ((fBase.fFacetsDefined & FACET_MAXLENGTH) != 0) {
          ...
          if (fMaxLength > fBase.fMaxLength) {
            reportError(
                ...
                new Object[] {
                  Integer.toString(fMaxLength), Integer.toString(fBase.fMaxLength), fTypeName
                });
          }
        }
      }
        ...
        if (((fBase.fFacetsDefined & FACET_TOTALDIGITS) != 0)) {
          ...
          if (fTotalDigits > fBase.fTotalDigits) {
            reportError(
                ...
                new Object[] {
                  Integer.toString(fTotalDigits), Integer.toString(fBase.fTotalDigits), fTypeName
                });
          }
        }
      }
      ...
      if ((fFacetsDefined & FACET_MAXLENGTH) != 0) {
        if (length > fMaxLength) {
          throw new InvalidDatatypeValueException(
              "cvc-maxLength-valid",
              new Object[] {
                content, Integer.toString(length), Integer.toString(fMaxLength), fTypeName
              });
        }
      }
      ...
      if ((fFacetsDefined & FACET_MINLENGTH) != 0) {
        if (length < fMinLength) {
          throw new InvalidDatatypeValueException(
              "cvc-minLength-valid",
              new Object[] {
                content, Integer.toString(length), Integer.toString(fMinLength), fTypeName
              });
        }
      }
      ...
      if ((fFacetsDefined & FACET_LENGTH) != 0) {
        if (length != fLength) {
          throw new InvalidDatatypeValueException(
              "cvc-length-valid",
              new Object[] {
                content, Integer.toString(length), Integer.toString(fLength), fTypeName
              });
        }
      }
    }
  ...
  private Object getActualValue(
      Object content, ValidationContext context, ValidatedInfo validatedInfo, boolean needNormalize)
      throws InvalidDatatypeValueException {
    ...
    if ((fFacetsDefined & FACET_PATTERN) != 0) {
      ...
      for (int idx = fPattern.size() - 1; idx >= 0; idx--) {
        ...
        if (!regex.matches(nvalue)) {
          throw new InvalidDatatypeValueException(
              "cvc-pattern-valid", new Object[] {content, fPatternStr.elementAt(idx), fTypeName});
        }
      }
    }
    ...
    if (fVariety == VARIETY_ATOMIC) {
      ...
      throw new InvalidDatatypeValueException(
          "cvc-datatype-valid.1.2.3", new Object[] {content, fTypeName, typesBuffer.toString()});
    }
  } // getActualValue()
    ...
    if (fEnumerationItemTypeList == null) {
      ...
      fEnumerationItemTypeList =
          new AbstractObjectList() {
            ...
            public boolean contains(Object item) {
              if (fEnumerationItemType == null || !(item instanceof ShortList)) return false;
  ...
  private void setOrdered() {
    ...
    // When {variety} is atomic, {value} is inherited from {value} of {base type definition}. For
    // all "primitive" types {value} is as specified in the table in Fundamental Facets (C.1).
    if (fVariety == VARIETY_ATOMIC) {
    ...
    // 1. If every member of {member type definitions} is derived from a common ancestor other than
    // the simple ur-type, then {value} is the same as that ancestor's ordered facet.
    // 2. If every member of {member type definitions} has a {value} of false for the ordered facet,
    // then {value} is false.
      ...
      for (int i = 0; i < memberTypes.getLength(); i++) {
        ...
        if (memberTypes.item(i) != null) {
          ...
          if (isDerivedByRestriction(
              ancestorNS, ancestorName, (XSSimpleTypeDefinition) memberTypes.item(i))) {
            return true;
          }
        }
      }
  ...
  /**
   * A list of constraining facets if it exists, otherwise an empty <code>XSObjectList</code>. Note:
   * This method must not be used to retrieve values for <code>enumeration</code> and <code>pattern
   * </code> facets.
   */
  ...
  public XSObjectList getMultiValueFacets() {
    if (fMultiValueFacets == null
      ...
      if ((fFacetsDefined & FACET_PATTERN) != 0
          ...
          || fValidationDV == DV_INTEGER) {
        facets[count] =
            new XSMVFacetImpl(FACET_PATTERN, this.getLexicalPattern(), patternAnnotations);
        count++;
      }
      if (fEnumeration != null) {
        facets[count] =
            new XSMVFacetImpl(
                FACET_ENUMERATION, this.getLexicalEnumeration(), enumerationAnnotations);
        count++;
      }
