...
public class CachingParserPool {
   ...
   *     not allowed to add new symbols to the main symbol table. New symbols are added to the
  ...
  public static final class ShadowedGrammarPool extends XMLGrammarPoolImpl {
    ...
    /**
     * Retrieve the initial set of grammars for the validator to work with. REVISIT: does this need
     * to be synchronized since it's just reading?
     *
     * @param grammarType Type of the grammars to be retrieved.
     * @return The initial grammar set the validator may place in its "bucket"
     */
