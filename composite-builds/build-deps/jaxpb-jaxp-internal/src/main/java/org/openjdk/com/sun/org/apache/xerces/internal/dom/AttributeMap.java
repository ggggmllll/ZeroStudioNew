...
public class AttributeMap extends NamedNodeMapImpl {
   ...
   * contents. If node does not belong to this named node map, we throw a DOMException.
   *
  ...
  /**
   * Internal removeNamedItem method allowing to specify whether an exception must be thrown if the
