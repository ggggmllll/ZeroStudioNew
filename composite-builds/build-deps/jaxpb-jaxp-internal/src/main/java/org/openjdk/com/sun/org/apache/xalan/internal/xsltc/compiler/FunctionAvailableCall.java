...
final class FunctionAvailableCall extends FunctionCall {
  ...
  /**
   * Returns an object representing the compile-time evaluation of an expression. We are only using
   * this for function-available and element-available at this time.
   */
  ...
  /**
   * Reports on whether the function specified in the argument to xslt function 'function-available'
   * was found.
   */
  ...
  /**
   * Calls to 'function-available' are resolved at compile time since the namespaces declared in the
   * stylsheet are not available at run time. Consequently, arguments to this function must be
   * literals.
   */
