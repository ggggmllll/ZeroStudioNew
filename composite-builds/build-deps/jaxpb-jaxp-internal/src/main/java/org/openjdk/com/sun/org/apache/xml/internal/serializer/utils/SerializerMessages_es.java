    ...
    Object[][] contents =
        new Object[][] {
          ...
          },
          {
            ...
            "Advertencia: es necesario que la versi\u00F3n del documento de salida sea ''{0}''."
                + " Esta versi\u00F3n de XML no est\u00E1 soportada. La versi\u00F3n del documento"
                + " de salida ser\u00E1 ''1.0''."
          },
           ...
           */
          {
            ...
            "El objeto de propiedades transferido a SerializerFactory no tiene una propiedad"
                + " ''{0}''."
          },
          {
            MsgKey.ER_ENCODING_NOT_SUPPORTED,
            "Advertencia: el tiempo de ejecuci\u00F3n de Java no soporta la codificaci\u00F3n"
                + " ''{0}''."
          },
        };
