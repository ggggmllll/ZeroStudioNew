  ...
  public void addExternalEntity(
    ...
    if (!fEntities.containsKey(name)) {
      if (baseSystemId == null) {
         ...
         * (ScannedEntity)fEntityStack.elementAt(i); if (externalEntity.entityLocation != null &&
         * externalEntity.entityLocation.getExpandedSystemId() != null) { baseSystemId =
         * externalEntity.entityLocation.getExpandedSystemId(); break; } }
         */
      }
