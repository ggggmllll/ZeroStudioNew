  ...
  public Object[][] getContents() {
    Object[][] contents =
        new Object[][] {
          {
            MsgKey.BAD_MSGKEY,
            "Der Nachrichtenschl\u00FCssel \"{0}\" ist nicht in der Nachrichtenklasse \"{1}\""
                + " enthalten"
          },
          {
            MsgKey.BAD_MSGFORMAT,
            "Das Format der Nachricht \"{0}\" in der Nachrichtenklasse \"{1}\" war nicht"
                + " erfolgreich."
          },
          {
          ...
          },
          {
            ...
            "Warnung: Die Version des Ausgabedokuments soll \"{0}\" sein. Diese Version von XML"
                + " wird nicht unterst\u00FCtzt. Die Version des Ausgabedokuments wird \"1.0\""
                + " sein."
          },
           ...
           */
          {
            ...
            "Das an die SerializerFactory \u00FCbergebene Properties-Objekt verf\u00FCgt \u00FCber"
                + " keine Eigenschaft \"{0}\"."
          },
          {
