...
public class ErrorMessages_es extends ListResourceBundle {
  ...
  public Object[][] getContents() {
    return new Object[][] {
       ...
       */
      {
        ErrorMsg.NAMESPACE_UNDEF_ERR, "No se ha declarado el prefijo de espacio de nombres ''{0}''."
      },
       ...
       */
      {ErrorMsg.ILLEGAL_CHAR_ERR, "Car\u00E1cter ''{0}'' no permitido en la expresi\u00F3n XPath."},
       ...
       */
      {
        ...
        "Los fragmentos del \u00E1rbol de resultados no se pueden ordenar (los elementos <xsl:sort>"
            + " se ignoran). Debe ordenar los nodos al crear el \u00E1rbol de resultados."
      },
       ...
       */
      {
        ErrorMsg.STRAY_OTHERWISE_ERR, "<xsl:otherwise> s\u00F3lo se puede utilizar en <xsl:choose>."
      },
       ...
       */
      {
        ...
        "El documento de entrada no es una hoja de estilo (el espacio de nombres XSL no se ha"
            + " declarado en el elemento ra\u00EDz)."
      },
       ...
       */
      {
        ...
        "No se ha podido leer el destino de hoja de estilos ''{0}'', porque no se permite el acceso"
            + " ''{1}'' debido a una restricci\u00F3n definida por la propiedad"
       ...
       */
      {ErrorMsg.NOT_STYLESHEET_ERR, "El documento de entrada no contiene una hoja de estilo XSL."},
       ...
       * type {0}.
       */
      {ErrorMsg.DATA_CONVERSION_ERR, "No se puede convertir el tipo de datos ''{0}'' en ''{1}''."},
       ...
       */
      {ErrorMsg.ERROR_LISTENER_NULL_ERR, "Intentando definir ErrorListener para ''{0}'' como nulo"},
       ...
       */
      {
        ...
        "SINOPSIS\n"
            ...
            + "   -p <paquete>   especifica un prefijo de nombre de paquete para todas las clases"
            + " de translet n\n"
            + "                  generadas.\n"
            + "   -n             permite poner en l\u00EDnea la plantilla (comportamiento por"
            + " defecto mejor\n"
            + "                  sobre la media).\n"
       ...
       */
      {
        ...
        "SYNOPSIS \n"
            + "   java com.sun.org.apache.xalan.internal.xsltc.cmdline.Transform [-j <archivo"
            + " jar>]\n"
       ...
       */
      {
        ...
        "El primer argumento de la funci\u00F3n Java no est\u00E1tica ''{0}'' no es una referencia"
            + " de objeto v\u00E1lida."
      },
       ...
       */
      {
        ErrorMsg.TRANSFORM_WITH_TRANSLET_STR, "Transformaci\u00F3n que utiliza el translet ''{0}'' "
      },
       ...
       */
      {
        ...
        "El nombre ''{0}'' no se ha podido utilizar como el nombre de la clase de translet porque"
            + " contiene caracteres que no est\u00E1n permitidos en el nombre de la clase Java. Se"
            + " ha utilizado el nombre ''{1}'' en su lugar."
      },
       ...
       */
      {
        ...
        "Un atributo cuyo valor debe ser un QName o lista de QNames separados por espacios en"
            + " blanco ten\u00EDa el valor ''{0}''"
      },
       ...
       */
      {
        ...
        "El atributo method de un elemento <xsl:output> ten\u00EDa el valor ''{0}''. El valor debe"
            + " ser ''xml'', ''html'', ''text'' o qname-but-not-ncname"
      },
      {
      ...
      },
      {
        ...
        "FEATURE_SECURE_PROCESSING: no se puede definir la funci\u00F3n en false cuando est\u00E1"
            + " presente el gestor de seguridad."
      },
       ...
       */
      {
        ...
        "Error interno de XSLTC: los marcadores OutlineableChunkStart y OutlineableChunkEnd deben"
            + " estar equilibrados y correctamente anidados."
      },
       ...
       */
      {
        ...
        "Error interno de XSLTC: todav\u00EDa se hace referencia a una instrucci\u00F3n que formaba"
            + " parte de un bloque de c\u00F3digo de bytes delimitado en el m\u00E9todo original."
      },
       ...
       */
      {
        ...
        "Error interno de XSLTC: un m\u00E9todo en el translet excede la limitaci\u00F3n de Java"
            + " Virtual Machine de longitud de un m\u00E9todo de 64 kilobytes. Normalmente, esto lo"
            + " causan plantillas en una hoja de estilos demasiado grandes. Pruebe a reestructurar"
            + " la hoja de estilos para utilizar plantillas m\u00E1s peque\u00F1as."
      },
      {
        ErrorMsg.DESERIALIZE_TRANSLET_ERR,
        "Cuando la seguridad de Java est\u00E1 activada, el soporte para anular la"
            + " serializaci\u00F3n de TemplatesImpl est\u00E1 desactivado. Esto se puede sustituir"
            + " definiendo la propiedad del sistema jdk.xml.enableTemplatesImplDeserialization en"
            + " true."
      }
    };
  }
