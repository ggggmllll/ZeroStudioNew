...
public final class ToXMLSAXHandler extends ToSAXHandler {
  ...
  /**
   * Start an element in the output document. This might be an XML element (<elem>data</elem> type)
   * or a CDATA section.
   */
  ...
  public void startElement(String namespaceURI, String localName, String name, Attributes atts)
    ...
    if (m_needToOutputDocTypeDecl) {
      ...
      if (doctypeSystem != null && m_lexHandler != null) {
        ...
        if (doctypeSystem != null) m_lexHandler.startDTD(name, doctypePublic, doctypeSystem);
      }
