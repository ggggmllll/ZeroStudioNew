...
public class PSVIAttrNSImpl extends AttrNSImpl implements AttributePSVI {
  ...
  public PSVIAttrNSImpl(
      CoreDocumentImpl ownerDocument, String namespaceURI, String qualifiedName, String localName) {
   ...
   * complex type definition whose {content type} is a simple thype definition with {variety} union,
   * then an item isomorphic to that member of the union's {member type definitions} which actually
