...
public class XSLTErrorResources_de extends ListResourceBundle {
  ...
  public Object[][] getContents() {
    return new Object[][] {
      ...
      {ER_REQUIRES_ELEMENTS_ATTRIB, "(StylesheetHandler) {0} erfordert ein \"elements\"-Attribut."},
      ...
      },
      {
        ...
        "default-space wird nicht mehr unterst\u00FCtzt. Verwenden Sie stattdessen xsl:strip-space"
            + " oder xsl:preserve-space."
      },
      {
      ...
      {
        ER_BAD_XSLSORT_USE,
        "(StylesheetHandler) xsl:sort kann nur mit xsl:apply-templates oder xsl:for-each verwendet"
            + " werden."
      },
      ...
      {ER_STYLESHEET_REQUIRES_VERSION_ATTRIB, "xsl:stylesheet erfordert ein \"version\"-Attribut."},
      ...
      {ER_NO_APPLY_IMPORT_IN_FOR_EACH, "xsl:apply-imports nicht zul\u00E4ssig in xsl:for-each"},
      {
        ...
        "DTMLiaison kann nicht f\u00FCr einen Ausgabe-DOM-Knoten verwendet werden. \u00DCbergeben"
            + " Sie stattdessen einen com.sun.org.apache.xpath.internal.DOM2Helper."
      },
      {
        ER_CANT_USE_DTM_FOR_INPUT,
        "DTMLiaison kann nicht f\u00FCr einen Eingabe-DOM-Knoten verwendet werden. \u00DCbergeben"
            + " Sie stattdessen einen com.sun.org.apache.xpath.internal.DOM2Helper."
      },
      ...
      {ER_CANNOT_CREATE_EXTENSN, "Erweiterung {0} konnte nicht erstellt werden; Grund: {1}"},
      {
        ...
        "Der Aufruf einer Instanzmethode von Methode {0} erfordert eine Objektinstanz als erstes"
            + " Argument"
      },
      ...
      {
        ER_MORE_MATCH_ELEMENT, "Mehrere passende \u00DCbereinstimmungen f\u00FCr Elementmethode {0}"
      },
      ...
      {ER_PROPERTY_VALUE_BOOLEAN, "Wert f\u00FCr Eigenschaft {0} muss eine boolesche Instanz sein"},
      ...
      {ER_VALUE_SHOULD_BE_NUMBER, "Wert f\u00FCr {0} sollte eine parsef\u00E4hige Zahl enthalten"},
      ...
      {
        ER_NULL_URI_NAMESPACE, "Versuch, ein Namespace-Pr\u00E4fix mit einem Null-URI zu generieren"
      },
      {
        ER_NUMBER_TOO_BIG,
      ...
      {
        ER_PARSER_PROPERTY_NOT_SPECIFIED, "Systemeigenschaft \"org.xml.sax.parser\" nicht angegeben"
      },
      ...
      {ER_NOT_ALLOWED_IN_POSITION, "{0} ist an dieser Position im Stylesheet nicht zul\u00E4ssig."},
      {
        ER_NONWHITESPACE_NOT_ALLOWED_IN_POSITION,
      ...
      {
        INVALID_TCHAR,
        "Ung\u00FCltiger Wert {1} f\u00FCr CHAR-Attribut {0} verwendet. Ein Attribut des Typs CHAR"
            + " darf nur 1 Zeichen enthalten."
      },
      ...
      {
        INVALID_ENUM,
        "Ung\u00FCltiger Wert {1} f\u00FCr ENUM-Attribut {0} verwendet. G\u00FCltige Werte sind:"
            + " {2}."
      },
      ...
      {
        ER_INVALID_SET_PARAM_VALUE, "Wert von Parameter {0} muss ein g\u00FCltiges Java-Objekt sein"
      },
      {
        ER_INVALID_NAMESPACE_URI_VALUE_FOR_RESULT_PREFIX_FOR_DEFAULT,
        "Das result-prefix-Attribut eines xsl:namespace-alias-Elements hat den Wert \"#default\","
            + " es ist aber keine Deklaration des Standard-Namespace im G\u00FCltigkeitsbereich"
            + " f\u00FCr das Element vorhanden"
      },
      {
        ER_INVALID_NAMESPACE_URI_VALUE_FOR_RESULT_PREFIX,
        "Das result-prefix-Attribut eines xsl:namespace-alias-Elements hat den Wert \"{0}\", es ist"
            + " aber keine Namespace-Deklaration f\u00FCr das Pr\u00E4fix \"{0}\" im"
            + " G\u00FCltigkeitsbereich f\u00FCr das Element vorhanden."
      },
      {
        ER_SET_FEATURE_NULL_NAME,
        "Der Featurename darf nicht null in TransformerFactory.setFeature(Zeichenfolgenname,"
      ...
      {
        ER_EXTENSION_ELEMENT_NOT_ALLOWED_IN_SECURE_PROCESSING,
        "Verwendung des Erweiterungselements \"{0}\" ist nicht zul\u00E4ssig, wenn das Feature"
            + " f\u00FCr die sichere Verarbeitung auf \"true\" gesetzt ist."
      },
      {
        ER_NAMESPACE_CONTEXT_NULL_NAMESPACE,
      ...
      {WG_STYLESHEET_REQUIRES_VERSION_ATTRIB, "xsl:stylesheet erfordert ein \"version\"-Attribut."},
      {WG_ILLEGAL_ATTRIBUTE_NAME, "Ung\u00FCltiger Attributname: {0}"},
      {WG_ILLEGAL_ATTRIBUTE_VALUE, "Ung\u00FCltiger Wert f\u00FCr Attribut {0}: {1}"},
      {
        WG_EMPTY_SECOND_ARG,
        "Resultierendes NodeSet aus zweitem Argument von Dokumentfunktion ist leer. Geben Sie ein"
            + " leeres NodeSet zur\u00FCck."
      },
      ...
      {
        WG_PROCESSINGINSTRUCTION_NAME_CANT_BE_XML,
        "Der Wert des \"name\"-Attributs des xsl:processing-instruction-Namens darf nicht \"xml\""
            + " sein"
      },
      ...
      {
        WG_PROCESSINGINSTRUCTION_NOTVALID_NCNAME,
        "Der Wert des \"name\"-Attributs von xsl:processing-instruction muss ein g\u00FCltiger"
            + " NCName sein: {0}"
      },
      ...
      // the attribute.
      {
        ...
        "Attribut {0} kann nicht nach untergeordneten Knoten oder vor dem Erstellen eines Elements"
            + " hinzugef\u00FCgt werden. Attribut wird ignoriert."
      },
      {
        NO_MODIFICATION_ALLOWED_ERR,
        "Es wurde versucht, ein Objekt zu \u00E4ndern, bei dem \u00C4nderungen nicht zul\u00E4ssig"
            + " sind."
      },
      ...
      {
        "xslProc_no_input",
        "Fehler: Kein Stylesheet und keine Eingabe-XML angegeben. F\u00FChren Sie diesen Befehl"
            + " ohne Optionen f\u00FCr Verwendungsanweisungen aus."
      },
      ...
      {
        "noParsermsg4",
        "Wenn Sie nicht \u00FCber den XML-Parser f\u00FCr Java von IBM verf\u00FCgen, k\u00F6nnen"
            + " Sie ihn hier herunterladen:"
      },
      ...
      },
      {
        ...
        "   [-ENTITYRESOLVER full class name (EntityResolver f\u00FCr die Aufl\u00F6sung von"
            + " Entit\u00E4ten)]"
      },
      {
        "optionCONTENTHANDLER",
        "   [-CONTENTHANDLER full class name (ContentHandler f\u00FCr die Serialisierung der"
            + " Ausgabe)]"
      },
      ...
      {
        "optionMEDIA",
        "   [-MEDIA mediaType (\"media\"-Attribut verwenden, um mit einem Dokument verkn\u00FCpftes"
      ...
      {"optionDIAG", "   [-DIAG (Gesamtdauer der Transformation in Millisekunden drucken.)]"},
      {
        ...
        "   [-INCREMENTAL (inkrementelle DTM-Konstruktion anfordern, indem"
            + " http://xml.apache.org/xalan/features/incremental auf \"true\" gesetzt wird.)]"
      },
      {
        "optionNOOPTIMIMIZE",
      ...
      {
        "optionRL",
        "   [-RL recursionlimit (numerischen Grenzwert f\u00FCr Stylesheet-Rekursionstiefe bekannt"
            + " machen.)]"
      },
