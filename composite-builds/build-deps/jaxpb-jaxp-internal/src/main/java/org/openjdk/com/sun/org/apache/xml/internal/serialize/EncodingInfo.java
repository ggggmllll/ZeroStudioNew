...
public class EncodingInfo {
   ...
   * accomplishes this using a java.nio.CharsetEncoder. If NIO isn't available it will attempt use a
    ...
    if (fCharsetEncoder == null
      ...
      try {
        ...
        if (((Boolean) CharsetMethods.fgCharsetCanEncodeMethod.invoke(charset, (Object[]) null))
            .booleanValue()) {
          fCharsetEncoder =
              CharsetMethods.fgCharsetNewEncoderMethod.invoke(charset, (Object[]) null);
        }
    ...
    if (fCharToByteConverter == null) {
      ...
      try {
        ...
        fCharToByteConverter =
            CharToByteConverterMethods.fgGetConverterMethod.invoke(null, fArgsForMethod);
      } catch (Exception e) {
        // don't try it again...
        fHaveTriedCToB = true;
        return false;
