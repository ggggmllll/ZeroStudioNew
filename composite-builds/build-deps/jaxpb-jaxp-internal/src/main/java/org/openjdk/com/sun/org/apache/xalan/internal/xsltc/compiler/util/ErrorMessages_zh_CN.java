...
public class ErrorMessages_zh_CN extends ListResourceBundle {
  ...
  public Object[][] getContents() {
    return new Object[][] {
       ...
       */
      {
        ErrorMsg.SYMBOLS_REDEF_ERR, "\u5DF2\u5B9A\u4E49\u5341\u8FDB\u5236\u683C\u5F0F ''{0}''\u3002"
      },
       ...
       */
      {
        ...
        "<xsl:choose> \u4E2D\u4EC5\u5141\u8BB8\u4F7F\u7528 <xsl:when> \u548C <xsl:otherwise>"
            + " \u5143\u7D20\u3002"
      },
       ...
       */
      {
        ...
        "\u63D0\u8981\n"
            ...
            + " \u4F4D\u4E8E\n"
            + "   \u7528\u6237\u7684 CLASSPATH \u6216\u9009\u62E9\u6027\u6307\u5B9A\u7684 <jarfile>"
            + " \u4E2D\u3002\n"
            + "\u9009\u9879\n"
            + "   -j <jarfile>    \u6307\u5B9A\u8981\u4ECE\u4E2D\u52A0\u8F7D translet \u7684"
            + " jarfile\n"
            + "   -x              \u542F\u7528\u5176\u4ED6\u8C03\u8BD5\u6D88\u606F\u8F93\u51FA\n"
            + "   -n <\u8FED\u4EE3\u6570> \u8FD0\u884C <\u8FED\u4EE3\u6570>"
            + " \u6B21\u8F6C\u6362\u5E76\n"
       ...
       */
      {
        ...
        "<xsl:output> \u5143\u7D20\u7684 method \u5C5E\u6027\u5177\u6709\u503C"
            + " ''{0}''\u3002\u8BE5\u503C\u5FC5\u987B\u662F ''xml'', ''html'', ''text'' \u6216"
            + " qname-but-not-ncname \u4E4B\u4E00"
      },
      {
       ...
       */
      {
        ...
        "\u5185\u90E8 XSLTC \u9519\u8BEF: \u751F\u6210\u7684\u5B57\u8282\u4EE3\u7801\u5305\u542B"
            + " try-catch-finally \u5757, \u65E0\u6CD5\u8FDB\u884C Outlined\u3002"
      },
       ...
       */
      {
        ...
        "\u5185\u90E8 XSLTC \u9519\u8BEF: translet \u4E2D\u7684\u65B9\u6CD5\u8D85\u8FC7\u4E86 Java"
            + " \u865A\u62DF\u673A\u7684\u65B9\u6CD5\u957F\u5EA6\u9650\u5236 64"
