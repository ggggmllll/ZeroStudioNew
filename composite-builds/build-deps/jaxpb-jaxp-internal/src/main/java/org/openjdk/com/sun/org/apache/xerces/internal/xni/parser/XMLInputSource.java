...
public class XMLInputSource {
   ...
   * instantiated, then the code that opens the stream should also set the character stream on this
   * object. Also, the encoding of the byte stream used by the reader should also be set on this
   * object, if known.
   *
