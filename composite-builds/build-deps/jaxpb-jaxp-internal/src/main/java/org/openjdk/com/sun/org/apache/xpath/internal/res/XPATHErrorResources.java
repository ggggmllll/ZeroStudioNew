  ...
  private static final Object[][] _contents =
      new Object[][] {
        ...
        {ER_FOUND_COMMA_BUT_NO_FOLLOWING_ARG, "Found ',' but no following argument!"},
        {
          ...
          "'..[predicate]' or '.[predicate]' is illegal syntax.  Use 'self::node()[predicate]'"
              + " instead."
        },
        ...
        // to a value of type boolean.
        {
          ...
          "The XPathResult of XPath expression ''{0}'' has an XPathResultType of {1} which cannot"
        ...
        // FIRST_ORDERED_NODE_TYPE.
        {
          ...
          "The XPathResult of XPath expression ''{0}'' has an XPathResultType of {1} which cannot"
              + " be converted to a single node. The method getSingleNodeValue applies only to"
              + " types ANY_UNORDERED_NODE_TYPE and FIRST_ORDERED_NODE_TYPE."
        },
        ...
        // ORDERED_NODE_SNAPSHOT_TYPE.
        {
          ...
          "The method getSnapshotLength cannot be called on the XPathResult of XPath expression"
              + " ''{0}'' because its XPathResultType is {1}. This method applies only to types"
              + " UNORDERED_NODE_SNAPSHOT_TYPE and ORDERED_NODE_SNAPSHOT_TYPE."
        },
        {
          ER_NON_ITERATOR_TYPE,
          "The method iterateNext cannot be called on the XPathResult of XPath expression ''{0}''"
              + " because its XPathResultType is {1}. This method applies only to types"
        ...
        {ER_EMPTY_XPATH_RESULT, "Empty XPath result object"},
        {
          ...
          "The XPathResult of XPath expression ''{0}'' has an XPathResultType of {1} which cannot"
              + " be coerced into the specified XPathResultType of {2}."
        },
        ...
        // UNORDERED_NODE_SNAPSHOT_TYPE and ORDERED_NODE_SNAPSHOT_TYPE.
        {
          ...
          "The method snapshotItem cannot be called on the XPathResult of XPath expression ''{0}''"
              + " because its XPathResultType is {1}. This method applies only to types"
              + " UNORDERED_NODE_SNAPSHOT_TYPE and ORDERED_NODE_SNAPSHOT_TYPE."
        },
