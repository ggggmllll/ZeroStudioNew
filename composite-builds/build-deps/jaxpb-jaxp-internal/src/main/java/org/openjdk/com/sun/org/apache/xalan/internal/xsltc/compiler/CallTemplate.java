...
final class CallTemplate extends Instruction {
  ...
  /**
   * The array of effective parameters in this CallTemplate. An object in this array can be either a
   * WithParam or a Param if no WithParam exists for a particular parameter.
   */
  ...
  public void translate(ClassGenerator classGen, MethodGenerator methodGen) {
    ...
    StringBuffer methodSig =
        new StringBuffer("(" + DOM_INTF_SIG + NODE_ITERATOR_SIG + TRANSLET_OUTPUT_SIG + NODE_SIG);
