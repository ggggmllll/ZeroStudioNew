...
public class EntityReferenceImpl extends ParentNode implements EntityReference {
  ...
  /**
   * NON-DOM: compute string representation of the entity reference. This method is used to retrieve
   * a string value for an attribute node that has child nodes.
   *
   ...
   * creates them if they haven't been created yet. This doesn't support editing the Entity though,
   * since this only called once for all.
   */
