      ...
      new Object[][] {
        ...
        {ER_CURRENT_TAKES_NO_ARGS, "current()-Funktion akzeptiert keine Argumente."},
        {
          ...
          "document()-Funktionsimplementierung wurde durch"
              + " org.openjdk.com.sun.org.apache.xalan.internal.xslt.FuncDocument ersetzt."
        },
        ...
        },
        {
          ...
          "\"..[predicate]\" oder \".[predicate]\" ist ung\u00FCltige Syntax. Verwenden Sie"
              + " stattdessen \"self::node()[predicate]\"."
        },
        ...
        {ER_ERROR_OCCURED, "Fehler aufgetreten."},
        {
          ...
          "VariableReference au\u00DFerhalb des Kontextes oder ohne Definition f\u00FCr Variable"
              + " angegeben. Name = {0}"
        },
        {
          ER_AXES_NOT_ALLOWED,
          "Nur \"child::\"- und \"attribute::\"-Achsen sind in Vergleichsmustern zul\u00E4ssig."
              + " Betreffende Achsen = {0}"
        },
        ...
        {ER_PREFIX_MUST_RESOLVE, "Pr\u00E4fix muss als Namespace aufgel\u00F6st werden: {0}"},
        {
          ...
          "parse (InputSource-Quelle) nicht unterst\u00FCtzt in XPathContext. {0} kann nicht"
              + " ge\u00F6ffnet werden"
        },
        ...
        // but no more characters were found in the expression.
        {
          ...
          "Ein Verzeichnispfad wurde erwartet, aber stattdessen wurde das Ende des XPath-Ausdrucks"
              + " gefunden."
        },
        ...
        // to a value of type boolean.
        {
          ...
          "XPathResult von XPath-Ausdruck \"{0}\" hat XPathResultType {1}, der nicht in einen"
              + " booleschen Wert konvertiert werden kann."
        },
        ...
        // FIRST_ORDERED_NODE_TYPE.
        {
          ...
          "XPathResult von XPath-Ausdruck \"{0}\" hat XPathResultType {1}, der nicht in einen"
              + " einzelnen Knoten konvertiert werden kann. Die Methode \"getSingleNodeValue\" gilt"
              + " nur f\u00FCr die Typen ANY_UNORDERED_NODE_TYPE und FIRST_ORDERED_NODE_TYPE."
        },
        ...
        // ORDERED_NODE_SNAPSHOT_TYPE.
        {
          ...
          "Die Methode \"getSnapshotLength\" kann nicht f\u00FCr XPathResult von XPath-Ausdruck"
              + " \"{0}\" aufgerufen werden, da der zugeh\u00F6rige XPathResultType {1} ist. Diese"
              + " Methode gilt nur f\u00FCr die Typen UNORDERED_NODE_SNAPSHOT_TYPE und"
              + " ORDERED_NODE_SNAPSHOT_TYPE."
        },
        {
          ER_NON_ITERATOR_TYPE,
          "Die Methode \"iterateNext\" kann nicht f\u00FCr XPathResult von XPath-Ausdruck \"{0}\""
              + " aufgerufen werden, da der zugeh\u00F6rige XPathResultType {1} ist. Diese Methode"
              + " gilt nur f\u00FCr die Typen UNORDERED_NODE_ITERATOR_TYPE und"
        ...
        {ER_EMPTY_XPATH_RESULT, "Leeres XPath-Ergebnisobjekt"},
        {
          ...
          "XPathResult von XPath-Ausdruck \"{0}\" hat XPathResultType {1}, der nicht in den"
              + " angegebenen XPathResultType {2} ge\u00E4ndert werden kann."
        },
        {
          ER_NULL_RESOLVER,
        ...
        // to a value of type string.
        {
          ...
          "XPathResult von XPath-Ausdruck \"{0}\" hat XPathResultType {1}, der nicht in eine"
              + " Zeichenfolge konvertiert werden kann."
        },
        ...
        // UNORDERED_NODE_SNAPSHOT_TYPE and ORDERED_NODE_SNAPSHOT_TYPE.
        {
          ...
          "Die Methode \"snapshotItem\" kann nicht f\u00FCr XPathResult von XPath-Ausdruck \"{0}\""
              + " aufgerufen werden, da der zugeh\u00F6rige XPathResultType {1} ist. Diese Methode"
              + " gilt nur f\u00FCr die Typen UNORDERED_NODE_SNAPSHOT_TYPE und"
              + " ORDERED_NODE_SNAPSHOT_TYPE."
        },
        ...
        {
          ER_CANT_CONVERT_XPATHRESULTTYPE_TO_NUMBER,
          "XPathResult von XPath-Ausdruck \"{0}\" hat XPathResultType {1}, der nicht in eine Zahl"
        ...
        /** Field ER_OBJECT_MODEL_NULL */
        {
          ...
          "{0}#isObjectModelSupported( String objectModel ) kann nicht mit objectModel == null"
              + " aufgerufen werden"
        },
        ...
        /** Field ER_OBJECT_MODEL_EMPTY */
        {
          ...
          "Es wird versucht, ein Feature mit einem Null-Namen festzulegen: {0}#setFeature( null,"
              + " {1})"
        },
        ...
        },
        {
          ...
          "FEATURE_SECURE_PROCESSING: Feature kann nicht auf \"false\" gesetzt werden, wenn"
              + " Security Manager vorhanden ist: {1}#setFeature({0},{2})"
        },
