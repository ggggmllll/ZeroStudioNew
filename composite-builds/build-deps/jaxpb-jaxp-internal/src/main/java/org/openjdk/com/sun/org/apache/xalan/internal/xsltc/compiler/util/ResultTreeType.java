...
public final class ResultTreeType extends Type {
  ...
  /**
   * Expects an result tree on the stack and pushes a boolean. Translates a result tree to a boolean
    ...
    if (_methodName == null) {
      ...
      final LocalVariableGen handler =
          methodGen.addLocalVariable(
              "rt_to_string_handler", Util.getJCRefType(STRING_VALUE_HANDLER_SIG), null, null);
      handler.setStart(il.append(new ASTORE(handler.getIndex())));

      // Call the method that implements this result tree
      index =
          cpg.addMethodref(className, _methodName, "(" + DOM_INTF_SIG + TRANSLET_OUTPUT_SIG + ")V");
  ...
  /**
   * Expects an result tree on the stack and pushes a real. Translates a result tree into a real by
   * first converting it to string.
   *
   * @param classGen A BCEL class generator
   * @param methodGen A BCEL method generator
  ...
  public void translateTo(ClassGenerator classGen, MethodGenerator methodGen, ReferenceType type) {
    ...
    if (_methodName == null) {
      ...
      index =
          cpg.addInterfaceMethodref(DOM_INTF, "getOutputDomBuilder", "()" + TRANSLET_OUTPUT_SIG);
      ...
      domBuilder =
          methodGen.addLocalVariable(
              "rt_to_reference_handler", Util.getJCRefType(TRANSLET_OUTPUT_SIG), null, null);
  ...
  /**
   * Translates a result tree to a Java type denoted by <code>clazz</code>. Expects a result tree on
   * the stack and pushes an object of the appropriate type after coercion. Result trees are
