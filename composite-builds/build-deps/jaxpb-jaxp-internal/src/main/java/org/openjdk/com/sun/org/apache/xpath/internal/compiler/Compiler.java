...
public class Compiler extends OpMap {
  ...
  protected Expression variable(int opPos) throws TransformerException {
    ...
    java.lang.String namespace =
        (OpCodes.EMPTY == nsPos) ? null : (java.lang.String) getTokenQueue().elementAt(nsPos);
  ...
  /**
   * Compile a location path union. The UnionPathIterator itself may create {@link LocPathIterator}
   * children.
   *
   * @param opPos The current position in the m_opMap array.
   ...
   *
   * @param opPos The position of the first predicate the m_opMap array.
   * @param predicates An empty pre-determined array of {@link Expression}s, that will be filled in.
   * @throws TransformerException
   */
