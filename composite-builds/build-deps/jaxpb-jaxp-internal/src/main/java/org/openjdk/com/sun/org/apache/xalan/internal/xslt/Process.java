...
public class Process {
  ...
  protected static void printArgOptions(ResourceBundle resbundle) {
    ...
    System.out.println(
        resbundle.getString(
            "optionURIRESOLVER")); // "   [-URIRESOLVER full class name (URIResolver to be used to
    // resolve URIs)]");
    System.out.println(
        resbundle.getString(
            "optionENTITYRESOLVER")); // "   [-ENTITYRESOLVER full class name (EntityResolver to be
    // used to resolve entities)]");
    waitForReturnKey(resbundle);
    System.out.println(
        resbundle.getString(
            "optionCONTENTHANDLER")); // "   [-CONTENTHANDLER full class name (ContentHandler to be
    // used to serialize output)]");
    System.out.println(
        resbundle.getString(
            "optionSECUREPROCESSING")); // "   [-SECURE (set the secure processing feature to
    // true)]");
   ...
   *
   * <p>To set stylesheet parameters from the command line, use <code>-PARAM name expression</code>.
   * If you want to set the parameter to a string value, simply pass the string value as-is, and it
   * will be interpreted as a string. (Note: if the value has spaces in it, you may need to quote it
