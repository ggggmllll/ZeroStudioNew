...
public class IndentPrinter extends Printer {
  ...
  /**
   * Holds the currently accumulating text that follows {@link #_line}. When the end of the part is
   * identified by a call to {@link #printSpace} or {@link #breakLine}, this part is added to the
   * accumulated line.
   */
  ...
  /**
   * Holds the indentation for the current line that is now accumulating in memory and will be sent
   * for printing shortly.
   */
  ...
  /**
   * Called to print additional text. Each time this method is called it accumulates more text. When
   * a space is printed ({@link #printSpace}) all the accumulated text becomes one part and is added
   * to the accumulate line. When a line is long enough, it can be broken at its text boundary.
   *
  ...
  /**
   * Called to print a single space between text parts that may be broken into separate lines. Must
   * not be called to print a space when preserving spaces. The text accumulated so far with {@link
   * #printText} will be added to the accumulated line, and a space separator will be counted. If
   * the line accumulated so far is long enough, it will be printed.
   */
  ...
  /**
   * Called to print a line consisting of the text accumulated so far. This is equivalent to calling
   * {@link #printSpace} but forcing the line to print and starting a new line ({@link #printSpace}
