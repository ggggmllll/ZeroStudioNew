...
public class ErrorMessages_pt_BR extends ListResourceBundle {
  ...
  public Object[][] getContents() {
    return new Object[][] {
      {ErrorMsg.MULTIPLE_STYLESHEET_ERR, "Mais de uma folha de estilos definida no mesmo arquivo."},
       ...
       */
      {
        ErrorMsg.TEMPLATE_REDEF_ERR, "O modelo ''{0}'' j\u00E1 foi definido nesta folha de estilos."
      },
       ...
       */
      {
        ...
        "N\u00E3o \u00E9 poss\u00EDvel converter o argumento/tipo de retorno na chamada para o"
            + " m\u00E9todo ''{0}''"
      },
       ...
       */
      {ErrorMsg.FILE_ACCESS_ERR, "N\u00E3o \u00E9 poss\u00EDvel abrir o arquivo ou o URI ''{0}''."},
       ...
       */
      {ErrorMsg.REQUIRED_ATTR_ERR, "O atributo obrigat\u00F3rio ''{0}'' n\u00E3o foi encontrado."},
       ...
       */
      {
        ...
        "Os fragmentos da \u00E1rvore n\u00E3o podem ser classificados (os elementos <xsl:sort>"
            + " foram ignorados). Voc\u00EA deve classificar os n\u00F3s ao criar a \u00E1rvore de"
            + " resultados."
      },
       ...
       */
      {ErrorMsg.SYMBOLS_REDEF_ERR, "A formata\u00E7\u00E3o decimal ''{0}'' j\u00E1 foi definida."},

      /*
       * Note to translators:  The stylesheet version named in the
       * substitution text is not supported.
       */
      {ErrorMsg.XSL_VERSION_ERR, "A vers\u00E3o XSL \"{0}'' n\u00E3o \u00E9 suportada por XSLTC."},
       ...
       * not recognized.
       */
      {ErrorMsg.ILLEGAL_BINARY_OP_ERR, "Operador desconhecido para a express\u00E3o bin\u00E1ria."},
       ...
       */
      {
        ...
        "O documento de entrada n\u00E3o \u00E9 uma folha de estilos (o namespace XSL n\u00E3o foi"
            + " declarado no elemento-raiz)."
      },
       ...
       */
      {
        ...
        "N\u00E3o foi poss\u00EDvel ler o alvo ''{0}'' da folha de estilos, porque o acesso a"
            + " ''{1}'' n\u00E3o \u00E9 permitido em virtude da restri\u00E7\u00E3o definida pela"
       ...
       */
      {ErrorMsg.ELEMENT_PARSE_ERR, "N\u00E3o foi poss\u00EDvel fazer parsing do elemento ''{0}''"},
      ...
      },
      {
        ...
        "Classe translet carregada, mas n\u00E3o \u00E9 poss\u00EDvel criar uma inst\u00E2ncia"
            + " translet."
      },
       ...
       * met.
       */
      {ErrorMsg.JAXP_NO_TRANSLET_ERR, "O Transformer n\u00E3o tem um objeto translet encapsulado."},
      ...
      {ErrorMsg.COMPILE_STDIN_ERR, "A op\u00E7\u00E3o -i deve ser usada com a op\u00E7\u00E3o -o."},
       ...
       */
      {
        ...
        "SINOPSE\n"
            ...
            + "                  \u00E9 ignorada caso sejam compiladas v\u00E1rias folhas de"
            + " estilos.\n"
            ...
            + "                  translet geradas.\n"
            + "   -n             permite a inclus\u00E3o do modelo na linha (comportamento default"
            + " melhor\n"
            + "                  em m\u00E9dia).\n"
       ...
       */
      {
        ...
        "SINOPSE \n"
            + "   java com.sun.org.apache.xalan.internal.xsltc.cmdline.Transforme [-j <arquivo"
            + " jar>]\n"
            ...
            + "   -x              ativa a sa\u00EDda de mensagens de depura\u00E7\u00E3o"
            + " adicionais\n"
            + "   -n <itera\u00E7\u00F5es> executa a transforma\u00E7\u00E3o <itera\u00E7\u00F5es>"
            + " vezes e\n"
       ...
       */
      {
        ...
        "O primeiro argumento para a fun\u00E7\u00E3o Java n\u00E3o static ''{0}'' n\u00E3o \u00E9"
            + " uma refer\u00EAncia de objeto v\u00E1lida."
      },
       ...
       */
      {
        ...
        "N\u00E3o foi poss\u00EDvel usar o nome ''{0}'' como o nome da classe translet, pois ele"
            + " cont\u00E9m caracteres que n\u00E3o s\u00E3o permitidos no nome da classe Java. O"
            + " nome ''{1}'' foi usado."
      },
       ...
       */
      {
        ...
        "Um atributo cujo valor deve ser um QName ou uma lista de QNames separada por espa\u00E7os"
            + " em branco tinha o valor ''{0}''"
      },
       ...
       */
      {
        ...
        "O atributo method de um elemento <xsl:output> tinha o valor ''{0}''. O valor deve ser um"
            + " dos seguintes: ''xml'', ''html'', ''text'', ou qname, mas n\u00E3o ncname"
      },
      {
      ...
      },
      {
        ...
        "FEATURE_SECURE_PROCESSING: N\u00E3o \u00E9 poss\u00EDvel definir o recurso como falso"
            + " quando o gerenciador de seguran\u00E7a est\u00E1 presente."
      },
       ...
       */
      {
        ...
        "Erro interno de XSLTC: os marcadores OutlineableChunkStart e OutlineableChunkEnd devem ser"
            + " balanceados e aninhados corretamente."
      },
       ...
       */
      {
        ...
        "Erro interno de XSLTC: ainda h\u00E1 refer\u00EAncia no m\u00E9todo original a uma"
            + " instru\u00E7\u00E3o que fazia parte de um bloco de byte code que foi outlined."
      },
       ...
       */
      {
        ...
        "Erro interno de XSLTC: um m\u00E9todo no translet excede a limita\u00E7\u00E3o da"
            + " M\u00E1quina Virtual Java quanto ao tamanho de um m\u00E9todo de de 64 kilobytes."
            + " Em geral, essa situa\u00E7\u00E3o \u00E9 causada por modelos de uma folha de"
            + " estilos que s\u00E3o muito grandes. Tente reestruturar sua folha de estilos de"
            + " forma a usar modelos menores."
      },
      {
        ErrorMsg.DESERIALIZE_TRANSLET_ERR,
        "Quando a seguran\u00E7a do Java est\u00E1 ativada, o suporte para desserializar"
            + " TemplatesImpl fica desativado. Essa situa\u00E7\u00E3o pode ser corrigida definindo"
            + " a propriedade do sistema jdk.xml.enableTemplatesImplDeserialization como true."
      }
    };
  }
}
