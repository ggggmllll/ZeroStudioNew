...
public interface XMLDocumentFragmentHandler {
   ...
   *     the parsing of this fragment. However, it is <em>strongly</em> recommended that a locator
   *     be supplied that can at least report the base system identifier.
   * @param namespaceContext The namespace context in effect at the start of this document fragment.
   *     This object only represents the current context. Implementors of this class are responsible
   *     for copying the namespace bindings from the the current context (and its parent contexts)
