...
public class XMLGregorianCalendarImpl extends XMLGregorianCalendar
   ...
   *
   * <p>TODO: Serialization should use the XML string representation as the serialization format to
   * ensure future compatibility.
   */
  private static final long serialVersionUID = 1L;

  /**
   * Use as a template for default field values when converting to a {@link GregorianCalendar}, set
   * to a leap year date of January 1, 0400 at midnight.
   *
  ...
  protected XMLGregorianCalendarImpl(String lexicalRepresentation) throws IllegalArgumentException {
    ...
    if (!isValid()) {
      throw new IllegalArgumentException(
          ...
          // "\"" + lexicalRepresentation + "\" is not a valid representation of an XML Gregorian
          // Calendar value."
          );
    }
  }
  ...
  protected XMLGregorianCalendarImpl(
    ...
    if (!isValid()) {
      ...
      /**
       * String yearString = "null"; if (year != null) { yearString = year.toString(); } String
       * fractionalSecondString = "null"; if (fractionalSecond != null) { fractionalSecondString =
       * fractionalSecond.toString(); }
       *
       * <p>throw new IllegalArgumentException( "year = " + yearString + ", month = " + month + ",
       * day = " + day + ", hour = " + hour + ", minute = " + minute + ", second = " + second + ",
       * fractionalSecond = " + fractionalSecondString + ", timezone = " + timezone + ", is not a
   ...
   * java.util.GregorianCalendar</code> daylight savings timezone id in the XML Schema 1.0 date/time
  ...
  /**
   * Create a Java representation of XML Schema builtin datatype <code>dateTime</code>. All possible
   * fields are specified for this factory method.
   *
   ...
   *
   * <p>Value constraints for this value are summarized in <a href="#datetimefield-year">year field
  ...
  /**
   * Return low order component for XML Schema 1.0 dateTime datatype field for <code>year</code> or
   ...
   *
   * <p>Value constraints for this value are summarized in <a href="#datetimefield-day">day field of
  ...
  /**
   * Return timezone offset in minutes or {@link DatatypeConstants#FIELD_UNDEFINED} if this optional
   ...
   *
   * <p>Value constraints for this value are summarized in <a href="#datetimefield-hour">hour field
   * of date/time field mapping table</a>.
   *
   ...
   * field is not defined, the optional xs:dateTime fractional seconds field, represented by {@link
   * #getFractionalSecond()} and {@link #getMillisecond()}, must not be defined.
   *
   ...
   *
   * <p>This method represents a convenience accessor to infinite precision fractional second value
   * returned by {@link #getFractionalSecond()}. The returned value is the rounded down to
   ...
   *
   * <p>Value constraints are detailed in <a href="#datetimefield-second">second field of date/time
  ...
  private void invalidFieldValue(int field, int value) {
    throw new IllegalArgumentException(
        DatatypeMessageFormatter.formatMessage(
            null, "InvalidFieldValue", new Object[] {new Integer(value), FIELD_NAME[field]}));
  }
  ...
  /**
   * Return the lexical representation of <code>this</code> instance. The format is specified in <a
   * href="http://www.w3.org/TR/xmlschema-2/#dateTime-order">XML Schema 1.0 Part 2, Section
   * 3.2.[7-14].1, <i>Lexical Representation</i>".</a>
   *
   * <p>Specific target lexical representation format is determined by {@link #getXMLSchemaType()}.
   *
  ...
  public void add(Duration duration) {
    ...
    BigDecimal dSeconds =
        DurationImpl.sanitize((BigDecimal) duration.getField(DatatypeConstants.SECONDS), signum);
    ...
    while (true) {
      if (endDays.compareTo(BigInteger.ONE) < 0) {
        ...
        monthCarry = -1;
          ...
          > 0) {
        endDays =
            endDays.add(BigInteger.valueOf(-maximumDayInMonthFor(getEonAndYear(), getMonth())));
        monthCarry = 1;
      } else {
        break;
      }
   ...
   *
   * <p>When <code>this</code> instance has an undefined field, this conversion relies on the <code>
   * java.util.GregorianCalendar</code> default for its corresponding field. A notable difference
   * between XML Schema 1.0 date/time datatypes and <code>java.util.GregorianCalendar</code> is that
   * Timezone value is optional for date/time datatypes and it is a required field for <code>
   * java.util.GregorianCalendar</code>. See javadoc for <code>java.util.TimeZone.getDefault()
   * </code> on how the default is determined. To explicitly specify the <code>TimeZone</code>
   ...
   *   <li>Obtain a pure Gregorian Calendar by invoking <code>GregorianCalendar.setGregorianChange(
   ...
   * </code> instance.
   *
   * <p>Since XML Schema 1.0 date/time datetypes has no concept of timezone ids or daylight savings
   * timezone ids, this conversion operation allows the user to explicitly specify one with <code>
   ...
   *   <li>else when <code>this.getTimezone() != DatatypeConstants.FIELD_UNDEFINED</code>, create a
   *       <code>java.util.TimeZone</code> with a custom timezone id using the <code>
   *       this.getTimezone()</code>.
   ...
   * @param aLocale provide explicit Locale. Use default GregorianCalendar locale if value is <code>
   *     null</code>.
   * @param defaults provide default field values to use when corresponding field for this instance
   *     is DatatypeConstants.FIELD_UNDEFINED or null. If <code>defaults</code>is <code>null</code>
   *     or a field within the specified <code>defaults</code> is undefined, just use <code>
  ...
  public GregorianCalendar toGregorianCalendar(
    ...
    if (year != null) {
      ...
      if (defaultYear != null) {
        result.set(
            Calendar.ERA, defaultYear.signum() == -1 ? GregorianCalendar.BC : GregorianCalendar.AD);
   ...
   *
   * <p>StringBuffer -> StringBuilder change had a very visible impact. It almost cut the execution
   * time to half, but unfortunately we can't use it because we need to run on JDK 1.3
   */
