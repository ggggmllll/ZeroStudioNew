  ...
  private static final Object[][] _contents =
      new Object[][] {
        ...
        {ER_SELF_CAUSATION_NOT_PERMITTED, "La causalitat pr\u00f2pia no est\u00e0 permesa. "},
        {
          ...
          "No es pot especificar informaci\u00f3 de l'usuari si no s'especifica el sistema"
              + " principal "
        },
        {
        ...
        },
        {
          ...
          "No es pot especificar una cadena de consulta en la via d'acc\u00e9s i la cadena de"
              + " consulta "
        },
        {
        ...
        {ER_OIERROR, "Error d'E/S "},
        {
          ...
          "No es pot afegir l''atribut {0} despr\u00e9s dels nodes subordinats o abans que es"
              + " produeixi un element. Es passar\u00e0 per alt l''atribut. "
        },
        ...
        },
        {
          ...
          "No s''ha pogut carregar ''{0}'' (comproveu la CLASSPATH); ara s''estan fent servir els"
              + " valors per defecte."
        },
        {
          ER_COULD_NOT_LOAD_METHOD_PROPERTY,
          "No s''ha pogut carregar el fitxer de propietats ''{0}'' del m\u00e8tode de sortida"
              + " ''{1}'' (comproveu la CLASSPATH)"
        }
      };
