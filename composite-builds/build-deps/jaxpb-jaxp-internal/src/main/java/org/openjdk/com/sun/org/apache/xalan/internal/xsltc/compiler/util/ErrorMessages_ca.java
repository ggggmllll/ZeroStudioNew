...
public class ErrorMessages_ca extends ListResourceBundle {
  ...
  public Object[][] getContents() {
    return new Object[][] {
       ...
       */
      {
        ErrorMsg.FUNCTION_RESOLVE_ERR, "No s''ha pogut resoldre la crida de la funci\u00f3 ''{0}''."
      },
       ...
       */
      {
        ...
        "Els fragments de l'arbre de resultats no es poden classificar (es passen per alt els"
            + " elements <xsl:sort>). Heu de classificar els nodes quan creeu l'arbre de resultats."
            + " "
      },
       ...
       */
      {
        ...
        "El document d'entrada no \u00e9s un full d'estils (l'espai de noms XSL no s'ha declarat en"
            + " l'element arrel)."
      },
       ...
       */
      {
        ...
        "S'ha cridat XSLTCSource.build() sense que s'hagu\u00e9s establert la identificaci\u00f3"
            + " del sistema."
      },
       ...
       */
      {
        ...
        "RESUM \n"
            ...
            + "OPCIONS\n"
            + "   -j <fitxer_jar>    especifica un fitxer jar des del qual es pot carregar el"
            + " translet\n"
            + "   -x habilita la sortida de missatges de depuraci\u00f3 addicionals\n"
            + "   -s              inhabilita la crida de System.exit\n"
            + "   -n <iteracions> executa la transformaci\u00f3 el nombre de vegades <iteracions>"
            + " i\n"
       ...
       */
      {
        ...
        "El primer argument de la funci\u00f3 Java no static ''{0}'' no \u00e9s una refer\u00e8ncia"
            + " d''objecte v\u00e0lida."
      },
       ...
       */
      {
        ...
        "S'ha produ\u00eft un error en comprovar el tipus d'expressi\u00f3 en una ubicaci\u00f3"
            + " desconeguda."
      },
       ...
       */
      {
        ErrorMsg.TRANSFORM_WITH_TRANSLET_STR, "Transformaci\u00f3 mitjan\u00e7ant translet ''{0}'' "
      },
