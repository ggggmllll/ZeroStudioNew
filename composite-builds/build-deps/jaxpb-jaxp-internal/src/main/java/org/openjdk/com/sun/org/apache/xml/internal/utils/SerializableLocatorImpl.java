...
public class SerializableLocatorImpl implements org.xml.sax.Locator, java.io.Serializable {
   ...
   *
   * <p>SAX says "This will not normally be useful, since the main purpose of this class is to make
   * a snapshot of an existing Locator." In fact, it _is_ sometimes useful when you want to
   * construct a new Locator pointing to a specific location... which, after all, is why the setter
