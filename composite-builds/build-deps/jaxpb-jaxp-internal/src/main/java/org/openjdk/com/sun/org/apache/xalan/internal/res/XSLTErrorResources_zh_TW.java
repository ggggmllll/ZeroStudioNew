...
public class XSLTErrorResources_zh_TW extends ListResourceBundle {
  ...
  public Object[][] getContents() {
    return new Object[][] {
      ...
      {ER_TEMPLATE_NOT_FOUND, "\u627E\u4E0D\u5230\u4E0B\u5217\u540D\u7A31\u7684\u6A23\u677F: {0}"},
      {
      ...
      {
        ER_NO_CLONE_OF_DOCUMENT_FRAG, "\u6C92\u6709\u6587\u4EF6\u7247\u6BB5\u7684\u8907\u88FD\uFF01"
      },
      {
        ER_CANT_CREATE_ITEM,
        "\u7121\u6CD5\u5728\u7D50\u679C\u6A39\u72C0\u7D50\u69CB\u4E2D\u5EFA\u7ACB\u9805\u76EE: {0}"
      ...
      },
      {
        ...
        "\u4E0D\u518D\u652F\u63F4 default-space\uFF01\u8ACB\u6539\u7528 xsl:strip-space \u6216"
            + " xsl:preserve-space\u3002"
      },
      {
      ...
      {
        ER_XMLSPACE_ILLEGAL_VAL, "(StylesheetHandler) xml:space \u5177\u6709\u7121\u6548\u503C: {0}"
      },
      ...
      {ER_CALL_TO_EXT_FAILED, "\u547C\u53EB\u64F4\u5145\u5957\u4EF6\u5143\u7D20\u5931\u6557: {0}"},
      {
      ...
      {
        ER_ELEM_CONTENT_NOT_ALLOWED, "\u5143\u7D20\u5167\u5BB9\u4E0D\u5141\u8A31 lang=javaclass {0}"
      },
      ...
      {
        ER_INVALID_PREFIX, "exclude-result-prefixes \u4E2D\u7684\u524D\u7F6E\u78BC\u7121\u6548: {0}"
      },
      ...
      {
        ER_INVALID_NAMESPACE_URI_VALUE_FOR_RESULT_PREFIX_FOR_DEFAULT,
        "xsl:namespace-alias \u5143\u7D20\u7684 result-prefix \u5C6C\u6027\u5177\u6709\u503C"
      ...
      {WG_CANNOT_LOAD_REQUESTED_DOC, "\u7121\u6CD5\u8F09\u5165\u8981\u6C42\u7684\u6587\u4EF6: {0}"},
      ...
      {
        WG_PROCESSINGINSTRUCTION_NAME_CANT_BE_XML,
        "xsl:processing-instruction \u540D\u7A31\u7684 'name' \u5C6C\u6027\u503C\u4E0D\u53EF\u70BA"
            + " 'xml'"
      },
