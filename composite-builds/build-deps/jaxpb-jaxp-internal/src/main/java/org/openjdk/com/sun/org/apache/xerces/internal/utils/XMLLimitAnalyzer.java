...
public final class XMLLimitAnalyzer {
  ...
  /**
   * Add the value to the current max count for the specified property To find the max value of all
   * entities, set no limit
   *
  ...
  public void debugPrint(XMLSecurityManager securityManager) {
    ...
    System.out.println(
        formatter.format(
            "%30s %15s %15s %15s %30s", "Property", "Limit", "Total size", "Size", "Entity Name"));
