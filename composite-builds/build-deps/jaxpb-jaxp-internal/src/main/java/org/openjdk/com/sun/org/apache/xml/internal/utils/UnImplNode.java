...
public class UnImplNode implements Node, Element, NodeList, Document {
   ...
   * href='http://www.w3.org/TR/2001/WD-DOM-Level-3-Core-20010605'>Document Object Model (DOM) Level
   * 3 Core Working Draft of 5 June 2001.</a>.
   *
   ...
   * 3 Core Working Draft of 5 June 2001.</a>.
   *
   * <p>An attribute specifying whether errors checking is enforced or not. When set to <code>false
   * </code>, the implementation is free to not test every possible error case normally defined on
   * DOM operations, and not raise any <code>DOMException</code>. In case of error, the behavior is
   * undefined. This attribute is <code>true</code> by defaults.
   *
   * @since DOM Level 3
   *     <p>NEEDSDOC ($objectName$) @return
   */
   ...
   * @param version This is the version number of the feature to test. If the version is <code>null
   *     </code> or the empty string, supporting any version of the feature will cause the method to
   *     return an object that supports at least one version of the feature.
