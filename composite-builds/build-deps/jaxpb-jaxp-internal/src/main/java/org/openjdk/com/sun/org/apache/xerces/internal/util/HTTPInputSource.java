...
public final class HTTPInputSource extends XMLInputSource {
  ...
  /**
   * Returns an iterator for the request properties this input source contains. Each object returned
   * by the iterator is an instance of <code>java.util.Map.Entry</code> where each key and value are
   * a pair of strings corresponding to the name and value of a request property.
   *
