  ...
  public Object[][] getContents() {
    return new Object[][] {
       ...
       */
      {
        ...
        "Nelze p\u0159ev\u00e9st argument/n\u00e1vratov\u00fd typ ve vol\u00e1n\u00ed metody"
            + " ''{0}''"
      },
       ...
       */
      {
        ...
        "Fragmenty stromu v\u00fdsledk\u016f nemohou b\u00fdt \u0159azeny (prvky <xsl:sort> se"
            + " ignoruj\u00ed). P\u0159i vytv\u00e1\u0159en\u00ed stromu v\u00fdsledk\u016f"
            + " mus\u00edte se\u0159adit uzly."
      },
       ...
       */
      {ErrorMsg.CIRCULAR_VARIABLE_ERR, "Cyklick\u00fd odkaz na prom\u011bnnou/parametr v ''{0}''."},
       ...
       */
      {
        ...
        "Vstupn\u00ed dokument nen\u00ed p\u0159edloha stylu (obor n\u00e1zv\u016f XSL nen\u00ed"
            + " deklarov\u00e1n v ko\u0159enov\u00e9m elementu)."
      },
       ...
       */
      {
        ...
        "Atribut use prom\u011bnn\u00e9 <key> mus\u00ed b\u00fdt typu node, node-set, string nebo"
            + " number."
      },
       ...
       */
      {
        ...
        "Neexistuje \u017e\u00e1dn\u00fd definovan\u00fd v\u00fdstupn\u00ed obslu\u017en\u00fd"
            + " program pro v\u00fdsledek transformace."
      },
       ...
       */
      {
        ...
        "SYNOPSIS\n"
            ...
            + " v\u0161echny generovan\u00e9 \n"
            + " t\u0159\u00eddy transletu.\n"
            + "   -n             povoluje zarovn\u00e1n\u00ed \u0161ablony (v\u00fdchoz\u00ed"
            + " chov\u00e1n\u00ed je v pr\u016fm\u011bru lep\u0161\u00ed\n"
            + "                  .\n"
       ...
       */
      {
        ...
        "V\u00fdstupn\u00ed k\u00f3dov\u00e1n\u00ed ''{0}'' nen\u00ed v tomto prost\u0159ed\u00ed"
            + " JVM podporov\u00e1no."
      },
       ...
       */
      {
        ...
        "Prvn\u00ed argument nestatick\u00e9 funkce Java ''{0}'' nen\u00ed platn\u00fdm odkazem na"
            + " objekt."
      },
       ...
       * Note to translators:  The substitution text is the name of a class.
       */
      {ErrorMsg.TRANSFORM_WITH_TRANSLET_STR, "Transformace pou\u017eit\u00edm transletu ''{0}'' "},
