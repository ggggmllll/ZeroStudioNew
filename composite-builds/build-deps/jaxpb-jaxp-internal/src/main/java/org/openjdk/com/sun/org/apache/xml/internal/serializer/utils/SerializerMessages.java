    ...
    Object[][] contents =
        new Object[][] {
          ...
          },
          {
            ...
            "Warning:  The version of the output document is requested to be ''{0}''.  This version"
                + " of XML is not supported.  The version of the output document will be ''1.0''."
          },
           ...
           */
          {
            ...
            "The Properties object passed to the SerializerFactory does not have a ''{0}''"
                + " property."
          },
          {
