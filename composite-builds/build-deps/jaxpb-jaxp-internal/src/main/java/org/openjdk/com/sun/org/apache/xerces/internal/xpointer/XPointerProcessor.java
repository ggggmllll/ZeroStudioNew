...
public interface XPointerProcessor {
  ...
  /**
   * Parses an XPointer expression. It performs scheme specific processing depending on the pointer
   * parts and sets up a Vector of XPointerParts in the order (left-to-right) they appear in the
   * XPointer expression.
   *
  ...
  /**
   * Returns true if the XPointer expression resolves to the current resource fragment or Node which
   * is part of the input resource being streamed else returns false.
   *
