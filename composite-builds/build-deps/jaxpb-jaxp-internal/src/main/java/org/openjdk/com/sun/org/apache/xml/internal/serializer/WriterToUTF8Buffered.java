...
final class WriterToUTF8Buffered extends Writer implements WriterChain {
  ...
  public void write(final char chars[], final int start, final int length)
    ...
    for (; i < n; i++) {
      ...
      /**
       * The following else if condition is added to support XML 1.1 Characters for UTF-8: [1111
       * 0uuu] [10uu zzzz] [10yy yyyy] [10xx xxxx]* Unicode: [1101 10ww] [wwzz zzyy] (high
       * surrogate) [1101 11yy] [yyxx xxxx] (low surrogate) * uuuuu = wwww + 1
       */
