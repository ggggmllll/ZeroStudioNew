...
public class XMLErrorResources_cs extends ListResourceBundle {
  ...
  private static final Object[][] _contents =
      new Object[][] {
        ...
        {
          ER_NODE_NON_NULL,
          "Uzel pou\u017eit\u00fd ve funkci getDTMHandleFromNode mus\u00ed m\u00edt hodnotu"
              + " not-null"
        },
        ...
        {ER_COULD_NOT_INIT_PARSER, "nelze inicializovat analyz\u00e1tor s: "},
        {
          ...
          "v\u00fdjimka p\u0159i vytv\u00e1\u0159en\u00ed nov\u00e9 instance spole\u010dn\u00e9"
              + " oblasti"
        },
        ...
        {ER_LOCATION_UNKNOWN, "Chyba se vyskytla na nezn\u00e1m\u00e9m m\u00edst\u011b"},
        {
          ...
          "P\u0159edponu mus\u00ed b\u00fdt mo\u017eno p\u0159elo\u017eit do oboru n\u00e1zv\u016f:"
              + " {0}"
        },
        {
        ...
        },
        {
          ...
          "Varov\u00e1n\u00ed: v\u00fdstup textu nem\u016f\u017ee p\u0159edch\u00e1zet prvku"
              + " dokumentu! Ignorov\u00e1no..."
        },
        {
        ...
        {ER_OIERROR, "Chyba vstupu/v\u00fdstupu"},
        {
          ...
          "Nelze p\u0159idat atribut {0} po uzlech potomk\u016f ani p\u0159ed t\u00edm, ne\u017e je"
              + " vytvo\u0159en prvek. Atribut bude ignorov\u00e1n."
        },
        ...
        {
          ER_COULD_NOT_LOAD_METHOD_PROPERTY,
          "Nelze na\u010d\u00edst soubor vlastnost\u00ed ''{0}'' pro v\u00fdstupn\u00ed metodu"
              + " ''{1}'' (zkontrolujte prom\u011bnnou CLASSPATH)."
        }
      };
