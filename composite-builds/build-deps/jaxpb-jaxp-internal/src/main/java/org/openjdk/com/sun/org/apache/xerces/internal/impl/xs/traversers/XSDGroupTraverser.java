...
class XSDGroupTraverser extends XSDAbstractParticleTraverser {
  ...
  XSParticleDecl traverseLocal(Element elmNode, XSDocumentInfo schemaDoc, SchemaGrammar grammar) {
    ...
    if (refAttr == null) {
      ...
      group =
          (XSGroupDecl)
              fSchemaHandler.getGlobalDecl(schemaDoc, XSDHandler.GROUP_TYPE, refAttr, elmNode);
    }
    ...
    if (group != null) {
      ...
      Object redefinedGrp =
          fSchemaHandler.getGrpOrAttrGrpRedefinedByRestriction(
              ...
              new QName(
                  XMLSymbols.EMPTY_STRING, strNameAttr, strNameAttr, schemaDoc.fTargetNamespace),
              schemaDoc,
              elmNode);
