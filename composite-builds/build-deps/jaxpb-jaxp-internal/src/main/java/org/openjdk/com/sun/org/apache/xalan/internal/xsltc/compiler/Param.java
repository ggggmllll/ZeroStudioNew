...
final class Param extends VariableBase {
  ...
  /**
   * True if this Param is declared in a simple named template. This is used to optimize codegen for
   * parameter passing in named templates.
   */
  ...
  /**
   * Parse the contents of the <xsl:param> element. This method must read the 'name' (required) and
  ...
  public void translate(ClassGenerator classGen, MethodGenerator methodGen) {
    ...
    if (isLocal()) {
      ...
      il.append(
          new INVOKEVIRTUAL(cpg.addMethodref(TRANSLET_CLASS, ADD_PARAMETER, ADD_PARAMETER_SIG)));
