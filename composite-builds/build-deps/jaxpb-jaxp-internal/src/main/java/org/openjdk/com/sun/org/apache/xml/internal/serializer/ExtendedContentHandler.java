...
abstract interface ExtendedContentHandler extends org.xml.sax.ContentHandler {
   ...
   * from the prefix of qName. The local name will be derived from qName and the type will be
   * assumed to be "CDATA".
   *
   * @param qName
   * @param value
  ...
  /**
   * This method is used to notify of a character event, but passing the data as a character String
   * rather than the standard character array.
   *
