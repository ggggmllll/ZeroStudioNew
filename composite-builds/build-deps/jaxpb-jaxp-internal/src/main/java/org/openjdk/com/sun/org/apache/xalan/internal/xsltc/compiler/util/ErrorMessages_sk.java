...
public class ErrorMessages_sk extends ListResourceBundle {
  ...
  public Object[][] getContents() {
    return new Object[][] {
       ...
       */
      {
        ErrorMsg.VARIABLE_UNDEF_ERR, "Premenn\u00e1 alebo parameter ''{0}'' nie je definovan\u00e1."
      },
       ...
       */
      {
        ErrorMsg.ILLEGAL_PI_ERR, "Neplatn\u00fd n\u00e1zov ''{0}'' pre in\u0161trukciu spracovania."
      },
       ...
       */
      {
        ...
        "Fragmenty stromu v\u00fdsledkov nemo\u017eno triedi\u0165 (elementy <xsl:sort> s\u00fa"
            + " ignorovan\u00e9). Ke\u010f vytv\u00e1rate v\u00fdsledkov\u00fd strom, mus\u00edte"
            + " triedi\u0165 uzly."
      },
       ...
       */
      {ErrorMsg.CIRCULAR_VARIABLE_ERR, "Cirkul\u00e1rna referencia premennej/parametra v ''{0}''."},
       ...
       */
      {
        ...
        "Vstupn\u00fd dokument nie je \u0161t\u00fdlom dokumentu (n\u00e1zvov\u00fd priestor XSL"
            + " nie je deklarovan\u00fd v kore\u0148ovom elemente)."
      },
       ...
       */
      {
        ...
        "Atrib\u00fat pou\u017eitia <key> mus\u00ed by\u0165 uzol, sada uzlov, re\u0165azec alebo"
            + " \u010d\u00edslo."
      },
       ...
       * Note to translators:  ???
       */
      {ErrorMsg.UNKNOWN_SIG_TYPE_ERR, "Nezn\u00e1my typ \u00fadajov v podpise pre triedu ''{0}''."},
       ...
       */
      {
        ErrorMsg.TRANSLET_CLASS_ERR, "Nebolo mo\u017en\u00e9 zavies\u0165 triedu transletu ''{0}''."
      },
      {
        ErrorMsg.TRANSLET_OBJECT_ERR,
        "Trieda transletu zaveden\u00e1, ale nie je mo\u017en\u00e9 vytvori\u0165 in\u0161tanciu"
            + " transletu."
      },
       ...
       */
      {ErrorMsg.JAXP_INVALID_ATTR_ERR, "TransformerFactory nerozozn\u00e1va atrib\u00fat ''{0}''."},
       ...
       */
      {
        ...
        "Pre v\u00fdsledok transform\u00e1cie nebol definovan\u00fd \u017eiadny v\u00fdstupn\u00fd"
            + " handler."
      },
       ...
       */
      {
        ErrorMsg.JAXP_NO_RESULT_ERR, "Objekt v\u00fdsledku odovzdan\u00fd ''{0}'' je neplatn\u00fd."
      },
       ...
       */
      {
        ...
        "SYNOPSIS\n"
            ...
            + "   -p <package>   uv\u00e1dza predponu n\u00e1zvu bal\u00edku pre v\u0161etky"
            + " generovan\u00e9 triedy transletu.\n\n"
            + "   -n             povo\u013euje zoradenie vzorov v riadku (\u0161tandardn\u00e9"
            + " chovanie v priemere lep\u0161ie). \n\n"
            + "   -x             zap\u00edna   v\u00fdstupy spr\u00e1v ladenia \n"
            + "   -s             zakazuje volanie System.exit\n"
            + "   -u             interpretuje<stylesheet> argumenty ako URL\n"
            + "   -i             n\u00fati kompil\u00e1tor \u010d\u00edta\u0165 \u0161t\u00fdl"
            + " dokumentu z stdin\n"
       ...
       */
      {
        ...
        "Prv\u00fd argument pre nestatick\u00fa funkciu Java ''{0}'' nie je platnou referenciou"
            + " objektu."
      },
      ...
      {ErrorMsg.RUNTIME_ERROR_KEY, "Chyby transletu:"},
      {
        ...
        "FEATURE_SECURE_PROCESSING: Cannot set the feature to false when security manager is"
            + " present."
      }
    };
  }
