...
public class XString extends XObject implements XMLString {
   ...
   * </blockquote>
   *
   * is true. If no such character occurs in this string at or after position <code>fromIndex</code>
   ...
   *     such substring is returned. If it does not occur as a substring starting at <code>fromIndex
   *     </code> or beyond, <code>-1</code> is returned.
   * @exception java.lang.NullPointerException if <code>str</code> is <code>null</code>
   */
   ...
   * <code>beginIndex</code> and extends to the character at index <code>endIndex - 1</code>. Thus
   * the length of the substring is <code>endIndex-beginIndex</code>.
   *
   * @param beginIndex the beginning index, inclusive.
   ...
   * sequence identical in length to the character sequence represented by this <code>String</code>
   * object and with every character equal to the result of applying the method <code>
