...
public class CatalogEntry {
  ...
  /**
   * The entryTypes vector maps catalog entry names (e.g., 'BASE' or 'SYSTEM') to their type (1, 2,
   ...
   * should only be called shortly after object creation to do some sort of cleanup. Catalog entries
   * should not mutate over time.
   *
   * @param argNum The argument number (arguments are numbered from 0).
