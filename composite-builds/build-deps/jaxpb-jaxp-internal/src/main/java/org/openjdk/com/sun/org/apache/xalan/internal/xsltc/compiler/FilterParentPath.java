...
final class FilterParentPath extends Expression {
   ...
   * it is of reference type. This type coercion is needed for expressions like $x/LINE where $x is
  ...
  public void translate(ClassGenerator classGen, MethodGenerator methodGen) {
    ...
    final int initSI =
        cpg.addMethodref(
            STEP_ITERATOR_CLASS, "<init>", "(" + NODE_ITERATOR_SIG + NODE_ITERATOR_SIG + ")V");
    ...
    LocalVariableGen filterTemp =
        methodGen.addLocalVariable(
            "filter_parent_path_tmp1", Util.getJCRefType(NODE_ITERATOR_SIG), null, null);
    filterTemp.setStart(il.append(new ASTORE(filterTemp.getIndex())));

    _path.translate(classGen, methodGen);
    LocalVariableGen pathTemp =
        methodGen.addLocalVariable(
            "filter_parent_path_tmp2", Util.getJCRefType(NODE_ITERATOR_SIG), null, null);
