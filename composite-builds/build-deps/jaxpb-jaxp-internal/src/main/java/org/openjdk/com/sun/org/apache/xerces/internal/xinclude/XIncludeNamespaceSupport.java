...
public class XIncludeNamespaceSupport extends MultipleScopeNamespaceSupport {
  ...
  /**
   * This returns the namespace URI which was associated with the given pretext, in the context that
   * existed at the include parent of the current element. The include parent is the last element,
   * before the current one, which was not set to an invalid context using setContextInvalid()
   *
