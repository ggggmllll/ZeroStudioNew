...
public class XPathParser {
  ...
  public XPathParser(
      ErrorListener errorListener, org.openjdk.javax.xml.transform.SourceLocator sourceLocator) {
  ...
  private final void consumeExpected(String expected)
    ...
    if (tokenIs(expected)) {
      ...
      error(
          ...
          new Object[] {expected, m_token}); // "Expected "+expected+", but found: "+m_token);
   ...
   * whether error() or errorForDOM3() is called because it is always catching TransformerException
   * objects and is oblivious to the new subclass of XPathStylesheetDOM3Exception. Older XPath code
   * runs as before.
   *
   ...
   * @throws org.openjdk.javax.xml.transform.TransformerException
   */
  protected void RelativePathPattern() throws org.openjdk.javax.xml.transform.TransformerException {
