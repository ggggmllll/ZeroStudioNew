...
public class XMLEventWriterImpl implements XMLEventWriter {
  ...
  public void add(org.openjdk.javax.xml.stream.events.XMLEvent xMLEvent)
    ...
    switch (type) {
      ...
      case XMLEvent.START_DOCUMENT:
        {
          ...
          try {
            fStreamWriter.writeStartDocument(
                startDocument.getCharacterEncodingScheme(), startDocument.getVersion());
      ...
      case XMLEvent.START_ELEMENT:
        {
          ...
          // getNamespaces() Returns an Iterator of namespaces declared on this element. This
          // Iterator does not contain
          // previously declared namespaces unless they appear on the current START_ELEMENT.
          // Therefore
          // this list may contain redeclared namespaces and duplicate namespace declarations. Use
          // the
          // getNamespaceContext() method to get the current context of namespace declarations.

          // so we should be using getNamespaces() to write namespace declarations for this
          // START_ELEMENT
      ...
      case XMLEvent.PROCESSING_INSTRUCTION:
        {
          ...
          if (DEBUG)
            System.out.println(
                "Adding processing instruction = " + processingInstruction.toString());
      ...
      case XMLEvent.END_ELEMENT:
        {
          // we dont need to typecast it.. just call writeEndElement() and fStreamWriter will take
          // care of it.
      ...
      case XMLEvent.END_DOCUMENT:
        {
          // we dont need to typecast just call writeEndDocument() and fStreamWriter will take care
          // rest.
  ...
  /**
   * @throws XMLStreamException will inturn call flush on the stream to which data is being written.
   */
   ...
   * @throws XMLStreamException
   */
  public void setNamespaceContext(org.openjdk.javax.xml.namespace.NamespaceContext namespaceContext)
      throws org.openjdk.javax.xml.stream.XMLStreamException {
