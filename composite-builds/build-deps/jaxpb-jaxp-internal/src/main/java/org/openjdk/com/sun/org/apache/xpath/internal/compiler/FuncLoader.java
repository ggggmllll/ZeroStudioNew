...
public class FuncLoader {
  ...
  /**
   * Get the local class name of the function class. If function name does not have a '.' in it, it
   * is assumed to be relative to 'com.sun.org.apache.xpath.internal.functions'.
   *
