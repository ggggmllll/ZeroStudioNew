...
public class NodeIteratorImpl implements NodeIterator {
  ...
  /**
   * Return the next Node in the Iterator. The node is the next node in depth-first order which also
   * passes the filter, and whatToShow. If there is no next node which passes these criteria, then
   * return null.
   */
  ...
  /**
   * Return the previous Node in the Iterator. The node is the next node in _backwards_ depth-first
