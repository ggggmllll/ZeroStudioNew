  ...
  private static final Object[][] _contents =
      new Object[][] {
        ...
        {ER_ERROR_OCCURED, "Fel intr\u00E4ffade!"},
        {
          ...
          "VariableReference angiven f\u00F6r variabel som \u00E4r utanf\u00F6r kontext eller som"
              + " saknar definition! Namn = {0}"
        },
        {
          ER_AXES_NOT_ALLOWED,
        ...
        {ER_PREFIX_MUST_RESOLVE, "Prefix m\u00E5ste matchas till en namnrymd: {0}"},
        {
          ...
          "tolkning (InputSource-k\u00E4lla) st\u00F6ds inte i XPathContext! Kan inte \u00F6ppna"
              + " {0}"
        },
        ...
        // but no more characters were found in the expression.
        {
          ...
          "En s\u00F6kv\u00E4g f\u00F6rv\u00E4ntades, men slutet av XPath-uttrycket hittades"
              + " ist\u00E4llet."
        },
        ...
        // to a value of type boolean.
        {
          ...
          "XPathResult i XPath-uttrycket ''{0}'' inneh\u00E5ller XPathResultType {1} som inte kan"
              + " konverteras till booleskt v\u00E4rde."
        },
        ...
        // FIRST_ORDERED_NODE_TYPE.
        {
          ...
          "XPathResult i XPath-uttrycket ''{0}'' inneh\u00E5ller XPathResultType {1} som inte kan"
              + " konverteras till enskild nod. Metoden getSingleNodeValue anv\u00E4nds endast till"
              + " typ ANY_UNORDERED_NODE_TYPE och FIRST_ORDERED_NODE_TYPE."
        },
        ...
        // ORDERED_NODE_SNAPSHOT_TYPE.
        {
          ...
          "Metoden getSnapshotLength kan inte anropas vid XPathResult fr\u00E5n XPath-uttrycket"
              + " ''{0}'' eftersom XPathResultType \u00E4r {1}. Metoden anv\u00E4nds endast till"
              + " typ UNORDERED_NODE_SNAPSHOT_TYPE och ORDERED_NODE_SNAPSHOT_TYPE."
        },
        {
          ER_NON_ITERATOR_TYPE,
          "Metoden iterateNext kan inte anropas vid XPathResult fr\u00E5n XPath-uttrycket ''{0}''"
              + " eftersom XPathResultType \u00E4r {1}. Metoden anv\u00E4nds endast till typ"
              + " UNORDERED_NODE_ITERATOR_TYPE och ORDERED_NODE_ITERATOR_TYPE."
        },
        ...
        {ER_EMPTY_XPATH_RESULT, "Tomt XPath-resultatobjekt"},
        {
          ...
          "XPathResult i XPath-uttrycket ''{0}'' inneh\u00E5ller XPathResultType {1} som inte kan"
              + " tvingas till angiven XPathResultType {2}."
        },
        ...
        // UNORDERED_NODE_SNAPSHOT_TYPE and ORDERED_NODE_SNAPSHOT_TYPE.
        {
          ...
          "Metoden snapshotItem kan inte anropas vid XPathResult fr\u00E5n XPath-uttrycket ''{0}''"
              + " eftersom XPathResultType \u00E4r {1}. Metoden anv\u00E4nds endast till typ"
              + " UNORDERED_NODE_SNAPSHOT_TYPE och ORDERED_NODE_SNAPSHOT_TYPE."
        },
        ...
        },
        {
          ...
          "SecurityException vid f\u00F6rs\u00F6k att f\u00E5 \u00E5tkomst till XSL-systemegenskap:"
              + " {0}"
        },
