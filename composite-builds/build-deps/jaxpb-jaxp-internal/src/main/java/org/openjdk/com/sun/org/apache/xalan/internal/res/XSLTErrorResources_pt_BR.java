...
public class XSLTErrorResources_pt_BR extends ListResourceBundle {
  ...
  public Object[][] getContents() {
    return new Object[][] {
      ...
      {ER_NEED_NAME_OR_MATCH_ATTRIB, "{0} requer um atributo de nome ou de correspond\u00EAncia."},
      {
      ...
      },
      {
        ...
        "(StylesheetHandler) A folha de estilos {0} est\u00E1 incluindo a si mesma direta ou"
            + " indiretamente!"
      },
      ...
      {
        ER_MISSING_CONTAINER_ELEMENT_COMPONENT,
        "(StylesheetHandler) elemento {0} incorretamente posicionado?? Elemento ''component'' do"
      ...
      {ER_UNIMPLNODE_ERROR, "Erro de UnImplNode: {0}"},
      {
        ...
        "Erro! N\u00E3o foi poss\u00EDvel localizar a express\u00E3o de sele\u00E7\u00E3o xpath"
            + " (-select)."
      },
      {
      ...
      {ER_NO_XSLKEY_DECLARATION, "N\u00E3o h\u00E1 uma declara\u00E7\u00E3o de xsl:key para {0}!"},
      ...
      {ER_MISPLACED_XSLOTHERWISE, "(StylesheetHandler) xsl:otherwise posicionado incorretamente!"},
      {
        ER_XSLOTHERWISE_NOT_PARENTED_BY_XSLCHOOSE,
      ...
      },
      {
        ...
        "(StylesheetHandler) As importa\u00E7\u00F5es s\u00F3 podem ocorrer como os primeiros"
            + " elementos na folha de estilos!"
      },
      {
        ER_IMPORTING_ITSELF,
        "(StylesheetHandler) A folha de estilos {0} est\u00E1 importando a si mesmo(a) direta ou"
            + " indiretamente!"
      },
      ...
      },
      {
        ...
        "Redirecionar extens\u00E3o: N\u00E3o foi poss\u00EDvel obter o nome do arquivo - o arquivo"
            + " ou o atributo de sele\u00E7\u00E3o deve retornar uma string v\u00E1lida."
      },
      {
        ER_CANNOT_BUILD_FORMATTERLISTENER_IN_REDIRECT,
      ...
      {ER_NO_APPLY_IMPORT_IN_FOR_EACH, "xsl:apply-imports n\u00E3o permitido em um xsl:for-each"},
      {
        ...
        "N\u00E3o \u00E9 poss\u00EDvel usar um DTMLiaison para um n\u00F3 DOM de sa\u00EDda... em"
            + " vez disso, especifique um com.sun.org.apache.xpath.internal.DOM2Helper!"
      },
      {
        ER_CANT_USE_DTM_FOR_INPUT,
        "N\u00E3o \u00E9 poss\u00EDvel usar um DTMLiaison para um n\u00F3 DOM de entrada... em vez"
            + " disso, especifique um com.sun.org.apache.xpath.internal.DOM2Helper!"
      },
      ...
      {
        ER_INVALID_KEY_CALL,
        "Chamada de fun\u00E7\u00E3o inv\u00E1lida: chamadas recursivas de key() n\u00E3o s\u00E3o"
            + " permitidas"
      },
      {
      ...
      },
      {
        ...
        "A chamada do m\u00E9todo da inst\u00E2ncia para o m\u00E9todo {0} exige uma inst\u00E2ncia"
            + " do Objeto como primeiro argumento"
      },
      ...
      {ER_EXTENSION_FUNC_UNKNOWN, "Fun\u00E7\u00E3o da extens\u00E3o {0} : {1} desconhecido"},
      {
        ...
        "H\u00E1 mais de uma melhor correspond\u00EAncia para o construtor em rela\u00E7\u00E3o a"
            + " {0}"
      },
      {
      ...
      {ER_TWO_OR_THREE, "2 ou 3"},
      {
        ...
        "N\u00E3o foi poss\u00EDvel carregar {0} (verificar CLASSPATH); usando agora apenas os"
            + " defaults"
      },
      {
      ...
      {
        ER_PROPERTY_VALUE_BOOLEAN, "O valor da propriedade {0} deve ser uma inst\u00E2ncia Booliana"
      },
      {
        ER_COULD_NOT_FIND_EXTERN_SCRIPT, "N\u00E3o foi poss\u00EDvel obter um script externo em {0}"
      },
      ...
      // In latest Xalan code base key name is  ER_VALUE_SHOULD_BE_NUMBER. This should also be taken
      // care
      ...
      {ER_CHARS_NOT_ALLOWED, "Os caracteres n\u00E3o s\u00E3o permitidos neste ponto do documento"},
      ...
      {
        ER_NONWHITESPACE_NOT_ALLOWED_IN_POSITION,
        "Texto sem espa\u00E7o em branco n\u00E3o permitido nesta posi\u00E7\u00E3o na folha de"
            + " estilos!"
      },
      ...
      {
        INVALID_TCHAR,
        "Valor inv\u00E1lido: {1} usado para o atributo CHAR: {0}. Um atributo do tipo CHAR deve"
            + " ter somente 1 caractere!"
      },
      ...
      {
        ER_INVALID_NAMESPACE_URI_VALUE_FOR_RESULT_PREFIX_FOR_DEFAULT,
        "O atributo result-prefix de um elemento xsl:namespace-alias tem o valor '#default', mas"
            + " n\u00E3o h\u00E1 declara\u00E7\u00E3o do namespace default no escopo do elemento"
      },
      {
        ER_INVALID_NAMESPACE_URI_VALUE_FOR_RESULT_PREFIX,
        "O atributo result-prefix de um elemento xsl:namespace-alias tem o valor ''{0}'', mas"
            + " n\u00E3o h\u00E1 declara\u00E7\u00E3o de namespace para o prefixo ''{0}'' no escopo"
            + " do elemento."
      },
      {
        ER_SET_FEATURE_NULL_NAME,
        "O nome do recurso n\u00E3o pode ser nulo em TransformerFactory.setFeature(Nome da string,"
            + " valor booliano)."
      },
      {
      ...
      {
        ER_EXTENSION_ELEMENT_NOT_ALLOWED_IN_SECURE_PROCESSING,
        "O uso do elemento da extens\u00E3o ''{0}'' n\u00E3o ser\u00E1 permitido quando o recurso"
            + " de processamento seguro for definido como verdadeiro."
      },
      {
        ER_NAMESPACE_CONTEXT_NULL_NAMESPACE,
      ...
      },
      {
        ...
        "Advert\u00EAncia: N\u00E3o foi poss\u00EDvel encontrar o nome das configura\u00E7\u00F5es"
            + " regionais de xml:lang={0}"
      },
      {WG_CANNOT_MAKE_URL_FROM, "N\u00E3o \u00E9 poss\u00EDvel criar o URL de: {0}"},
      {
        WG_CANNOT_LOAD_REQUESTED_DOC, "N\u00E3o \u00E9 poss\u00EDvel carregar o doc solicitado: {0}"
      },
      {
      ...
      },
      {
        ...
        "Conflitos de especificidade encontrados: {0} Ser\u00E1 usado o \u00FAltimo encontrado na"
            + " folha de estilos."
      },
      ...
      {WG_ILLEGAL_ATTRIBUTE, "{0} tem um atributo inv\u00E1lido: {1}"},
      {
        ...
        "N\u00E3o foi poss\u00EDvel resolver o prefixo do namespace: {0}. O n\u00F3 ser\u00E1"
            + " ignorado."
      },
      ...
      {
        WG_EMPTY_SECOND_ARG,
        "O conjunto de n\u00F3s resultante do segundo argumento da fun\u00E7\u00E3o do documento"
            + " est\u00E1 vazio. Retorne um conjunto de n\u00F3s vazio."
      },
      ...
      {
        WG_PROCESSINGINSTRUCTION_NOTVALID_NCNAME,
        "O valor do atributo ''name'' de xsl:processing-instruction deve ser um NCName v\u00E1lido:"
            + " {0}"
      },
      ...
      // the attribute.
      {
        ...
        "N\u00E3o \u00E9 poss\u00EDvel adicionar o atributo {0} depois dos n\u00F3s filhos ou antes"
            + " que um elemento seja produzido. O atributo ser\u00E1 ignorado."
      },
      {
        NO_MODIFICATION_ALLOWED_ERR,
        "Foi feita uma tentativa de modificar um objeto no qual n\u00E3o s\u00E3o permitidas"
            + " modifica\u00E7\u00F5es."
      },
      ...
      {
        "xslProc_no_input",
        "Erro: N\u00E3o foi especificada uma folha de estilos ou um xml de entrada . Execute este"
            + " comando sem nenhuma op\u00E7\u00E3o para instru\u00E7\u00F5es de uso."
      },
      ...
      {
        "optionLF",
        "   [-LF (Usar alimenta\u00E7\u00F5es de linha somente na sa\u00EDda {o default \u00E9"
            + " CR/LF})]"
      },
      {
        "optionCR",
      ...
      {
        "optionESCAPE",
        "   [-ESCAPE (Quais caracteres devem ser identificados como escape {o default \u00E9"
            + " <>&\"'\\r"
            + "\\n"
            + "}]"
      },
      {
        "optionINDENT",
        "   [-INDENT (Controla quantos espa\u00E7os devem ser recuados {o default \u00E9 0})]"
      },
      ...
      {
        "optionVALIDATE",
        "   [-VALIDATE (Define se ocorre valida\u00E7\u00E3o. Por default, a valida\u00E7\u00E3o"
            + " fica desativada.)]"
      },
      {
        "optionEDUMP",
      ...
      {
        "noParsermsg4",
        "Se voc\u00EA n\u00E3o tiver um Parser XML da IBM para Java, poder\u00E1 fazer download"
            + " dele em"
      },
      ...
      },
      {
        ...
        "   [-ENTITYRESOLVER nome completo da classe (EntityResolver a ser usado para resolver"
            + " entidades)]"
      },
      {
        "optionCONTENTHANDLER",
        "   [-CONTENTHANDLER nome completo da classe (ContentHandler a ser usado para serializar a"
            + " sa\u00EDda)]"
      },
      ...
      // Following are the new options added in XSLTErrorResources.properties files after Jdk 1.4
      // (Xalan 2.2-D11)

      {
        "optionMEDIA",
        "   [-MEDIA mediaType (use o atributo de m\u00EDdia para localizar a folha de estilos"
      ...
      {
        "optionNOOPTIMIMIZE",
        "   [-NOOPTIMIMIZE (solicite o n\u00E3o processamento de otimiza\u00E7\u00E3o da folha de"
            + " estilos definindo http://xml.apache.org/xalan/features/optimize como falso.)]"
      },
      {
        "optionRL",
        "   [-RL recursionlimit (limite num\u00E9rico de asser\u00E7\u00E3o na profundidade de"
            + " recurs\u00E3o da folha de estilos.)]"
      },
      ...
      {
        "optionXP",
        "   [-XP pacote (especifica um prefixo de nome do pacote para todas as classes translet"
            + " geradas)]"
      },
