...
public final class ToXMLStream extends ToStream {
  ...
  /**
   * Starts a whitespace preserving section. All characters printed within a preserving section are
   * printed without indentation and without consolidating multiple spaces. This is equivalent to
   * the <tt>xml:space=&quot;preserve&quot;</tt> attribute. Only XML and HTML serializers need to
   * support this method.
   *
  ...
  public void processingInstruction(String target, String data) throws org.xml.sax.SAXException {
    ...
    if (target.equals(Result.PI_DISABLE_OUTPUT_ESCAPING)) {
      ...
      try {
        ...
        /**
         * Before Xalan 1497, a newline char was printed out if not inside of an element. The
         * whitespace is not significant is the output is standalone
         */
  ...
  /**
   * This method checks for the XML version of output document. If XML version of output document is
   * not specified, then output document is of version XML 1.0. If XML version of output doucment is
   * specified, but it is not either XML 1.0 or XML 1.1, a warning message is generated, the XML
