...
final class UnsupportedElement extends SyntaxTreeNode {
  ...
  /**
   * There are different categories of unsupported elements (believe it or not): there are elements
   * within the XSLT namespace (these would be elements that are not yet implemented), there are
   * extensions of other XSLT processors and there are unrecognised extension elements of this XSLT
   * processor. The error message passed to this method should describe the unsupported element
  ...
  public void translate(ClassGenerator classGen, MethodGenerator methodGen) {
    ...
    // the unsupported element has no fallback.
      ...
      final int unsupportedElem =
          cpg.addMethodref(BASIS_LIBRARY_CLASS, "unsupported_ElementF", "(" + STRING_SIG + "Z)V");
