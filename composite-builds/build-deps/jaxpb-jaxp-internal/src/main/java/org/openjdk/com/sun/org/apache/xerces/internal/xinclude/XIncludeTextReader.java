    ...
    if (source.getCharacterStream() != null) {
      ...
      if (source.getByteStream() != null) {
        ...
        String expandedSystemId =
            XMLEntityManager.expandSystemId(source.getSystemId(), source.getBaseSystemId(), false);
        ...
        /**
         * The encoding of such a resource is determined by: 1 external encoding information, if
         * available, otherwise -- the most common type of external information is the "charset"
         * parameter of a MIME package 2 if the media type of the resource is text/xml,
         * application/xml, or matches the conventions text/*+xml or application/*+xml as described
         * in XML Media Types [IETF RFC 3023], the encoding is recognized as specified in XML 1.0,
         * otherwise 3 the value of the encoding attribute if one exists, otherwise 4 UTF-8.
         */
      ...
      if (javaEncoding == null) {
        ...
        throw new IOException(
            aFormatter.formatMessage(aLocale, "EncodingDeclInvalid", new Object[] {encoding}));
