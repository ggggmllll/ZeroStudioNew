...
public final class NodeType extends Type {
  ...
  /**
   * Translates a node into an object of internal type <code>type</code>. The translation to int is
   ...
   * pushed iff "attr" is an attribute of the current node. If the expression is ".", the result is
   * always "true".
   *
   * @see Type#translateTo
   */
  ...
  /**
   * Expects a node on the stack and pushes a real. First the node is converted to string, and from
   * string to real.
   *
   * @see Type#translateTo
   */
  ...
  /**
   * Translates a node into the Java type denoted by <code>clazz</code>. Expects a node on the stack
   * and pushes an object of the appropriate type after coercion.
   */
