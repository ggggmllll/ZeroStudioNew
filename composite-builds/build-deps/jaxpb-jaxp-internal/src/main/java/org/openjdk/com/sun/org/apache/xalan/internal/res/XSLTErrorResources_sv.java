...
public class XSLTErrorResources_sv extends ListResourceBundle {
  ...
  public Object[][] getContents() {
    return new Object[][] {
      ...
      {
        ER_MISSING_CONTAINER_ELEMENT_COMPONENT,
        "(StylesheetHandler) {0}-element?? \u00E4r felplacerat Container-elementet ''component''"
            + " saknas"
      },
      {
        ER_CAN_ONLY_OUTPUT_TO_ELEMENT,
        "Kan endast skicka utdata till ett Element, ett DocumentFragment, ett Document eller en"
            + " PrintWriter."
      },
      ...
      {
        ER_BAD_XSLSORT_USE,
        "(StylesheetHandler) xsl:sort kan endast anv\u00E4ndas med xsl:apply-templates eller"
            + " xsl:for-each."
      },
      ...
      },
      {
        ...
        "(StylesheetHandler) Imports kan endast f\u00F6rekomma som de f\u00F6rsta elementen i"
            + " formatmallen!"
      },
      {
        ER_IMPORTING_ITSELF,
      ...
      },
      {
        ...
        "Redirect-till\u00E4gg: Hittade inte filnamn - fil eller valattribut m\u00E5ste returnera"
            + " giltig str\u00E4ng."
      },
      {
        ER_CANNOT_BUILD_FORMATTERLISTENER_IN_REDIRECT,
      ...
      {ER_STYLESHEET_REQUIRES_VERSION_ATTRIB, "xsl:stylesheet kr\u00E4ver ett 'version'-attribut!"},
      ...
      {
        ER_CHARS_NOT_ALLOWED, "Tecken \u00E4r inte till\u00E5tna i dokumentet i det h\u00E4r skedet"
      },
      ...
      {
        ER_NUMBER_TOO_BIG,
        "F\u00F6rs\u00F6ker formatera ett tal som \u00E4r st\u00F6rre \u00E4n det st\u00F6rsta"
            + " l\u00E5nga heltalet"
      },
      ...
      //   translated.
      {
        ER_ASSERT_REDUNDENT_EXPR_ELIMINATOR, "Programmerarens utsaga i RedundentExprEliminator: {0}"
      },
      {
      ...
      {
        INVALID_TCHAR,
        "Otill\u00E5tet v\u00E4rde: {1} anv\u00E4nds f\u00F6r CHAR-attributet: {0}. Ett attribut av"
            + " CHAR-typ f\u00E5r bara ha 1 tecken!"
      },
      ...
      {INVALID_QNAME, "Otill\u00E5tet v\u00E4rde: {1} anv\u00E4nds f\u00F6r QNAME-attributet: {0}"},
      ...
      {ER_ARG_LITERAL, "Argument f\u00F6r {0} i matchningsm\u00F6nstret m\u00E5ste vara litteral."},
      ...
      {
        ER_INVALID_NAMESPACE_URI_VALUE_FOR_RESULT_PREFIX_FOR_DEFAULT,
        "result-prefix-attributet i xsl:namespace-alias-element har v\u00E4rdet '#default', men det"
            + " finns ingen deklaration av standardnamnrymd inom omfattningen av elementet"
      },
      {
        ER_INVALID_NAMESPACE_URI_VALUE_FOR_RESULT_PREFIX,
        "result-prefix-attributet i xsl:namespace-alias-element har v\u00E4rdet ''{0}'', men det"
            + " finns ingen deklaration av namnrymd f\u00F6r prefixet ''{0}'' inom omfattningen av"
            + " elementet."
      },
      {
      ...
      {
        ER_EXTENSION_ELEMENT_NOT_ALLOWED_IN_SECURE_PROCESSING,
        "Anv\u00E4ndning av till\u00E4ggselementet ''{0}'' \u00E4r inte till\u00E5tet n\u00E4r"
            + " s\u00E4ker bearbetning till\u00E4mpas."
      },
      {
        ER_NAMESPACE_CONTEXT_NULL_NAMESPACE,
      ...
      {WG_NO_DECIMALFORMAT_DECLARATION, "Hittade ingen deklaration f\u00F6r decimalformatet: {0}"},
      ...
      {WG_STYLESHEET_REQUIRES_VERSION_ATTRIB, "xsl:stylesheet kr\u00E4ver ett 'version'-attribut!"},
      {WG_ILLEGAL_ATTRIBUTE_NAME, "Ogiltigt attributnamn: {0}"},
      {WG_ILLEGAL_ATTRIBUTE_VALUE, "Ogiltigt v\u00E4rde anv\u00E4nds f\u00F6r attributet {0}: {1}"},
      {
        WG_EMPTY_SECOND_ARG,
        "Resulterande nodupps\u00E4ttning fr\u00E5n dokumentfunktionens andra argumentet \u00E4r"
            + " tomt. En tom nodupps\u00E4ttning anv\u00E4nds."
      },
      ...
      {
        WG_PROCESSINGINSTRUCTION_NOTVALID_NCNAME,
        "''name''-attributets v\u00E4rde f\u00F6r xsl:processing-instruction m\u00E5ste vara"
            + " giltigt NCName: {0}"
      },
      ...
      // the attribute.
      {
        ...
        "Kan inte l\u00E4gga till attributet {0} efter underordnade noder eller innan ett element"
            + " har skapats. Attributet ignoreras."
      },
      {
      ...
      {
        "xslProc_no_input",
        "Fel: Ingen formatmall eller indata-xml har angetts. K\u00F6r kommandot utan n\u00E5got"
            + " alternativ f\u00F6r att visa syntax."
      },
      ...
      {
        "optionVALIDATE",
        "   [-VALIDATE (St\u00E4ll in om validering utf\u00F6rs. Standard \u00E4r att validering"
            + " \u00E4r avst\u00E4ngd.)]"
      },
      ...
      {
        "optionURIRESOLVER",
        "   [-URIRESOLVER fullst\u00E4ndigt klassnamn (URIResolver som anv\u00E4nds vid matchning"
            + " av URI-er)]"
      },
      {
        "optionENTITYRESOLVER",
        "   [-ENTITYRESOLVER fullst\u00E4ndigt klassnamn (EntityResolver som anv\u00E4nds vid"
            + " matchning av enheter)]"
      },
      {
        "optionCONTENTHANDLER",
        "   [-CONTENTHANDLER fullst\u00E4ndigt klassnamn (ContentHandler som anv\u00E4nds vid"
      ...
      {
        "optionMEDIA",
        "   [-MEDIA mediaType (anv\u00E4nd medieattribut f\u00F6r att hitta formatmall som h\u00F6r"
            + " ihop med dokument.)]"
      },
      {
        "optionFLAVOR",
      ...
      {
        "optionNOOPTIMIMIZE",
        "   [-NOOPTIMIMIZE (beg\u00E4r att ingen formatmallsoptimering utf\u00F6rs genom att ange"
