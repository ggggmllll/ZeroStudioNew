...
abstract class XSDAbstractTraverser {
  ...
  XSAnnotationImpl traverseAnnotationDecl(
      Element annotationDecl, Object[] parentAttrs, boolean isGlobal, XSDocumentInfo schemaDoc) {
      ...
      if (facet.equals(SchemaSymbols.ELT_ENUMERATION)) {
        ...
        if (child != null) {
          reportSchemaError(
              ...
              new Object[] {"enumeration", "(annotation?)", DOMUtil.getLocalName(child)},
              child);
        }
      ...
      if (childName.equals(SchemaSymbols.ELT_ATTRIBUTE)) {
        ...
        otherUse =
            attrGrp.getAttributeUseNoProhibited(
                tempAttrUse.fAttrDecl.getNamespace(), tempAttrUse.fAttrDecl.getName());
        if (otherUse == null) {
          ...
          if (idName != null) {
            ...
            reportSchemaError(
                code, new Object[] {name, tempAttrUse.fAttrDecl.getName(), idName}, child);
          }
        ...
        tempAttrGrp =
            fSchemaHandler.fAttributeGroupTraverser.traverseLocal(child, schemaDoc, grammar);
        ...
        for (int i = 0; i < attrCount; i++) {
          ...
          if (otherUse == null) {
            ...
            if (idName != null) {
              ...
              String name = (enclosingCT == null) ? attrGrp.fName : enclosingCT.getName();
              reportSchemaError(
                  code, new Object[] {name, oneAttrUse.fAttrDecl.getName(), idName}, child);
            }
    ...
    if (child != null) {
      ...
      if (childName.equals(SchemaSymbols.ELT_ANYATTRIBUTE)) {
        ...
        // perform intersection of attribute wildcard
          ...
          attrGrp.fAttributeWC =
              tempAttrWC.performIntersectionWith(attrGrp.fAttributeWC, tempAttrWC.fProcessContents);
          if (attrGrp.fAttributeWC == null) {
            String code = (enclosingCT == null) ? "src-attribute_group.2" : "src-ct.4";
            String name = (enclosingCT == null) ? attrGrp.fName : enclosingCT.getName();
            reportSchemaError(code, new Object[] {name}, child);
