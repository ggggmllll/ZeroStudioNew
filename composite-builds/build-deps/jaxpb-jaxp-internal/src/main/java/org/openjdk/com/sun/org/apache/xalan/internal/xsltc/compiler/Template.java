...
public final class Template extends TopLevelElement {
   ...
   * method to force some specific behaviour. What we need to do is: o) create a pattern matching on
   * the root node o) add the LRE root node (the only child of the Stylesheet) as our only child
   * node o) set the empty Stylesheet as our parent o) set this template as the Stylesheet's only
   * child
   */
