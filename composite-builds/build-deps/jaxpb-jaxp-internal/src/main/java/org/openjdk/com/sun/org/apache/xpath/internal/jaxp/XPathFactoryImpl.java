...
public class XPathFactoryImpl extends XPathFactory {
  ...
  public boolean isObjectModelSupported(String objectModel) {
    ...
    if (objectModel == null) {
      String fmsg =
          XSLMessages.createXPATHMessage(
              XPATHErrorResources.ER_OBJECT_MODEL_NULL, new Object[] {this.getClass().getName()});
    ...
    if (objectModel.length() == 0) {
      String fmsg =
          XSLMessages.createXPATHMessage(
              XPATHErrorResources.ER_OBJECT_MODEL_EMPTY, new Object[] {this.getClass().getName()});
   ...
   * possible for an <code>XPathFactory</code> to expose a feature value but be unable to change its
   * state.
   *
   ...
   * @throws XPathFactoryConfigurationException if this <code>XPathFactory</code> or the <code>XPath
  ...
  public boolean getFeature(String name) throws XPathFactoryConfigurationException {
    ...
    String fmsg =
        XSLMessages.createXPATHMessage(
            XPATHErrorResources.ER_GETTING_UNKNOWN_FEATURE, new Object[] {name, CLASS_NAME});
  ...
  public void setXPathFunctionResolver(XPathFunctionResolver resolver) {
    ...
    if (resolver == null) {
      String fmsg =
          XSLMessages.createXPATHMessage(
              XPATHErrorResources.ER_NULL_XPATH_FUNCTION_RESOLVER, new Object[] {CLASS_NAME});
      throw new NullPointerException(fmsg);
    }
  ...
  public void setXPathVariableResolver(XPathVariableResolver resolver) {
    ...
    if (resolver == null) {
      String fmsg =
          XSLMessages.createXPATHMessage(
              XPATHErrorResources.ER_NULL_XPATH_VARIABLE_RESOLVER, new Object[] {CLASS_NAME});
      throw new NullPointerException(fmsg);
    }
