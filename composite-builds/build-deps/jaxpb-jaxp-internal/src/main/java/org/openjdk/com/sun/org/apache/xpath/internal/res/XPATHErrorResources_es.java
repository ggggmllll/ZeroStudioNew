  ...
  private static final Object[][] _contents =
      new Object[][] {
        ...
        {ER_ERROR_OCCURED, "Se ha producido un error."},
        {
          ...
          "La referencia de variable proporcionada para la variable est\u00E1 fuera de contexto o"
              + " no tiene definici\u00F3n. Nombre = {0}"
        },
        {
          ER_AXES_NOT_ALLOWED,
          "S\u00F3lo los ejes child:: y attribute:: est\u00E1n permitidos en los patrones de"
              + " coincidencia. Ejes incorrectos = {0}"
        },
        ...
        {ER_PREFIX_MUST_RESOLVE, "El prefijo se debe resolver en un espacio de nombres: {0}"},
        {
          ...
          "El an\u00E1lisis (origen de InputSource) no est\u00E1 soportado en XPathContext. No se"
              + " puede abrir {0}"
        },
        ...
        // the characters specified by the substitution text were encountered instead.
        {
          ...
          "Se esperaba una ruta de acceso de ubicaci\u00F3n, pero se ha encontrado el siguiente"
              + " token: {0}"
        },
        ...
        // but no more characters were found in the expression.
        {
          ...
          "Se esperaba una ruta de acceso de ubicaci\u00F3n, pero se ha encontrado el final de la"
              + " expresi\u00F3n XPath en su lugar."
        },
        ...
        // FIRST_ORDERED_NODE_TYPE.
        {
          ...
          "El valor de XPathResult de la expresi\u00F3n XPath ''{0}'' tiene un valor de"
              + " XPathResultType de {1} que no se puede convertir a un nodo \u00FAnico. El"
              + " m\u00E9todo getSingleNodeValue se aplica s\u00F3lo a los tipos"
        ...
        // ORDERED_NODE_SNAPSHOT_TYPE.
        {
          ...
          "No se puede llamar al m\u00E9todo getSnapshotLength en la expresi\u00F3n XPathResult de"
              + " XPath ''{0}'' porque el valor de su XPathResultType es {1}. Este m\u00E9todo se"
              + " aplica s\u00F3lo a los tipos UNORDERED_NODE_SNAPSHOT_TYPE y"
              + " ORDERED_NODE_SNAPSHOT_TYPE."
        },
        {
          ER_NON_ITERATOR_TYPE,
          "No se puede llamar al m\u00E9todo iterateNext en el XPathResult de la expresi\u00F3n"
              + " XPath ''{0}'' porque el valor de su XPathResultType es {1}. Este m\u00E9todo se"
              + " aplica s\u00F3lo a los tipos UNORDERED_NODE_ITERATOR_TYPE y"
        ...
        {ER_EMPTY_XPATH_RESULT, "Objeto de resultado XPath vac\u00EDo"},
        {
          ...
          "El valor de XPathResult de la expresi\u00F3n XPath ''{0}'' tiene un valor de"
              + " XPathResultType de {1} que no se puede forzar en el XPathResultType especificado"
              + " de {2}."
        },
        {
          ER_NULL_RESOLVER,
        ...
        // UNORDERED_NODE_SNAPSHOT_TYPE and ORDERED_NODE_SNAPSHOT_TYPE.
        {
          ...
          "No se puede llamar al m\u00E9todo snapshotItem en la expresi\u00F3n XPathResult de XPath"
              + " ''{0}'' porque el valor de su XPathResultType es {1}. Este m\u00E9todo se aplica"
              + " s\u00F3lo a los tipos UNORDERED_NODE_SNAPSHOT_TYPE y ORDERED_NODE_SNAPSHOT_TYPE."
        },
        ...
        {
          ER_EXTENSION_FUNCTION_CANNOT_BE_INVOKED,
          "Funci\u00F3n de extensi\u00F3n: no se puede llamar a ''{0}'' cuando la funci\u00F3n"
              + " XMLConstants.FEATURE_SECURE_PROCESSING est\u00E1 definida en true."
        },
        ...
        },
        {
          ...
          "FEATURE_SECURE_PROCESSING: no se puede definir la funci\u00F3n en false cuando est\u00E1"
              + " presente el gestor de seguridad: {1}#setFeature({0},{2})"
        },
...

        {
          ...
          "El nombre de la configuraci\u00F3n regional en la funci\u00F3n format-number no se ha"
              + " manejado a\u00FAn."
        },
