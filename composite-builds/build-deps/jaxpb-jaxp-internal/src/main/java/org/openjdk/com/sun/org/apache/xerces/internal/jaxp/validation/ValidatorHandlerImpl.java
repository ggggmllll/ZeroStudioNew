...
final class ValidatorHandlerImpl extends ValidatorHandler
  ...
  public boolean getFeature(String name)
    ...
    try {
      ...
      final String key =
          e.getType() == Status.NOT_RECOGNIZED ? "feature-not-recognized" : "feature-not-supported";
  ...
  public void processingInstruction(String target, String data) throws SAXException {
    /**
     * Processing instructions do not participate in schema validation, so just forward the event to
     * the application's content handler.
     */
    if (fContentHandler != null) {
          ...
          try {
            ...
            if (reader instanceof SAXParser) {
              ...
              try {
                ...
                System.err.println(
                    "Warning: " + reader.getClass().getName() + ": " + exc.getMessage());
              }
            }
          } catch (Exception e) {
  ...
  private void fillXMLAttribute(Attributes att, int index) {
    ...
    fAttributes.addAttributeNS(
        fAttributeQName, (type != null) ? type : XMLSymbols.fCDATASymbol, att.getValue(index));
  }
  ...
  private class XMLSchemaTypeInfoProvider extends TypeInfoProvider {
    ...
    /**
     * Throws a {@link IllegalStateException} if we are not in the startElement callback. the JAXP
     * API requires this for most of the public methods.
     */
  ...
  static final class ResolutionForwarder implements EntityResolver2 {
    ...
    public InputSource resolveEntity(String name, String publicId, String baseURI, String systemId)
      ...
      if (fEntityResolver != null) {
        LSInput lsInput =
            fEntityResolver.resolveResource(XML_TYPE, null, publicId, systemId, baseURI);
        if (lsInput != null) {
           ...
           * characterStream, byteStream, stringData, systemId, publicId. For consistency with the
           * DOM Level 3 Load and Save Recommendation use the same lookup order here.
           */
