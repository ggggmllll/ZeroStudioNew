...
final class Message extends Instruction {
  ...
  public void translate(ClassGenerator classGen, MethodGenerator methodGen) {
    ...
    switch (elementCount()) {
      ...
      default:
        ...
        il.append(
            new INVOKEINTERFACE(
                cpg.addInterfaceMethodref(
                    TRANSLET_OUTPUT_INTERFACE, "setWriter", "(" + WRITER_SIG + ")V"),
                2));
        ...
        il.append(
            new INVOKEINTERFACE(
                cpg.addInterfaceMethodref(
                    TRANSLET_OUTPUT_INTERFACE, "setEncoding", "(" + STRING_SIG + ")V"),
                2));
        ...
        il.append(
            new INVOKEINTERFACE(
                cpg.addInterfaceMethodref(TRANSLET_OUTPUT_INTERFACE, "startDocument", "()V"), 1));
        ...
        il.append(
            new INVOKEVIRTUAL(cpg.addMethodref(STRING_WRITER, "toString", "()" + STRING_SIG)));
    ...
    if (_terminate == true) {
      ...
      final int einit =
          cpg.addMethodref("java.lang.RuntimeException", "<init>", "(Ljava/lang/String;)V");
