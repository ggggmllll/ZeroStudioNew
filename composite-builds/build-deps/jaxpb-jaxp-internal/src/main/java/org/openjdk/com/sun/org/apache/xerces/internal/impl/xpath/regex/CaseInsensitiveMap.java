...
public class CaseInsensitiveMap {
  ...
  /**
   * Return a list of code point characters (not including the input value) that can be substituted
  ...
  private static int[] updateMap(
      int codePoint, int[] codePointMap, int ciCodePoint, int[] ciCodePointMap, int matchType) {
