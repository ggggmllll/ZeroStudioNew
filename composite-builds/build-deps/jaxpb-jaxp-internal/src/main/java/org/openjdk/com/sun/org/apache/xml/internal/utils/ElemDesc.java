...
class ElemDesc {
  ...
  /**
   * Element's flags, describing the role this element plays during formatting of the document. This
   * is used as a bitvector; more than one flag may be set at a time, bitwise-ORed together.
   * Mnemonic and bits have been assigned to the flag values. NOTE: Some bits are currently assigned
   * multiple mnemonics; it is the caller's responsibility to disambiguate these if necessary.
   */
  int m_flags;
