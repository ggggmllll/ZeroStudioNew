...
public final class ToHTMLSAXHandler extends ToSAXHandler {
  ...
  protected void closeStartTag() throws SAXException {
    ...
    m_saxHandler.startElement(
        EMPTYSTRING, m_elemContext.m_elementName, m_elemContext.m_elementName, m_attributes);
    m_attributes.clear();
  }
  ...
  public void startElement(String elementNamespaceURI, String elementLocalName, String elementName)
    ...
    if (!m_dtdHandled) {
      ...
      if ((doctypeSystem != null) || (doctypePublic != null)) {
        if (m_lexHandler != null) m_lexHandler.startDTD(elementName, doctypePublic, doctypeSystem);
      }
      m_dtdHandled = true;
    }
