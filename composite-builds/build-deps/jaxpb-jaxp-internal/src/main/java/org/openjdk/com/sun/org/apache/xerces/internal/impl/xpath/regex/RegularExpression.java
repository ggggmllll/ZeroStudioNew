...
public class RegularExpression implements java.io.Serializable {
          ...
          case Op.BACKREFERENCE:
            {
              ...
              if (dx > 0) {
                ...
                if (!target.regionMatches(
                    isSetIgnoreCase, offset - literallen, con.limit, o2, literallen)) {
                  returned = true;
                  break;
                }
                offset -= literallen;
          ...
          case Op.STRING:
            {
              ...
              if (dx > 0) {
                ...
                if (!target.regionMatches(
                    isSetIgnoreCase, offset - literallen, con.limit, literal, literallen)) {
                  returned = true;
                  break;
                }
                offset -= literallen;
    ...
    */
    ...
    if (this.operations != null
      ...
      this.fixedStringTable =
          new BMPattern(this.fixedString, 256, isSet(this.fixedStringOptions, IGNORE_CASE));
  ...
  /**
   * Returns a option string. The order of letters in it may be different from a string specified in
   * a constructor or <code>setPattern()</code>.
   *
