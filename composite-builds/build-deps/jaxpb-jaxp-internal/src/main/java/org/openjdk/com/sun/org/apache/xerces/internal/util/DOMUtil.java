...
public class DOMUtil {
  ...
  /**
   * Copies the source tree into the specified place in a destination tree. The source node and its
   * children are appended as children of the destination node.
   *
  ...
  /**
   * Finds and returns the last visible child element node. Overload previous method for non-Xerces
   * node impl
   */
