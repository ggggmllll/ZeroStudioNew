...
public class Constants {
   ...
   *
   * <ul>
   *   <li>S_XMLNAMESPACEURI (http://www.w3.org/XML/1998/namespace) is the URI permanantly assigned
   *       to the "xml:" prefix. This is used for some features built into the XML specification
   *       itself, such as xml:space and xml:lang. It was defined by the W3C's XML Namespaces spec.
   *   <li>S_XSLNAMESPACEURL (http://www.w3.org/1999/XSL/Transform) is the URI which indicates that
   *       a name may be an XSLT directive. In most XSLT stylesheets, this is bound to the "xsl:"
   *       prefix. It's defined by the W3C's XSLT Recommendation.
   ...
   * predefined to signify Xalan's built-in XSLT Extensions. When used in stylesheets, this is often
