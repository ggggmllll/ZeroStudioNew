...
public final class OutputPropertiesFactory {
   ...
   * constructor that implements the ContentHandler interface, where the result tree events will be
   * sent to.
   */
  ...
  /**
   * This non-standard property key is used to specify the name of the property file that specifies
   * character to entity reference mappings.
   */
      ...
      if (defaults == null) {
        ...
        throw new WrappedRuntimeException(
            org.openjdk.com.sun.org.apache.xml.internal.serializer.utils.Utils.messages
                .createMessage(MsgKey.ER_COULD_NOT_LOAD_RESOURCE, new Object[] {resourceName}),
            ioe);
