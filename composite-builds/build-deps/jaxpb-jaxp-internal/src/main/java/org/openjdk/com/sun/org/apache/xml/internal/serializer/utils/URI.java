...
final class URI {
  ...
  public void setScheme(String p_scheme) throws MalformedURIException {
    ...
    if (p_scheme == null) {
      throw new MalformedURIException(
          Utils.messages.createMessage(
              MsgKey.ER_SCHEME_FROM_NULL_STRING, null)); // "Cannot set scheme from null string!");
    }

    if (!isConformantSchemeName(p_scheme)) {
      throw new MalformedURIException(
          Utils.messages.createMessage(
              MsgKey.ER_SCHEME_NOT_CONFORMANT, null)); // "The scheme is not conformant.");
    }
  ...
  public void setPort(int p_port) throws MalformedURIException {
    ...
    if (p_port >= 0 && p_port <= 65535) {
      if (m_host == null) {
        throw new MalformedURIException(
            Utils.messages.createMessage(
                MsgKey.ER_PORT_WHEN_HOST_NULL, null)); // "Port cannot be set when host is null!");
      }
    } else if (p_port != -1) {
      throw new MalformedURIException(
  ...
  public void setFragment(String p_fragment) throws MalformedURIException {
    ...
    if (p_fragment == null) {
      ...
      throw new MalformedURIException(
          Utils.messages.createMessage(
              MsgKey.ER_FRAG_INVALID_CHAR, null)); // "Fragment contains invalid character!");
    } else {
