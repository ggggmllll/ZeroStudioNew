...
public class OutputFormat {
  ...
  /**
   * Constructs a new output format with the proper method, document type identifiers and media type
  ...
  /**
   * Constructs a new output format with the proper method, document type identifiers and media type
   * for the specified document, and with the specified encoding. If <tt>indent</tt> is true, the
   * document will be pretty printed with the default indentation level and default line wrapping.
   *
   * @param doc The document to output
   * @param encoding The specified encoding
   * @param indenting True for pretty printing
  ...
  /**
   * Returns the method specified for this output format. Typically the method will be <tt>xml</tt>,
   * <tt>html</tt> or <tt>text</tt>, but it might be other values. If no method was specified, null
   * will be returned and the most suitable method will be determined for the document by calling
   * {@link #whichMethod}.
   *
  ...
  /**
   * Sets the version for this output method. For XML the value would be "1.0", for HTML it would be
   * "4.0".
   *
   * @see #getVersion
   ...
   * different indentation level or line wrapping, use {@link #setIndent} and {@link #setLineWidth}.
   *
   ...
   * "UTF-8". Make sure the encoding is compatible with the one used by the {@link java.io.Writer}.
   *
   * @see #getEncoding
  ...
  /**
   * Sets the document type public and system identifiers. Required only if the DOM Document or SAX
   * events do not specify the document type, and one must be present in the serialized document.
   * Any document type specified by the DOM Document or SAX events will override these values.
   *
  ...
  /**
   * Returns a list of all the elements whose text node children should be output as CDATA, or null
  ...
  /**
   * Sets the list of elements for which text node children should be output unescaped (no character
   * references).
   *
   ...
   * do not specify otherwise or specify the default behavior will be formatted based on this rule.
   * All elements that specify space preserving will always preserve space.
   */
  ...
  /**
   * Sets space preserving as the default behavior. The default is space stripping and all elements
   * that do not specify otherwise or use the default value will not preserve spaces.
   *
   ...
   * {@link org.w3c.dom.html.HTMLDocument} then the method is said to be <tt>html</tt>. If the root
   * element is 'html' and all text nodes preceding the root element are all whitespace, then the
   * method is said to be <tt>html</tt>. Otherwise the method is <tt>xml</tt>.
   *
