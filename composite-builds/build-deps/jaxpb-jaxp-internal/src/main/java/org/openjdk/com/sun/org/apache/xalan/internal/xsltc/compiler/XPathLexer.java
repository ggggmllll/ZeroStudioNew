...
class XPathLexer implements Scanner {
   ...
   * http://www.w3.org/TR/xpath#exprlex then treat as a name instead of a keyword (Jira-1912). Look
   * two tokens behind to desambiguate expressions like "* and *" or "and * and".
   */
