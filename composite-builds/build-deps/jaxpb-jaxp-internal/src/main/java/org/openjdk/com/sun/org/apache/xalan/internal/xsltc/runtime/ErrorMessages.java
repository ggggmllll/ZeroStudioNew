  ...
  public Object[][] getContents() {
    return new Object[][] {
       ...
       */
      {
        ...
        "The specified translet, ''{0}'', was created using a version of XSLTC more recent than the"
            + " version of the XSLTC run-time that is in use.  You must recompile the stylesheet or"
            + " use a more recent version of XSLTC to run this translet."
      },
      ...
      },
      {
        ...
        "Use of the extension function ''{0}'' is not allowed when the secure processing feature is"
            + " set to true."
      },
      {
