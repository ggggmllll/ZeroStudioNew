...
public class XSGrammarBucket {
  ...
  /**
   * Put a schema grammar into the registry This method is for internal use only: it assumes that a
   * grammar with the same target namespace is not already in the bucket.
   *
   ...
   * registry. when a grammar with the same target namespace is already in the bucket, and different
   * from the one being added, it's an error, and no grammar will be added into the bucket.
   *
   * @param grammar the grammar to put in the registry
   ...
   * put a schema grammar and any grammars imported by it (directly or inderectly) into the
   * registry. when a grammar with the same target namespace is already in the bucket, and different
   * from the one being added, no grammar will be added into the bucket.
   *
   * @param grammar the grammar to put in the registry
   * @param deep whether to add imported grammars
