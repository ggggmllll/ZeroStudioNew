...
class VariableRefBase extends Expression {
  ...
  /**
   * If this variable reference is in a top-level element like another variable, param or key, add a
   * dependency between that top-level element and the referenced variable. For example,
   *
   * <p><xsl:variable name="x" .../> <xsl:variable name="y" select="$x + 1"/>
   *
   * <p>and assuming this class represents "$x", add a reference between variable y and variable x.
   */
  ...
  public boolean equals(Object obj) {
    return obj == this
        || (obj instanceof VariableRefBase) && (_variable == ((VariableRefBase) obj)._variable);
  }
