...
public final class DOMImplementationRegistry {
   ...
   * implementing the <code>DOMImplementationSource</code> interface. Each class listed in the class
   * name list is instantiated and any exceptions encountered are thrown to the application.
   *
  ...
  /**
   * Return the first implementation that has the desired features, or <code>null</code> if none is
   * found.
   *
