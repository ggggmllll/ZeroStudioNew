 ...
 *   <li>JSR 175 recommends package-info.java for package level annotations. JAXB Providers that
 *       follow this recommendation will allow the package level annotations to be defined in
 *       package-info.java.
 * </ul>
 *
...
public @interface XmlSchema {
   ...
   * namespace are generated by a JAXB Provider in an implementation dependent way.
   */
  XmlNs[] xmlns() default {};
   ...
   *
   * <p>This instructs the JAXB schema generators to simply refer to the pointed schema, as opposed
   * to generating components into the schema. This schema is assumed to match what would be
   * otherwise produced by the schema generator (same element names, same type names...)
   *
