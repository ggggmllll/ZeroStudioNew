...
public interface HTMLTableRowElement extends HTMLElement {
  /**
   * The index of this row, relative to the entire table, starting from 0. This is in document tree
   * order and not display order. The <code>rowIndex</code> does not take into account sections (
   * <code>THEAD</code> , <code>TFOOT</code> , or <code>TBODY</code> ) within the table.
   */
  ...
  /**
   * Background color for rows. See the bgcolor attribute definition in HTML 4.0. This attribute is
