...
public interface ErrorHandler {
   ...
   * defined by the XML recommendation. The default behaviour is to take no action.
   *
   ...
   * application cannot do so, then the parser should report a fatal error even if the XML
   ...
   * documentation for {@link org.xml.sax.ContentHandler#endDocument}. Until this ambiguity is
   * resolved in a future major release, clients should make no assumptions about whether
   * endDocument() will or will not be invoked when the parser has reported a fatalError() or thrown
   * an exception.</strong>
   *
   ...
   * method, and should continue (if at all) only for the sake of collecting additional error
