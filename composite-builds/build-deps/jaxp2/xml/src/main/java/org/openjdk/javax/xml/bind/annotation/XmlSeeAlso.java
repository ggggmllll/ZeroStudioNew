 ...
 * in a way of JAXB users, as it JAXB cannot automatically list up the classes that need to be known
 * to {@link JAXBContext}.
 *
 ...
 * annotation, JAXB implementations will be able to correctly bind {@code Dog} and {@code Cat}.
 *
