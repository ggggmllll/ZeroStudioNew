...
public interface TransformerHandler extends ContentHandler, LexicalHandler, DTDHandler {
  ...
  /**
   * Set the <code>Result</code> associated with this <code>TransformerHandler</code> to be used for
   * the transformation.
   *
  ...
  /**
   * Get the <code>Transformer</code> associated with this handler, which is needed in order to set
