...
public class DOMException extends RuntimeException {
  ...
  /**
   * If an attempt is made to create or change an object in a way which is incorrect with regard to
   * namespaces.
   *
   * @since DOM Level 2
   */
  ...
  /**
   * If the type of an object is incompatible with the expected type of the parameter associated to
   * the object.
   *
   * @since DOM Level 3
   */
