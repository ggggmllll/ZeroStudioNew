...
public interface XPath {
   ...
   * </code>s, e.g. {@link Object#equals(Object obj)}. It is guaranteed to have a functionally equal
   * <code>XPathFunctionResolver</code>, <code>XPathVariableResolver</code> and <code>
   ...
   *
   * <p>A <code>NullPointerException</code> is thrown if <code>resolver</code> is <code>null</code>.
   *
   ...
   *
   * <p>A <code>NullPointerException</code> is thrown if <code>nsContext</code> is <code>null</code>
   * .
   *
   ...
   * org.openjdk.javax.xml.xpath.XPathExpressionException} will be thrown if the <code>XPathFunction
   * </code> cannot be resovled with the <code>XPathFunctionResolver</code>.
   *
   ...
   * @throws org.openjdk.javax.xml.xpath.XPathExpressionException If <code>expression</code> cannot
   *     be compiled.
  ...
  /**
   * Evaluate an <code>XPath</code> expression in the specified context and return the result as the
   * specified type.
   *
   ...
   * @return Result of evaluating an XPath expression as an <code>Object</code> of <code>returnType
   *     </code>.
   * @throws org.openjdk.javax.xml.xpath.XPathExpressionException If <code>expression</code> cannot
   *     be evaluated.
   * @throws IllegalArgumentException If <code>returnType</code> is not one of the types defined in
   *     {@link org.openjdk.javax.xml.xpath.XPathConstants}.
   ...
   * <code>returnType</code> of {@link org.openjdk.javax.xml.xpath.XPathConstants#STRING}.
   *
   * <p>See <a href="#XPath-evaluation">Evaluation of XPath Expressions</a> for context item
