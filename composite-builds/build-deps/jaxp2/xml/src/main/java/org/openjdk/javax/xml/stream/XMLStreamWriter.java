...
public interface XMLStreamWriter {
   ...
   * internal namespace context. Writing the corresponding EndElement causes the scope to be closed.
   *
   ...
   * UnsupportedOperationException. For example note that any namespace declarations, end tags, etc.
   * will be ignored and could interfere with proper maintanence of the writers internal state.
   *
  ...
  /**
   * Write the XML Declaration. Note that the encoding parameter does not set the actual encoding of
   * the underlying output. That must be set when the instance of the XMLStreamWriter is created
   ...
   * method as the root context for resolving namespaces. This method may only be called once at the
   * start of the document. It does not cause the namespaces to be declared. If a namespace URI to
   * prefix mapping is found in the namespace context it is treated as declared and the prefix may
