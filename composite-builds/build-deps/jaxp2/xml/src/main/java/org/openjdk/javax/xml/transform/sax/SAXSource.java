...
public class SAXSource implements Source {
   ...
   * {@link #setInputSource(InputSource inputSource)} , then the <code>Transformer</code> will
   * create an empty source {@link org.xml.sax.InputSource} using {@link
  ...
  /**
   * Create a <code>SAXSource</code>, using an {@link org.xml.sax.XMLReader} and a SAX InputSource.
   * The {@link Transformer} or {@link SAXTransformerFactory} will set itself to be the reader's
   * {@link org.xml.sax.ContentHandler}, and then will call reader.parse(inputSource).
   *
  ...
  /**
   * Create a <code>SAXSource</code>, using a SAX <code>InputSource</code>. The {@link Transformer}
   * or {@link SAXTransformerFactory} creates a reader via {@link
  ...
  /**
   * Set the system identifier for this Source. If an input source has already been set, it will set
   * the system ID or that input source, otherwise it will create a new input source.
   *
   ...
   * URI only if no byte stream or character stream is specified).
   *
