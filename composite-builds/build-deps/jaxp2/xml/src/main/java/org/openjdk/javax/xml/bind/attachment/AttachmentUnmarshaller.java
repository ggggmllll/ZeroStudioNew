 ...
 * to a MIME-based package processor that implements this abstract class.
 *
 ...
 *   <li>For WS-I AP 1.0, the cid is identified as an element or attribute of type {@code
 *       ref:swaRef} specified in <a
 *       href="http://www.ws-i.org/Profiles/AttachmentsProfile-1.0-2004-08-24.html#Referencing_Attachments_from_the_SOAP_Envelope">
...
public abstract class AttachmentUnmarshaller {
   ...
   *
   * <p>The returned {@code DataHandler} instance must be configured to meet the following required
   * mapping constaint.
   *
   * <table class="striped">
   ...
   *
   * @param cid It is expected to be a valid lexical form of the XML Schema {@code xs:anyURI}
   *     datatype. If {@link #isXOPPackage()}{@code ==true}, it must be a valid URI per the {@code
   *     cid:} URI scheme (see <a href="http://www.ietf.org/rfc/rfc2387.txt">RFC 2387</a>)
   ...
   *
   * <p>This method returns {@code true} when the constraints specified in <a
   * href="http://www.w3.org/TR/2005/REC-xop10-20050125/#identifying_xop_documents">Identifying XOP
   * Documents</a> are met. This value must not change during the unmarshalling process.
   *
