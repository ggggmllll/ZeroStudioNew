...
public interface HTMLFrameElement extends HTMLElement {
  ...
  /**
   * The frame name (object of the <code>target</code> attribute). See the name attribute definition
   * in HTML 4.0.
   */
  ...
  /**
   * Specify whether or not the frame should have scrollbars. See the scrolling attribute definition
   * in HTML 4.0.
   */
