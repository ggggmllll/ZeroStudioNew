...
public interface UserDataHandler {
   ...
   * The node is deleted.
   *
   * <p><b>Note:</b> This may not be supported or may not be reliable in certain environments, such
   * as Java, where the implementation has no real control over when objects are actually deleted.
   */
