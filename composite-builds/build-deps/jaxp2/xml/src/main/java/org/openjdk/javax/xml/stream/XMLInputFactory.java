...
public abstract class XMLInputFactory {
  /**
   * The property used to turn on/off namespace support, this is to support XML 1.0 documents, only
   * the true setting must be supported
   */
   ...
   *   <li>Use the properties file "lib/stax.properties" in the JRE directory. This configuration
   *       file is in standard java.util.Properties format and contains the fully qualified name of
   *       the implementation class with the key being the given {@code factoryId}.
   ...
   *       locate and load an implementation of the service using the specified {@code ClassLoader}.
   *       If {@code classLoader} is null, the {@linkplain
   *       java.util.ServiceLoader#load(java.lang.Class) default loading mechanism} will apply: That
   *       is, the service-provider loading facility will use the {@linkplain
   *       java.lang.Thread#getContextClassLoader() current thread's context class loader} to
   *       attempt to load the service. If the context class loader is null, the {@linkplain
   *       ClassLoader#getSystemClassLoader() system class loader} will be used.
   ...
   * classLoader)} method. No changes in behavior are defined by this replacement method relative to
   * the deprecated method.
   *
   * @apiNote The parameter factoryId defined here is inconsistent with that of other JAXP factories
   *     where the first parameter is fully qualified factory class name that provides
  ...
  /**
   * The resolver that will be set on any XMLStreamReader or XMLEventReader created by this factory
   * instance.
   */
  ...
  /**
   * The reporter that will be set on any XMLStreamReader or XMLEventReader created by this factory
   * instance.
   */
