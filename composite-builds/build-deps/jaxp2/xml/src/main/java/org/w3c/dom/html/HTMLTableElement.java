...
public interface HTMLTableElement extends HTMLElement {
   ...
   * TFOOT</code> , all <code>TBODY</code> elements.
   */
  ...
  /**
   * Description about the purpose or structure of a table. See the summary attribute definition in
   * HTML 4.0.
   */
   ...
   * section as the current <code>index</code> th row in the table. If <code>index</code> is equal
   * to the number of rows, the new row is appended. In addition, when the table is empty the row is
   * inserted into a <code>TBODY</code> which is created and inserted into the table. Note. A table
   ...
   * @exception DOMException INDEX_SIZE_ERR: Raised if the specified index is greater than or equal
   *     to the number of rows or if the index is negative.
   */
