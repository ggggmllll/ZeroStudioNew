...
/**
 * The DatatypeConverterInterface is for JAXB provider use only. A JAXB provider must supply a class
 * that implements this interface. JAXB Providers are required to call the {@link
 * DatatypeConverter#setDatatypeConverter(DatatypeConverterInterface)
 * DatatypeConverter.setDatatypeConverter} api at some point before the first marshal or unmarshal
 * operation (perhaps during the call to JAXBContext.newInstance). This step is necessary to
 * configure the converter that should be used to perform the print and parse functionality. Calling
 * this api repeatedly will have no effect - the DatatypeConverter instance passed into the first
 * invocation is the one that will be used from then on.
 *
 * <p>This interface defines the parse and print methods. There is one parse and print method for
 * each XML schema datatype specified in the the default binding Table 5-1 in the JAXB
 * specification.
 *
 * <p>The parse and print methods defined here are invoked by the static parse and print methods
 * defined in the {@link DatatypeConverter DatatypeConverter} class.
 *
 * <p>A parse method for a XML schema datatype must be capable of converting any lexical
 * representation of the XML schema datatype ( specified by the <a
 * href="http://www.w3.org/TR/xmlschema-2/">XML Schema Part2: Datatypes specification</a> into a
 * value in the value space of the XML schema datatype. If an error is encountered during
 * conversion, then an IllegalArgumentException or a subclass of IllegalArgumentException must be
 * thrown by the method.
 *
 * <p>A print method for a XML schema datatype can output any lexical representation that is valid
 * with respect to the XML schema datatype. If an error is encountered during conversion, then an
 * IllegalArgumentException, or a subclass of IllegalArgumentException must be thrown by the method.
 *
 * <p>The prefix xsd: is used to refer to XML schema datatypes <a
 * href="http://www.w3.org/TR/xmlschema-2/">XML Schema Part2: Datatypes specification.</a>
 *
 * @author
 *     <ul>
...
public interface DatatypeConverterInterface {
   ...
   * @throws NumberFormatException {@code lexicalXSDInteger} is not a valid string representation of
   *     a {@link java.math.BigInteger} value.
   */
   ...
   * @throws NumberFormatException {@code lexicalXSDInt} is not a valid string representation of an
   *     {@code int} value.
   */
   ...
   * @throws NumberFormatException {@code lexicalXSDLong} is not a valid string representation of a
   *     {@code long} value.
   */
   ...
   * @throws NumberFormatException {@code lexicalXSDShort} is not a valid string representation of a
   *     {@code short} value.
   */
   ...
   * @throws NumberFormatException {@code lexicalXSDFloat} is not a valid string representation of a
   *     {@code float} value.
   */
   ...
   * @throws NumberFormatException {@code lexicalXSDDouble} is not a valid string representation of
   *     a {@code double} value.
   */
   ...
   *
   * <p>String parameter {@code lexicalXSDQname} must conform to lexical value space specifed at <a
   * href="http://www.w3.org/TR/xmlschema-2/#QName">XML Schema Part 2:Datatypes
   ...
   *     specification or if namespace prefix of {@code lexicalXSDQname} is not bound to a URI in
   *     NamespaceContext {@code nsc}.
   */
  public org.openjdk.javax.xml.namespace.QName parseQName(
      String lexicalXSDQName, org.openjdk.javax.xml.namespace.NamespaceContext nsc);
   ...
   * @throws IllegalArgumentException if {@code val} is null or if {@code nsc} is non-null or {@code
   *     nsc.getPrefix(nsprefixFromVal)} is null.
   */
  public String printQName(
      org.openjdk.javax.xml.namespace.QName val,
