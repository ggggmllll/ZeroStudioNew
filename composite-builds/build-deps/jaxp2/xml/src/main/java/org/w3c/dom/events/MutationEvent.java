...
public interface MutationEvent extends Event {
   ...
   * the <code>relatedNode</code> is the changed parent. If an event is instead dispatched to a
   * subtree indicating a node was changed within it, the <code>relatedNode</code> is the changed
   * node. In the case of the DOMAttrModified event it indicates the <code>Attr</code> node which
   ...
   * DOMAttrModified events, and of the <code>CharacterData</code> node in DOMCharacterDataModified
   * events.
   */
   ...
   * MutationEvent</code> created through the <code>DocumentEvent</code> interface. This method may
   * only be called before the <code>MutationEvent</code> has been dispatched via the <code>
