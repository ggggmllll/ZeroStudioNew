 ...
 * "Element Property" of JAXB 2.0 specification). An element property method signature is of the
 * form:
 *
 * <pre>{@code
 ...
 *       property) is {@link javax.xml.bind.JAXBElement}, then {@code @XmlElementRef.name()} and
 ...
 *       </ul>
 *   <li>If the collection item type (for collection property) or property type (for single valued
 *       property) is not {@link javax.xml.bind.JAXBElement}, then the type referenced by the
...
public @interface XmlElementRef {
   ...
   *
   * <p>For compatibility with JAXB 2.1, this property defaults to {@code true}, despite the fact
   * that {@link XmlElement#required()} defaults to false.
   *
   * @since 1.7, JAXB 2.2
   */
