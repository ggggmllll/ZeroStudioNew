...
class FunctionCall extends Expression {
  ...
  /**
   * inner class to used in internal2Java mappings, contains the Java type and the distance between
   * the internal type and the Java type.
   */
  ...
  static {
    try {
      ...
      _extensionNamespaceTable.put(
          EXSLT_DATETIME, "org.openjdk.com.sun.org.apache.xalan.internal.lib.ExsltDatetime");
      _extensionNamespaceTable.put(
          EXSLT_STRINGS, "org.openjdk.com.sun.org.apache.xalan.internal.lib.ExsltStrings");
  ...
  public void translate(ClassGenerator classGen, MethodGenerator methodGen) {
    ...
    // run-time error message for unsupported external functions
      ...
      if (isSecureProcessing && !isExtensionFunctionEnabled) translateUnallowedExtension(cpg, il);
      ...
      for (int i = 0; i < n; i++) {
        ...
        paramTemp[i] =
            methodGen.addLocalVariable("function_call_tmp" + i, expType.toJCType(), null, null);
