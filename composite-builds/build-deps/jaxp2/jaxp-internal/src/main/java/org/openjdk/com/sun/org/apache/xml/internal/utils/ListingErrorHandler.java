...
public class ListingErrorHandler implements ErrorHandler, ErrorListener {
   ...
   * Receive notification of a warning.
   *
   * <p>{@link org.openjdk.javax.xml.transform.Transformer} can use this method to report conditions
   * that are not errors or fatal errors. The default behaviour is to take no action.
   *
   * <p>After invoking this method, the Transformer must continue with the transformation. It should
   * still be possible for the application to process the document through to the end.
   *
   * @param exception The warning information encapsulated in a transformer exception.
   * @throws org.openjdk.javax.xml.transform.TransformerException only if setThrowOnWarning is true.
   ...
   * method. It should still be possible for the application to process the document through to the
   * end if no other errors are encountered.
   *
   ...
   * <p>The transformer must continue to try and provide normal transformation after invoking this
   * method. It should still be possible for the application to process the document through to the
   * end if no other errors are encountered, but there is no guarantee that the output will be
   * useable.
   *
   * @param exception The error information encapsulated in a transformer exception.
   * @throws org.openjdk.javax.xml.transform.TransformerException only if setThrowOnError is true.
