...
public class XSLTErrorResources_fr extends ListResourceBundle {
  ...
  public Object[][] getContents() {
    return new Object[][] {
      ...
      {ER_NULL_SOURCENODE_APPLYIMPORTS, "La valeur de sourceNode est NULL dans xsl:apply-imports."},
      ...
      {ER_CANT_RESOLVE_NAME_AVT, "Impossible de r\u00E9soudre le nom AVT dans xsl:call-template."},
      ...
      },
      {
        ...
        "\u00E9l\u00E9ment default-space plus pris en charge. Utilisez plut\u00F4t xsl:strip-space"
            + " ou xsl:preserve-space."
      },
      {
      ...
      {
        ER_BAD_XSLSORT_USE,
        "(StylesheetHandler) xsl:sort ne peut \u00EAtre utilis\u00E9 qu'avec xsl:apply-templates ou"
            + " xsl:for-each."
      },
      ...
      },
      {
        ...
        "Extension Redirect : impossible d'obtenir le nom de fichier. L'attribut \"file\" ou"
            + " \"select\" doit renvoyer une cha\u00EEne valide."
      },
      {
        ER_CANNOT_BUILD_FORMATTERLISTENER_IN_REDIRECT,
      ...
      {ER_MISSING_NS_URI, "URI d'espace de noms manquant pour le pr\u00E9fixe sp\u00E9cifi\u00E9"},
      ...
      },
      {
        ...
        "Impossible d'utiliser un \u00E9l\u00E9ment DTMLiaison pour un noeud DOM de sortie..."
            + " Transmettez plut\u00F4t un \u00E9l\u00E9ment"
            + " com.sun.org.apache.xpath.internal.DOM2Helper."
      },
      {
        ER_CANT_USE_DTM_FOR_INPUT,
        "Impossible d'utiliser un \u00E9l\u00E9ment DTMLiaison pour un noeud DOM d'entr\u00E9e..."
            + " Transmettez plut\u00F4t un \u00E9l\u00E9ment"
            + " com.sun.org.apache.xpath.internal.DOM2Helper."
      },
      ...
      {ER_INVALID_UTF16_SURROGATE, "Substitut UTF-16 non valide d\u00E9tect\u00E9 : {0} ?"},
      {
        ...
        "xsl:attribute-set {0} s''est utilis\u00E9 lui-m\u00EAme, ce qui g\u00E9n\u00E8re une"
            + " boucle sans fin."
      },
      {
      ...
      },
      {
        ...
        "Le noeud d'entr\u00E9e ne peut pas \u00EAtre NULL pour un \u00E9l\u00E9ment DOMSource de"
            + " newTemplates."
      },
      ...
      {ER_CANNOT_CREATE_EXTENSN, "Impossible de cr\u00E9er l''extension {0}. Cause : {1}"},
      {
        ...
        "L''appel de la m\u00E9thode d''instance {0} exige une instance d''objet comme premier"
            + " argument"
      },
      ...
      {ER_NO_STYLESHEET_IN_MEDIA, "Aucune feuille de style trouv\u00E9e dans : {0}, support = {1}"},
      {
        ER_NO_STYLESHEET_PI,
      ...
      {ER_COULD_NOT_FIND_EXTERN_SCRIPT, "Impossible d''acc\u00E9der au script externe \u00E0 {0}"},
      ...
      {ER_FAILED_CREATING_ELEMLITRSLT, "Echec de la cr\u00E9ation de l'instance ElemLiteralResult"},
      ...
      {ER_FAILED_CREATING_ELEMTMPL, "Echec de la cr\u00E9ation de l'instance ElemTemplateElement"},
      {
      ...
      {
        ER_NUMBER_TOO_BIG,
        "Tentative de formatage d'un nombre sup\u00E9rieur \u00E0 l'entier de type Long le plus"
            + " grand"
      },
      ...
      {
        INVALID_TCHAR,
        "Valeur non admise {1} utilis\u00E9e pour l''attribut CHAR : {0}. Un attribut de type CHAR"
            + " ne doit \u00EAtre compos\u00E9 que d''un caract\u00E8re."
      },
      ...
      {
        INVALID_ENUM,
        "Valeur non admise {1} utilis\u00E9e pour l''attribut ENUM : {0}. Les valeurs valides sont"
            + " les suivantes : {2}."
      },
      ...
      // of the attribute, and should not be translated.  The substitution text {1} is
      // the attribute value and {0} is the attribute name.
      {INVALID_BOOLEAN, "Valeur non admise {1} utilis\u00E9e pour l''attribut \"boolean\" : {0} "},
      ...
      // an XSLT keyword in this case and must not be translated.
      {
        ...
        "L''\u00E9l\u00E9ment {0} ne doit pas avoir \u00E0 la fois un attribut \"select\" et un"
            + " attribut de contenu."
      },
      ...
      },
      {
        ...
        "L'attribut result-prefix d'un \u00E9l\u00E9ment xsl:namespace-alias a la valeur"
            + " \"#default\", mais il n'existe aucune d\u00E9claration de l'espace de noms par"
            + " d\u00E9faut dans la port\u00E9e pour l'\u00E9l\u00E9ment"
      },
      {
        ER_INVALID_NAMESPACE_URI_VALUE_FOR_RESULT_PREFIX,
        "L''attribut result-prefix d''un \u00E9l\u00E9ment xsl:namespace-alias a la valeur ''{0}'',"
            + " mais il n''existe aucune d\u00E9claration d''espace de noms pour le pr\u00E9fixe"
            + " ''{0}'' dans la port\u00E9e pour l''\u00E9l\u00E9ment."
      },
      {
        ER_SET_FEATURE_NULL_NAME,
        "Le nom de la fonctionnalit\u00E9 ne peut pas \u00EAtre NULL dans"
            + " TransformerFactory.setFeature (cha\u00EEne pour le nom, valeur bool\u00E9enne)."
      },
      {
      ...
      },
      {
        ...
        "Impossible de d\u00E9finir la fonctionnalit\u00E9 ''{0}'' sur cette propri\u00E9t\u00E9"
            + " TransformerFactory."
      },
      {
        ER_EXTENSION_ELEMENT_NOT_ALLOWED_IN_SECURE_PROCESSING,
        "L''utilisation de l''\u00E9l\u00E9ment d''extension ''{0}'' n''est pas autoris\u00E9e"
            + " lorsque la fonctionnalit\u00E9 de traitement s\u00E9curis\u00E9 est d\u00E9finie"
            + " sur True."
      },
      {
        ER_NAMESPACE_CONTEXT_NULL_NAMESPACE,
      ...
      {
        WG_COUNT_ATTRIB_MATCHES_NO_ANCESTOR,
        "Avertissement : l''attribut \"count\" ne correspond pas \u00E0 un anc\u00EAtre dans"
            + " xsl:number ! Cible = {0}"
      },
      {
      ...
      {WG_ENCODING_NOT_SUPPORTED_USING_JAVA, "encodage non pris en charge : {0}, avec Java {1}"},
      {
        ...
        "Conflits de sp\u00E9cificit\u00E9 d\u00E9tect\u00E9s : {0} Les derniers \u00E9l\u00E9ments"
            + " trouv\u00E9s dans la feuille de style seront utilis\u00E9s."
      },
      ...
      {
        WG_XSLDECIMALFORMAT_NAMES_MUST_BE_UNIQUE,
        "Les noms xsl:decimal-format doivent \u00EAtre uniques. Le nom \"{0}\" a \u00E9t\u00E9"
            + " dupliqu\u00E9."
      },
      {WG_ILLEGAL_ATTRIBUTE, "{0} a un attribut non admis : {1}"},
      {
        WG_COULD_NOT_RESOLVE_PREFIX,
        "Impossible de r\u00E9soudre le pr\u00E9fixe d''espace de noms : {0}. Le noeud ne sera pas"
            + " pris en compte."
      },
      ...
      {
        WG_EMPTY_SECOND_ARG,
        "Le jeu de noeuds r\u00E9sultant du deuxi\u00E8me argument de la fonction de document est"
            + " vide. Renvoyez un jeu de noeuds vide."
      },
      ...
      {
        WG_PROCESSINGINSTRUCTION_NAME_CANT_BE_XML,
        "La valeur de l'attribut \"name\" du nom xsl:processing-instruction ne doit pas \u00EAtre"
            + " \"xml\""
      },
      ...
      {
        WG_PROCESSINGINSTRUCTION_NOTVALID_NCNAME,
        "La valeur de l''attribut ''name'' de xsl:processing-instruction doit \u00EAtre un NCName"
            + " valide : {0}"
      },
      ...
      // the attribute.
      {
        ...
        "Impossible d''ajouter l''attribut {0} apr\u00E8s des noeuds enfant ou avant la production"
            + " d''un \u00E9l\u00E9ment. L''attribut est ignor\u00E9."
      },
      {
        NO_MODIFICATION_ALLOWED_ERR,
        "Une tentative de modification d'un objet a \u00E9t\u00E9 effectu\u00E9e alors que les"
      ...
      {
        "optionLF",
        "   [-LF (Utiliser les retours \u00E0 la ligne uniquement en sortie {valeur par d\u00E9faut"
            + " : CR/LF})]"
      },
      {
        "optionCR",
      ...
      {
        "optionINDENT",
        "   [-INDENT (Contr\u00F4ler le nombre d'espaces \u00E0 mettre en retrait {valeur par"
            + " d\u00E9faut : 0})]"
      },
      {
        "optionTT",
      ...
      {
        "optionTTC",
        "   [-TTC (G\u00E9n\u00E9rer une trace des enfants de mod\u00E8le pendant qu'ils sont"
            + " trait\u00E9s.)]"
      },
      {"optionTCLASS", "   [-TCLASS (Classe TraceListener pour les extensions de trace.)]"},
      {
        "optionVALIDATE",
        "   [-VALIDATE (D\u00E9finir si la validation est effectu\u00E9e. Par d\u00E9faut, la"
            + " validation est d\u00E9sactiv\u00E9e.)]"
      },
      {
        "optionEDUMP",
      ...
      {
        "optionURIRESOLVER",
        "   [-URIRESOLVER Nom de classe complet (URIResolver \u00E0 utiliser pour r\u00E9soudre les"
            + " URI)]"
      },
      {
      ...
      {"optionLINENUMBERS", "   [-L Utiliser les num\u00E9ros de ligne pour le document source]"},
      {
        ...
        "   [-SECURE (D\u00E9finir la fonctionnalit\u00E9 de traitement s\u00E9curis\u00E9 sur"
            + " True)]"
      },
      ...
      {
        "optionMEDIA",
        "   [-MEDIA mediaType (Utiliser l'attribut de support pour trouver la feuille de style"
            + " associ\u00E9e \u00E0 un document)]"
      },
      {
        "optionFLAVOR",
        "   [-FLAVOR flavorName (Utiliser explicitement s2s=SAX ou d2d=DOM pour effectuer la"
            + " transformation)] "
      ...
      {
        "optionINCREMENTAL",
        "   [-INCREMENTAL (Demander la construction DTM incr\u00E9mentielle en d\u00E9finissant"
      ...
      {
        "optionXP",
        "   [-XP package (Indique un pr\u00E9fixe de nom de package pour toutes les classes de"
            + " translet g\u00E9n\u00E9r\u00E9es)]"
      },
