...
public class SAXCatalogReader implements CatalogReader, ContentHandler, DocumentHandler {
  ...
  /**
   * Set if something goes horribly wrong. It allows the class to ignore the rest of the events that
   * are received.
   */
   ...
   *
   * <p>This is a bit of a hack. Anyway, whenever we read for a catalog, we extract the debug object
