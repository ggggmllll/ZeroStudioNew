...
public final class ErrorMsg {
  ...
  /**
   * Return an ErrorMessages string corresponding to the _code This function is temporary until the
   * three special-cased keys below are moved into ErrorMessages
   *
