...
abstract class AbstractXMLSchema extends Schema implements XSGrammarPoolContainer {
  ...
  /**
   * Map containing the initial values of properties for validators created using this grammar pool
   * container.
   */
  ...
  /**
   * Returns the initial value of a feature for validators created using this grammar pool container
   * or null if the validators should use the default value.
   */
