...
public class XSElementDecl implements XSElementDeclaration {
   ...
   * attribute with [local name] nil from namespace http://www.w3.org/2001/XMLSchema-instance and
   * value true (see xsi:nil (2.6.2)) even if it has no text or element content despite a {content
  ...
  /**
   * Convenience method. Check if <code>exclusion</code> is a substitution group exclusion for this
   * element declaration.
   *
  ...
  /**
   * Specifies if this declaration can be nominated as the {substitution group affiliation} of other
   * element declarations having the same {type definition} or types derived therefrom.
   *
