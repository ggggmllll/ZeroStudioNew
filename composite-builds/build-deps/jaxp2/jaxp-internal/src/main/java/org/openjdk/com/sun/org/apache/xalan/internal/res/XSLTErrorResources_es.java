...
public class XSLTErrorResources_es extends ListResourceBundle {
  ...
  public Object[][] getContents() {
    return new Object[][] {
      ...
      {
        ER_CANT_RESOLVE_NAME_AVT, "No se ha podido resolver el AVT del nombre en xsl:call-template."
      },
      ...
      {
        ER_IOEXCEPTION, "Ten\u00EDa una excepci\u00F3n de E/S con el archivo de hoja de estilo: {0}"
      },
      ...
      {ER_NO_CLONE_OF_DOCUMENT_FRAG, "No hay ninguna clonaci\u00F3n de un fragmento de documento."},
      ...
      },
      {
        ...
        "default-space ya no est\u00E1 soportado. Utilice xsl:strip-space o xsl:preserve-space en"
            + " su lugar."
      },
      {
      ...
      },
      {
        ...
        "(StylesheetHandler) Las importaciones s\u00F3lo se pueden realizar como los primeros"
            + " elementos en la hoja de estilo."
      },
      {
        ER_IMPORTING_ITSELF,
      ...
      {ER_PROCESSSTYLESHEET_NOT_SUCCESSFUL, "processStylesheet no se ha realizado correctamente."},
      ...
      },
      {
        ...
        "Extensi\u00F3n de redireccionamiento: no se ha podido obtener el nombre de archivo - el"
            + " atributo file o select debe devolver una cadena v\u00E1lida."
      },
      {
        ER_CANNOT_BUILD_FORMATTERLISTENER_IN_REDIRECT,
      ...
      {ER_CANNOT_CREATE_EXTENSN, "No se ha podido crear la extensi\u00F3n: {0} debido a: {1}"},
      {
        ...
        "La llamada del m\u00E9todo de instancia al m\u00E9todo {0} necesita una instancia de"
            + " objeto como primer argumento"
      },
      ...
      {ER_INVALID_CONTEXT_PASSED, "Se ha transferido un contexto no v\u00E1lido para evaluar {0}"},
      ...
      {ER_TWO_OR_THREE, "2 o 3"},
      {
        ...
        "No se ha podido cargar {0} (marcar CLASSPATH), actualmente s\u00F3lo se utilizan los"
            + " valores por defecto"
      },
      ...
      {ER_PROPERTY_VALUE_BOOLEAN, "El valor para la propiedad {0} debe ser una instancia booleana"},
      ...
      {ER_CHARS_NOT_ALLOWED, "En este momento, no se permite el uso de caracteres en el documento"},
      ...
      {
        ER_NONWHITESPACE_NOT_ALLOWED_IN_POSITION,
        "El texto distinto de un espacio en blanco no est\u00E1 permitido en esta posici\u00F3n de"
            + " la hoja de estilo."
      },
      ...
      {
        INVALID_TCHAR,
        "Valor no permitido: {1} utilizado para el atributo CHAR: {0}. Un atributo del tipo CHAR"
            + " debe tener s\u00F3lo 1 car\u00E1cter."
      },
      ...
      {
        INVALID_ENUM,
        "Valor no permitido: {1} utilizado para el atributo ENUM: {0}. Los valores v\u00E1lidos"
            + " son: {2}."
      },
      ...
      {
        ER_INVALID_NAMESPACE_URI_VALUE_FOR_RESULT_PREFIX_FOR_DEFAULT,
        "El atributo result-prefix de un elemento xsl:namespace-alias tiene el valor ''#default',"
            + " pero no hay ninguna declaraci\u00F3n del espacio de nombres por defecto en el"
            + " \u00E1mbito para el elemento"
      },
      {
        ER_INVALID_NAMESPACE_URI_VALUE_FOR_RESULT_PREFIX,
        "El atributo result-prefix de un elemento xsl:namespace-alias tiene el valor ''{0}'', pero"
            + " no hay ninguna declaraci\u00F3n del espacio de nombres para el prefijo ''{0}'' en"
            + " el \u00E1mbito para el elemento."
      },
      {
        ER_SET_FEATURE_NULL_NAME,
        "El nombre de funci\u00F3n no puede ser nulo en TransformerFactory.setFeature (nombre de"
            + " cadena, valor booleano)."
      },
      {
        ER_GET_FEATURE_NULL_NAME,
        "El nombre de funci\u00F3n no puede ser nulo en TransformerFactory.getFeature (nombre de"
            + " cadena)."
      },
      {
      ...
      {
        ER_EXTENSION_ELEMENT_NOT_ALLOWED_IN_SECURE_PROCESSING,
        "La utilizaci\u00F3n del elemento de extensi\u00F3n ''{0}'' no est\u00E1 permitida cuando"
      ...
      {
        WG_COUNT_ATTRIB_MATCHES_NO_ANCESTOR,
        "Advertencia: el atributo count no coincide con un ascendiente en el destino xsl:number! ="
            + " {0}"
      },
      {
      ...
      },
      {
        ...
        "Xalan no maneja a\u00FAn el nombre de configuraci\u00F3n regional en la funci\u00F3n"
            + " format-number."
      },
      {
        WG_LOCALE_NOT_FOUND,
      ...
      },
      {
        ...
        "Se han encontrado conflictos de precisi\u00F3n: {0} Se utilizar\u00E1 la \u00FAltima"
            + " encontrada en la hoja de estilo."
      },
      ...
      {
        WG_EMPTY_SECOND_ARG,
        "El juego de nodos resultante del segundo argumento de la funci\u00F3n del documento"
            + " est\u00E1 vac\u00EDo. Se ha devuelto un juego de nodos vac\u00EDo."
      },
      ...
      // the attribute.
      {
        ...
        "No se puede agregar el atributo {0} despu\u00E9s de nodos secundarios o antes de que se"
            + " produzca un elemento. Se ignorar\u00E1 el atributo."
      },
      {
      ...
      {
        "xslProc_no_input",
        "Error: no se ha especificado ninguna hoja de estilo o XML de entrada. Ejecute este comando"
            + " sin ninguna opci\u00F3n para las instrucciones de uso."
      },
      ...
      {
        "optionLF",
        "   [-LF (Utilizar saltos de l\u00EDnea s\u00F3lo en la salida {el valor por defecto es"
            + " CR/LF})]"
      },
      {
        "optionCR",
        "   [-CR (Utilizar retornos de carro s\u00F3lo en la salida {el valor por defecto es"
            + " CR/LF})]"
      },
      {
        "optionESCAPE",
      ...
      {
        "optionINDENT",
        "   [-INDENT (Control del n\u00FAmero de espacios para el sangrado {el valor por defecto es"
            + " 0})]"
      },
      ...
      {
        "optionVALIDATE",
        "   [-VALIDATE (Determinar si se produce la validaci\u00F3n. La validaci\u00F3n est\u00E1"
      ...
      {
        "optionURIRESOLVER",
        "   [-URIRESOLVER nombre de clase completo (URIResolver se puede utilizar para resolver los"
            + " URI)]"
      },
      {
        "optionENTITYRESOLVER",
        "   [-ENTITYRESOLVER nombre de clase completo (EntityResolver utilizado para resolver"
            + " entidades)]"
      },
      {
        "optionCONTENTHANDLER",
        "   [-CONTENTHANDLER nombre de clase completo (ContentHandler utilizado para serializar la"
            + " salida)]"
      },
      {
        "optionLINENUMBERS",
      ...
      {
        "optionMEDIA",
        "   [-MEDIA mediaType (utilice el atributo media para buscar la hoja de estilo asociada a"
            + " un documento.)]"
      },
      {
        "optionFLAVOR",
        "   [-FLAVOR flavorName (Utilizar expl\u00EDcitamente s2s=SAX o d2d=DOM para realizar la"
            + " transformaci\u00F3n.)] "
      ...
      {
        "optionXJ",
        "   [-XJ jarfile (empaqueta las clases de translet en un archivo jar llamado <archivo"
            + " jar>)]"
      },
      {
        "optionXP",
        "   [-XP package (especifica un prefijo de nombre de paquete para todas las clases de"
            + " translet generadas)]"
      },
