...
public final class ToUnknownStream extends SerializerBase {
  ...
  /**
   * This method cannot be cached because default is different in HTML and XML (we need more than a
   * boolean).
   */
  ...
  /**
   * Initialize the wrapped output stream (XML or HTML). If the stream handler should be HTML, then
   * replace the XML handler with an HTML handler. After than send the starting method calls that
   * were cached to the wrapped handler.
   */
