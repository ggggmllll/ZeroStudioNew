...
public class SerializerMessages_sv extends ListResourceBundle {
  ...
  */
  ...
  public Object[][] getContents() {
    Object[][] contents =
        new Object[][] {
          {MsgKey.BAD_MSGKEY, "Meddelandenyckeln ''{0}'' \u00E4r inte i meddelandeklassen ''{1}''"},
          {
          ...
          },
          {
            ...
            "Varning:  Versionen av utdatadokumentet som beg\u00E4rts \u00E4r ''{0}''.  Den"
                + " h\u00E4r versionen av XML st\u00F6ds inte.  Versionen av utdatadokumentet"
                + " kommer att vara ''1.0''."
          },
