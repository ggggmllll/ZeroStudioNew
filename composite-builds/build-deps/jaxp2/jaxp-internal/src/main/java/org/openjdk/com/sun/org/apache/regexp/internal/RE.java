...
public class RE implements Serializable {
        ...
        case OP_POSIXCLASS:
          {
            ...
            switch (opdata) {
              ...
              case POSIX_CLASS_XDIGIT: // JWL - bugbug??
                {
                  boolean isXDigit =
                      ((search.charAt(idx) >= '0' && search.charAt(idx) <= '9')
   ...
   * string to split of "xyzzyababbayyzabbbab123", the result would be the array of Strings "[xyzzy,
   * yyz, 123]".
   *
   ...
   * $9. A regular expression of "http://[\\.\\w\\-\\?/~_@&=%]+", a String to substituteIn of "visit
   * us: http://www.apache.org!" and the substitution String "&lt;a href=\"$0\"&gt;$0&lt;/a&gt;",
   * the resulting String returned by subst would be "visit us: &lt;a
