...
public class XSLTErrorResources_it extends ListResourceBundle {
  ...
  public Object[][] getContents() {
    return new Object[][] {
      ...
      {ER_NEED_MATCH_ATTRIB, "{0} deve avere un attributo match se dispone di una modalit\u00E0."},
      ...
      {
        ER_MISSING_CONTAINER_ELEMENT_COMPONENT,
        "(StylesheetHandler) posizione errata dell''elemento {0}. Elemento ''component'' del"
      ...
      {
        ER_BAD_XSLSORT_USE,
        "(StylesheetHandler) xsl:sort pu\u00F2 essere utilizzato solo con xsl:apply-templates o"
            + " xsl:for-each."
      },
      ...
      },
      {
        ...
        "(StylesheetHandler) Le importazioni possono essere eseguite solo come primi elementi nel"
            + " foglio di stile."
      },
      {
        ER_IMPORTING_ITSELF,
      ...
      },
      {
        ...
        "Estensione di reindirizzamento: impossibile trovare il nome file. L'attributo file o"
            + " select deve restituire una stringa valida."
      },
      {
        ER_CANNOT_BUILD_FORMATTERLISTENER_IN_REDIRECT,
      ...
      {
        ER_UNKNOWN_ERROR_CALLING_EXTENSION, "Errore sconosciuto durante la chiamata dell'estensione"
      },
      {
        ER_NO_NAMESPACE_DECL,
        "Il prefisso {0} non ha una dichiarazione di spazio di nomi corrispondente"
      },
      {ER_ELEM_CONTENT_NOT_ALLOWED, "Contenuto di elemento non consentito per lang=javaclass {0}"},
      ...
      {
        ER_NUMBER_TOO_BIG,
        "Tentativo di formattare un numero superiore a quello del numero intero di tipo Long"
            + " pi\u00F9 grande"
      },
      ...
      {
        INVALID_TCHAR,
        "Valore non valido {1} utilizzato per l''attributo CHAR {0}. Un attributo di tipo CHAR deve"
            + " avere un solo carattere."
      },
      ...
      {ER_ARG_LITERAL, "L''argomento per {0} nel pattern di corrispondenza deve essere un valore."},
      ...
      {
        ER_INVALID_NAMESPACE_URI_VALUE_FOR_RESULT_PREFIX_FOR_DEFAULT,
        "L'attributo result-prefix di un elemento xsl:namespace-alias ha il valore '#default', ma"
            + " non esiste alcuna dichiarazione dello spazio di nomi predefinito nell'ambito per"
            + " l'elemento."
      },
      {
        ER_INVALID_NAMESPACE_URI_VALUE_FOR_RESULT_PREFIX,
        "L''attributo result-prefix di un elemento xsl:namespace-alias ha il valore ''{0}'', ma non"
            + " esiste alcuna dichiarazione dello spazio di nomi per il prefisso ''{0}''"
            + " nell''ambito per l''elemento."
      },
      {
      ...
      {
        ER_EXTENSION_ELEMENT_NOT_ALLOWED_IN_SECURE_PROCESSING,
        "Non \u00E8 consentito utilizzare l''elemento di estensione ''{0}'' se la funzione di"
            + " elaborazione sicura \u00E8 impostata su true."
      },
      {
        ER_NAMESPACE_CONTEXT_NULL_NAMESPACE,
      ...
      },
      {
        ...
        "Sono stati trovati conflitti di specificit\u00E0: {0}. Verr\u00E0 utilizzato l''ultimo"
      ...
      {
        WG_EMPTY_SECOND_ARG,
        "Il set di nodi risultante dal secondo argomento della funzione di documento \u00E8 vuoto."
            + " Verr\u00E0 restituito un set di nodi vuoto."
      },
      ...
      {
        WG_PROCESSINGINSTRUCTION_NOTVALID_NCNAME,
        "Il valore dell''attributo ''name'' di xsl:processing-instruction deve essere un NCName"
            + " valido: {0}"
      },
      ...
      {
        "xslProc_no_input",
        "Errore: non \u00E8 stato specificato alcun foglio di stile o XML di input. Eseguire questo"
            + " comando senza opzioni per visualizzare le istruzioni sull'uso."
      },
      ...
      {
        "optionVALIDATE",
        "   [-VALIDATE (imposta se viene eseguita la convalida che, per impostazione predefinita,"
            + " \u00E8 disattivata.)]"
      },
      ...
      },
      {
        ...
        "   [-ENTITYRESOLVER nome classe completo (EntityResolver da utilizzare per risolvere le"
            + " entit\u00E0)]"
      },
      {
        "optionCONTENTHANDLER",
        "   [-CONTENTHANDLER nome classe completo (ContentHandler da utilizzare per serializzare"
            + " l'output)]"
      },
      ...
      {
        "optionMEDIA",
        "   [-MEDIA mediaType (utilizza l'attributo media per trovare il foglio di stile associato"
            + " a un documento.)]"
      },
      {
        "optionFLAVOR",
      ...
      {
        "optionNOOPTIMIMIZE",
        "   [-NOOPTIMIMIZE (richiede che non venga elaborata l'ottimizzazione dei fogli di stile"
            + " impostando http://xml.apache.org/xalan/features/optimize su false.)]"
      },
      {
        "optionRL",
        "   [-RL recursionlimit (stabilisce un limite numerico sulla profondit\u00E0 ricorsiva dei"
            + " fogli di stile.)]"
      },
      ...
      {
        "optionXP",
        "   [-XP package (specifica un prefisso nome package per tutte le classi di translet"
            + " generate)]"
      },
