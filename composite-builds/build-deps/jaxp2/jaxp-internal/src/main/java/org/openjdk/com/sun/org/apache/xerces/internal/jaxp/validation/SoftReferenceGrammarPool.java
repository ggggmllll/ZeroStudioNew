...
final class SoftReferenceGrammarPool implements XMLGrammarPool {
  ...
  /**
   * Puts the specified grammar into the grammar pool and associates it to its root element name or
  ...
  /**
   * This class stores a soft reference to a grammar object. It keeps a reference to its associated
   * entry, so that it can be easily removed from the pool.
   */
