  ...
  private static final Object[][] _contents =
      new Object[][] {
        ...
        {ER_CURRENT_TAKES_NO_ARGS, "A fun\u00E7\u00E3o current() n\u00E3o aceita argumentos!"},
        {
          ...
          "a implementa\u00E7\u00E3o da fun\u00E7\u00E3o document() foi substitu\u00EDda por"
        ...
        {ER_UNKNOWN_MATCH_OPERATION, "Opera\u00E7\u00E3o correspondente desconhecida!"},
        {
          ...
          "O tamanho do argumento do teste de n\u00F3 de processing-instruction() est\u00E1"
              + " incorreto!"
        },
        {
        ...
        {ER_PREFIX_MUST_RESOLVE, "O prefixo deve ser resolvido para um namespace: {0}"},
        {
          ...
          "parsing (InputSource source) n\u00E3o suportado em XPathContext! N\u00E3o \u00E9"
              + " poss\u00EDvel abrir {0}"
        },
        ...
        },
        {
          ...
          "Este NodeSetDTM n\u00E3o pode executar as fun\u00E7\u00F5es de indexa\u00E7\u00E3o ou de"
              + " contagem!"
        },
        {
          ER_NODESET_CANNOT_INDEX,
          "Este NodeSet n\u00E3o pode executar as fun\u00E7\u00F5es de indexa\u00E7\u00E3o ou de"
              + " contagem!"
        },
        {
          ER_CANNOT_CALL_SETSHOULDCACHENODE,
          "N\u00E3o \u00E9 poss\u00EDvel chamar setShouldCacheNodes depois de nextNode ter sido"
              + " chamado!"
        },
        ...
        // characters '/' or '//', but was not found.
        {
          ...
          "Esperava-se um caminho de localiza\u00E7\u00E3o relativo, mas o seguinte token foi"
              + " encontrado: '/' ou '//'."
        },
        ...
        // the characters specified by the substitution text were encountered instead.
        {
          ...
          "Esperava-se um caminho de localiza\u00E7\u00E3o, mas o seguinte token foi encontrado: "
              + " {0}"
        },
        ...
        // to a value of type boolean.
        {
          ...
          "O XPathResult da express\u00E3o de XPath ''{0}'' tem um XPathResultType de {1} que"
              + " n\u00E3o pode ser convertido em um booliano."
        },
        ...
        // FIRST_ORDERED_NODE_TYPE.
        {
          ...
          "O XPathResult da express\u00E3o de XPath ''{0}'' tem um XPathResultType de {1} que"
              + " n\u00E3o pode ser convertido em um n\u00F3 simples. O m\u00E9todo"
              + " getSingleNodeValue aplica-se somente aos tipos ANY_UNORDERED_NODE_TYPE e"
              + " FIRST_ORDERED_NODE_TYPE."
        },
        ...
        // ORDERED_NODE_SNAPSHOT_TYPE.
        {
          ...
          "O m\u00E9todo getSnapshotLength n\u00E3o pode ser chamado no XPathResult da"
              + " express\u00E3o XPath ''{0}'' porque seu XPathResultType \u00E9 {1}. Este"
              + " m\u00E9todo se aplica somente a tipos UNORDERED_NODE_SNAPSHOT_TYPE e"
              + " ORDERED_NODE_SNAPSHOT_TYPE."
        },
        {
          ER_NON_ITERATOR_TYPE,
          "O m\u00E9todo iterateNext n\u00E3o pode ser chamado no XPathResult da express\u00E3o"
              + " XPath ''{0}'' porque seu XPathResultType \u00E9 {1}. Este m\u00E9todo se aplica"
              + " somente a tipos UNORDERED_NODE_ITERATOR_TYPE e ORDERED_NODE_ITERATOR_TYPE."
        },
        ...
        {ER_EMPTY_XPATH_RESULT, "Objeto de resultado de XPath vazio"},
        {
          ...
          "O XPathResult da express\u00E3o XPath ''{0}'' tem um XPathResultType {1} que n\u00E3o"
              + " pode estar delimitado no XPathResultType especificado {2}."
        },
        {
          ER_NULL_RESOLVER,
        ...
        // UNORDERED_NODE_SNAPSHOT_TYPE and ORDERED_NODE_SNAPSHOT_TYPE.
        {
          ...
          "O m\u00E9todo snapshotItem n\u00E3o pode ser chamado no XPathResult da express\u00E3o"
              + " XPath ''{0}'' porque seu XPathResultType \u00E9 {1}. Este m\u00E9todo se aplica"
              + " somente a tipos UNORDERED_NODE_SNAPSHOT_TYPE e ORDERED_NODE_SNAPSHOT_TYPE."
        },
        ...
        {
          ER_WRONG_DOCUMENT,
          "O n\u00F3 de contexto n\u00E3o pertence ao documento que est\u00E1 vinculado a este"
              + " XPathEvaluator."
        },
        ...
        {
          ER_EXTENSION_FUNCTION_CANNOT_BE_INVOKED,
          "Fun\u00E7\u00E3o de extens\u00E3o: ''{0}'' n\u00E3o pode ser chamado quando o recurso"
              + " XMLConstants.FEATURE_SECURE_PROCESSING estiver definido como verdadeiro."
        },
...

        {
          ...
          "nome das configura\u00E7\u00F5es regionais na fun\u00E7\u00E3o format-number ainda"
              + " n\u00E3o tratado!"
        },
