...
public class ErrorMessages_es extends ListResourceBundle {
  ...
  public Object[][] getContents() {
    return new Object[][] {
       ...
       */
      {BasisLibrary.RUN_TIME_INTERNAL_ERR, "Error interno de tiempo de ejecuci\u00F3n en ''{0}''"},

      /*
       * Note to translators:  <xsl:copy> is a keyword that should not be
       * translated.
       */
      {BasisLibrary.RUN_TIME_COPY_ERR, "Error de tiempo de ejecuci\u00F3n al ejecutar <xsl:copy>."},
       ...
       */
      {
        ...
        "El translet especificado, ''{0}'' se ha creado con una versi\u00F3n de XSLTC m\u00E1s"
            + " reciente que la versi\u00F3n del tiempo de ejecuci\u00F3n de XSLTC que se est\u00E1"
            + " utilizando. Debe volver a compilar la hoja de estilo o utilizar una versi\u00F3n"
            + " m\u00E1s reciente de XSLTC para ejecutar este translet."
      },
      ...
      },
      {
        ...
        "El uso de la funci\u00F3n de extensi\u00F3n ''{0}'' no est\u00E1 permitido cuando la"
