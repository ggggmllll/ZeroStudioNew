...
public class BitArray implements Externalizable {
  ...
  /**
   * This method returns the Nth bit that is set in the bit array. The current position is cached in
   * the following 4 variables and will help speed up a sequence of next() call in an index
