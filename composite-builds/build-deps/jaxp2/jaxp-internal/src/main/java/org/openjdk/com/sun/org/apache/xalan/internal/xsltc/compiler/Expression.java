...
abstract class Expression extends SyntaxTreeNode {
  ...
  /**
   * Synthesize a boolean expression, i.e., either push a 0 or 1 onto the operand stack for the next
   * statement to succeed. Returns the handle of the instruction to be backpatched.
   */
   ...
   * is returned. The first entry in the vector of primops that has the right arity is considered to
   * be the default one.
   */
