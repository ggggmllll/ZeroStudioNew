...
abstract class MarkerInstruction extends Instruction {
  /**
   * Zero-argument constructor. Sets the opcode to an invalid value and sets the length to zero, as
   * it will not be written as part of the generated byte code.
   */
  ...
  /**
   * Produce a copy of the instruction. By default a {@link MarkerInstruction} has no parameters, so
   * the base implementation of {@link #copy()} returns the instruction itself.
   *
