...
public class SchemaGrammar implements XSGrammar, XSNamespaceItem {
      ...
      if (grammar == GRAMMAR_XS) {
        ...
        type =
            schemaFactory.createTypeList(
                "#AnonType_schemaLocation", SchemaSymbols.URI_XSI, (short) 0, anyURI, null);
  ...
  public static final class Schema4Annotations extends SchemaGrammar {
    ...
    private Schema4Annotations() {
      ...
      // fill in attribute groups
      {
        ...
        // add attribute uses and wildcards to attribute groups for <annotation>, <documentation>
        // and <appinfo>
  ...
  public final void addIDConstraintDecl(
    ...
    fGlobalIDConstraintDeclsExt.put(
        ((location != null) ? location : "") + "," + decl.getIdentityConstraintName(), decl);
  }
  ...
  public final IdentityConstraint getIDConstraintDecl(String declName, String location) {
    return (IdentityConstraint)
        fGlobalIDConstraintDeclsExt.get(((location != null) ? location : "") + "," + declName);
  }
  ...
  /**
   * after the first-round checking, some types don't need to be checked against UPA again. here we
   * trim the array to the proper size.
   */
  ...
  synchronized DOMParser getDOMParser() {
    ...
    try {
      parser.setFeature(
          Constants.XERCES_FEATURE_PREFIX + Constants.DEFER_NODE_EXPANSION_FEATURE, false);
