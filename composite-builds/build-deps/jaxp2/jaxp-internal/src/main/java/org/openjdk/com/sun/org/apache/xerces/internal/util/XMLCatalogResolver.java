...
public class XMLCatalogResolver implements XMLEntityResolver, EntityResolver2, LSResourceResolver {
   ...
   * absence of any occurence of the <code>prefer</code> attribute on the <code>catalog</code> entry
   * of a catalog. If this property has not yet been explicitly set its value is <code>true</code>.
   *
   ...
   *
   * <p>The literal system identifier is the URI as it was provided before absolutization. It may be
