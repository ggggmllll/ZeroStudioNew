...
public class TemplatesHandlerImpl implements ContentHandler, TemplatesHandler, SourceLoader {
  ...
  protected TemplatesHandlerImpl(int indentNumber, TransformerFactoryImpl tfactory) {
    ...
    xsltc.setProperty(
        XalanConstants.SECURITY_MANAGER, tfactory.getAttribute(XalanConstants.SECURITY_MANAGER));
    ...
    try {
      ...
      if (!_parser.errorsFound()) {
        ...
        throw new SAXException(
            ErrorMsg.JAXP_COMPILE_ERR, new TransformerException(errorMessage.toString()));
      }
