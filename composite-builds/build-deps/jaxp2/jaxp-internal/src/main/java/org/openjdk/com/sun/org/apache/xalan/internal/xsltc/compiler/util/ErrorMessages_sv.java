...
public class ErrorMessages_sv extends ListResourceBundle {
  ...
  public Object[][] getContents() {
    return new Object[][] {
      {ErrorMsg.MULTIPLE_STYLESHEET_ERR, "Fler \u00E4n en formatmall har definierats i samma fil."},
       ...
       */
      {ErrorMsg.NEED_LITERAL_ERR, "Argument till ''{0}'' m\u00E5ste vara en litteral str\u00E4ng."},
       ...
       */
      {
        ...
        "Resultattr\u00E4dfragment kan inte sorteras (<xsl:sort>-element ignoreras). Du m\u00E5ste"
            + " sortera noderna n\u00E4r resultattr\u00E4det skapas."
      },
       ...
       */
      {
        ...
        "Kunde inte l\u00E4sa formatmallen ''{0}'', eftersom ''{1}''-\u00E5tkomst inte till\u00E5ts"
            + " p\u00E5 grund av begr\u00E4nsning som anges av egenskapen accessExternalStylesheet."
      },
       ...
       * Note to translators:  ???
       */
      {ErrorMsg.UNKNOWN_SIG_TYPE_ERR, "Ok\u00E4nd datatyp i signaturen f\u00F6r klassen ''{0}''."},
      ...
      {ErrorMsg.COMPILE_STDIN_ERR, "Alternativet -i m\u00E5ste anv\u00E4ndas med alternativet -o."},
       ...
       */
      {
        ...
        "Det f\u00F6rsta argumentet f\u00F6r den icke-statiska Java-funktionen ''{0}'' \u00E4r inte"
            + " n\u00E5gon giltig objektreferens."
      },
       ...
       */
      {
        ...
        "''{0}'' kunde inte anv\u00E4ndas som namn p\u00E5 transletklassen eftersom det"
            + " inneh\u00E5ller otill\u00E5tna tecken f\u00F6r Java-klassnamn. Namnet ''{1}''"
            + " anv\u00E4ndes ist\u00E4llet."
      },
       ...
       */
      {
        ...
        "Ett attribut vars v\u00E4rde m\u00E5ste vara ett QName eller en blankteckenavgr\u00E4nsad"
            + " lista med QNames hade v\u00E4rdet ''{0}''"
      },
       ...
       */
      {
        ...
        "Metodattributet f\u00F6r ett <xsl:output>-element hade v\u00E4rdet ''{0}''. Endast"
            + " n\u00E5got av f\u00F6ljande v\u00E4rden kan anv\u00E4ndas: ''xml'', ''html'',"
            + " ''text'' eller qname-but-not-ncname i XML"
      },
      {
       ...
       */
      {
        ...
        "Internt XSLTC-fel: den genererade bytekoden inneh\u00E5ller ett try-catch-finally-block"
            + " och kan inte g\u00F6ras till en disposition."
      },
       ...
       */
      {
        ...
        "Internt XSLTC-fel: originalmetoden refererar fortfarande till en instruktion som var en"
            + " del av ett bytekodsblock som gjordes till en disposition."
      },
       ...
       */
      {
        ...
        "Internt XSLTC-fel: en metod i transleten \u00F6verstiger Java Virtual Machines"
            + " l\u00E4ngdbegr\u00E4nsning f\u00F6r en metod p\u00E5 64 kilobytes.  Det h\u00E4r"
            + " orsakas vanligen av mycket stora mallar i en formatmall. F\u00F6rs\u00F6k att"
            + " omstrukturera formatmallen att anv\u00E4nda mindre mallar."
      },
      {
        ErrorMsg.DESERIALIZE_TRANSLET_ERR,
        "N\u00E4r Java-s\u00E4kerheten \u00E4r aktiverad \u00E4r st\u00F6det f\u00F6r"
            + " avserialisering av TemplatesImpl avaktiverat. Du kan \u00E5sidos\u00E4tta det"
            + " h\u00E4r genom att st\u00E4lla in systemegenskapen"
