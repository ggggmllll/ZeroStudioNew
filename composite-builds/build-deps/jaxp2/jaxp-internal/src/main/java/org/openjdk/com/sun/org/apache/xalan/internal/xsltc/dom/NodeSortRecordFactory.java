...
public class NodeSortRecordFactory {
  ...
  public NodeSortRecordFactory(
    ...
    try {
      ...
      _sortSettings =
          new SortSettings(
              (AbstractTranslet) translet, iOrder, iType, locales, collators, caseOrder);
  ...
  /**
   * Create an instance of a sub-class of NodeSortRecord. The name of this sub-class is passed to us
   * in the constructor.
   */
