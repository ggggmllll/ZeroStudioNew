...
final class SymbolTable {
  ...
  /**
   * This is used for xsl:attribute elements that have a "namespace" attribute that is currently not
   * defined using xmlns:
   */
  ...
  /**
   * Exclusion of namespaces by a stylesheet does not extend to any stylesheet imported or included
   * by the stylesheet. Upon entering the context of a new stylesheet, a call to this method is
   * needed to clear the current set of excluded namespaces temporarily. Every call to this method
   * requires a corresponding call to {@link #popExcludedNamespacesContext()}.
   */
  ...
  /**
   * Exclusion of namespaces by a stylesheet does not extend to any stylesheet imported or included
   * by the stylesheet. Upon exiting the context of a stylesheet, a call to this method is needed to
   * restore the set of excluded namespaces that was in effect prior to entering the context of the
   * current stylesheet.
   */
