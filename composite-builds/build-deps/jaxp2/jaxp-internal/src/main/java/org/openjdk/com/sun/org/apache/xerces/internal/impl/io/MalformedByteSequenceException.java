...
public class MalformedByteSequenceException extends CharConversionException {
  ...
  /**
   * Constructs a MalformedByteSequenceException with the given parameters which may be passed to an
   * error reporter to generate a localized string for this exception.
   *
  ...
  public MalformedByteSequenceException(
      MessageFormatter formatter, Locale locale, String domain, String key, Object[] arguments) {
