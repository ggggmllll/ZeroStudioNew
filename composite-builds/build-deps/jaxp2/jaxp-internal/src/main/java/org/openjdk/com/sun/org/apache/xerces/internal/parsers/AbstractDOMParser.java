...
public class AbstractDOMParser extends AbstractXMLDocumentParser {
  ...
  /**
   * This method allows the programmer to decide which document factory to use when constructing the
   * DOM tree. However, doing so will lose the functionality of the default factory. Also, a
   * document class other than the default will lose the ability to defer node expansion on the DOM
   * tree produced.
   *
  ...
  public void doctypeDecl(String rootElement, String publicId, String systemId, Augmentations augs)
    ...
    if (!fDeferNodeExpansion) {
      ...
      fDocumentTypeIndex =
          fDeferredDocumentImpl.createDeferredDocumentType(rootElement, publicId, systemId);
  ...
  public void endDTD(Augmentations augs) throws XNIException {
    ...
    String internalSubset =
        fInternalSubset != null && fInternalSubset.length() > 0 ? fInternalSubset.toString() : null;
    if (fDeferNodeExpansion) {
  ...
  protected Attr createAttrNode(QName attrQName) {
    ...
    if (fNamespaceAware) {
      if (fDocumentImpl != null) {
        ...
        // own constructor to reuse the strings we have here.
        attr =
            fDocumentImpl.createAttributeNS(attrQName.uri, attrQName.rawname, attrQName.localpart);
      } else {
