...
final class Predicate extends Expression implements Closure {
  ...
  /**
   * This flag indicates if optimizations are turned on. The method <code>dontOptimize()</code> can
   * be called to turn optimizations off.
   */
  ...
  /**
   * Returns a boolean value indicating if the nth descendant optimization is on. Must be call after
   * type checking!
   */
   ...
   * like '/foo/bar[@attr = $var]', which are very common in many stylesheets
   */
