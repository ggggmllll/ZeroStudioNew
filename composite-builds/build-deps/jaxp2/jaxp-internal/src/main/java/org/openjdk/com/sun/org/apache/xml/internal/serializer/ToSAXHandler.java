...
public abstract class ToSAXHandler extends SerializerBase {
   ...
   * attribute xmlns:prefix1="uri1" to be effectively added to the attributes passed to the wrapped
   * ContentHandler.
   */
  ...
  /**
   * Returns true if namespace declarations from calls such as startPrefixMapping("prefix1","uri1")
   * should also be mirrored with self generated additional attributes of elements that declare the
   * namespace, for example the attribute xmlns:prefix1="uri1"
   */
