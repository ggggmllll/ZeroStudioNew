...
public class REDebugCompiler extends RECompiler {
   ...
   *     " " + insertAt ); PrintWriter writer = new PrintWriter( System.out ); dumpProgram( writer
   *     ); super.nodeInsert( opcode, opdata, insertAt ); System.out.println( "====< " );
   ...
   * @param pointTo Node to have the tail of the chain point to * / void setNextOfEnd(int node, int
   *     pointTo) { System.out.println( "====> " + node + " " + pointTo ); PrintWriter writer = new
   *     PrintWriter( System.out ); dumpProgram( writer ); super.setNextOfEnd( node, pointTo );
