...
public class NodeSet implements NodeList, NodeIterator, Cloneable, ContextNodeList {
   ...
   * @throws DOMException INVALID_STATE_ERR: Raised if this method is called after the <code>detach
   *     </code> method was invoked.
   */
  ...
  public int addNodeInDocOrder(Node node, boolean test, XPathContext support) {
    ...
    if (!m_mutable)
      throw new RuntimeException(
          XSLMessages.createXPATHMessage(
              XPATHErrorResources.ER_NODESET_NOT_MUTABLE,
              null)); // XSLMessages.createXPATHMessage(XPATHErrorResources.ER_NODESET_NOT_MUTABLE,
    // null)); //"This NodeSet is not mutable!");
