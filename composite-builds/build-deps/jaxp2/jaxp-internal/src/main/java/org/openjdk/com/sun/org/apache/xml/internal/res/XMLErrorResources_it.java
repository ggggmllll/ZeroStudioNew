...
public class XMLErrorResources_it extends ListResourceBundle {
  ...
  private static final Object[][] contents = {
    ...
    {
      ER_INCRSAXSRCFILTER_NOT_RESTARTABLE, "IncrementalSAXSource_Filter attualmente non riavviabile"
    },
    ...
    },
    {
      ...
      "Tentativo di eseguire l''output di un carattere di valore integrale {0} non rappresentato"
          + " nella codifica di output {1} specificata."
    },
    {
      ER_COULD_NOT_LOAD_METHOD_PROPERTY,
      "Impossibile caricare il file delle propriet\u00E0 ''{0}'' per il metodo di emissione ''{1}''"
