        ...
        XMLReader // SAX1, SAX2
{
  ...
  /**
   * True if a parse is in progress. This state is needed because some features/properties cannot be
   * set while parsing (e.g. validation and namespaces).
   */
   ...
   *
   * <p><strong>Note:</strong> Since the document is an entity, the handler will be notified of the
   * start of the document entity by calling the startEntity method with the entity name "[xml]"
   * <em>before</em> calling the startDocument method. When exposing entity boundaries through the
   ...
   *
   * <p><strong>Note:</strong> Since the document is an entity, the handler will be notified of the
   * end of the document entity by calling the endEntity method with the entity name "[xml]"
   * <em>after</em> calling the endDocument method. When exposing entity boundaries through the SAX
      ...
      if (fUseEntityResolver2 && resolver instanceof EntityResolver2) {
        if (xer instanceof EntityResolver2Wrapper) {
          ...
          fConfiguration.setProperty(
              ENTITY_RESOLVER, new EntityResolver2Wrapper((EntityResolver2) resolver));
        }
      } else {
      ...
      if (featureId.startsWith(Constants.SAX_FEATURE_PREFIX)) {
          ...
          if (!state) {
            throw new SAXNotSupportedException(
                SAXMessageFormatter.formatMessage(
                    fConfiguration.getLocale(), "false-not-supported", new Object[] {featureId}));
          }
          return;
        }
        ...
        if (suffixLength == Constants.UNICODE_NORMALIZATION_CHECKING_FEATURE.length()
          ...
          if (state) {
            throw new SAXNotSupportedException(
                SAXMessageFormatter.formatMessage(
                    fConfiguration.getLocale(), "true-not-supported", new Object[] {featureId}));
          }
          return;
        }
        ...
        if ((suffixLength == Constants.IS_STANDALONE_FEATURE.length()
          ...
          throw new SAXNotSupportedException(
              SAXMessageFormatter.formatMessage(
                  fConfiguration.getLocale(), "feature-read-only", new Object[] {featureId}));
        }
    ...
    try {
      ...
      if (propertyId.startsWith(Constants.SAX_PROPERTY_PREFIX)) {
        ...
        if ((suffixLength == Constants.DOM_NODE_PROPERTY.length()
          ...
          throw new SAXNotSupportedException(
              SAXMessageFormatter.formatMessage(
                  fConfiguration.getLocale(), "property-read-only", new Object[] {propertyId}));
        }
        //
        // Drop through and perform default processing
        //
  ...
  public AttributePSVI getAttributePSVI(int index) {
    ...
    return (AttributePSVI)
        fAttributesProxy.fAttributes.getAugmentations(index).getItem(Constants.ATTRIBUTE_PSVI);
  }
