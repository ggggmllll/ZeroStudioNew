...
public final class XPointerHandler extends XIncludeHandler implements XPointerProcessor {
  ...
  private final class Tokens {
    ...
    /**
     * XPointer Framework tokens [1] Pointer ::= Shorthand | SchemeBased [2] Shorthand ::= NCName
     * [3] SchemeBased ::= PointerPart (S? PointerPart)* [4] PointerPart ::= SchemeName '('
     * SchemeData ')' [5] SchemeName ::= QName [6] SchemeData ::= EscapedData* [7] EscapedData ::=
     * NormalChar | '^(' | '^)' | '^^' | '(' SchemeData ')' [8] NormalChar ::= UnicodeChar - [()^]
  ...
  private class Scanner {
    ...
    private final byte[] fASCIICharMap = {
      ...
      0, 2, 1, 1, 1, 1, 1, 1, 1, 4, 5, 1, 1, 1, 6, 7, 8, 9, 9, 9, 9, 9, 9, 9, 9, 9, 9, 10, 1, 1, 11,
      1, 1, 1, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12,
      12, 12, 12, 12, 12, 1, 1, 1, 3, 13, 1, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12,
     ...
     * '^)' | '^^' | '(' SchemeData ')' [8] NormalChar ::= UnicodeChar - [()^] [9] UnicodeChar ::=
     * [#x0-#x10FFFF]
     */
