...
public class ErrorMessages_it extends ListResourceBundle {
  ...
  public Object[][] getContents() {
    return new Object[][] {
       ...
       */
      {
        BasisLibrary.TYPED_AXIS_SUPPORT_ERR, "Iteratore per l''asse immesso ''{0}'' non supportato."
      },
       ...
       */
      {
        ...
        "Il translet specificato ''{0}'' \u00E8 stato creato utilizzando una versione di XSLTC"
            + " pi\u00F9 recente di quella della fase di esecuzione XSLTC in uso. Ricompilare il"
            + " foglio di stile o utilizzare una versione pi\u00F9 recente di XSLTC per eseguire"
            + " questo translet."
      },
      ...
      },
      {
        ...
        "Non \u00E8 consentito utilizzare la funzione di estensione ''{0}'' se la funzione di"
