...
final class StreamValidatorHelper implements ValidatorHelper {
              ...
              fComponentManager.getFeature(Constants.ORACLE_FEATURE_SERVICE_MECHANISM)
                  ...
                  : (SAXTransformerFactory)
                      TransformerFactory.newInstance(
                          DEFAULT_TRANSFORMER_IMPL, StreamValidatorHelper.class.getClassLoader());
  ...
  private XMLParserConfiguration initialize() {
    ...
    config.setProperty(
        Constants.SECURITY_MANAGER, fComponentManager.getProperty(Constants.SECURITY_MANAGER));
