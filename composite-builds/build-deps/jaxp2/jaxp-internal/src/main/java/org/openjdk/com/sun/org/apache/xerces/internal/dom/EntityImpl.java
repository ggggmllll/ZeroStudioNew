...
public class EntityImpl extends ParentNode implements Entity {
  ...
  /**
   * DOM Level 3 WD - experimental the version number of this entity, when it is an external parsed
   * entity.
   */
  ...
  /**
   * NON-DOM version - An attribute specifying, as part of the text declaration, the version number
