...
public class FuncExtFunctionAvailable extends FunctionOneArg {
   ...
   * evaluation, this method is called at compilation time to insert function table information for
   * later usage. It should only be used during compiling of XPath expressions.
   *
