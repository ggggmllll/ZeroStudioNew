...
public final class Constants {
  ...
  //
  /**
   * JDK entity expansion limit; Note that the existing system property "entityExpansionLimit" with
   * no prefix is still observed
   */
  ...
  /**
   * Boolean indicating whether an attribute is declared in the DTD is stored in augmentations using
   * the string "ATTRIBUTE_DECLARED". The absence of this augmentation indicates that the attribute
   * was not declared in the DTD.
   */
  ...
  /**
   * Boolean indicating whether an entity referenced in the document has not been read is stored in
   * augmentations using the string "ENTITY_SKIPPED". The absence of this augmentation indicates
   * that the entity had a declaration and was expanded.
   */
