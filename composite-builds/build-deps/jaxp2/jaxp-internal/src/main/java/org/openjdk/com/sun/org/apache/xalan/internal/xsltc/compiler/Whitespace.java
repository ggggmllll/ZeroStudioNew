  ...
  */
  ...
  private static void compilePredicate(Vector rules, int defaultAction, ClassGenerator classGen) {
    ...
    for (int i = 0; i < rules.size(); i++) {
      ...
      final int gns =
          cpg.addInterfaceMethodref(DOM_INTF, "getNamespaceName", "(I)Ljava/lang/String;");
  ...
  /**
   * Takes a vector of WhitespaceRule objects and generates a predicate method. This method returns
   * the translets default action for handling whitespace text-nodes: - USE_PREDICATE (run the
   * method generated by this method) - STRIP_SPACE (always strip whitespace text-nodes) -
