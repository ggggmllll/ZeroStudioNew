...
final class ApplyImports extends Instruction {
   ...
   * stylesheet in which this <xsl:apply-imports/> element occured. The templates that are imported
   * by the stylesheet in which this element occured will all have higher import precedence than the
   * integer returned by this method.
   */
