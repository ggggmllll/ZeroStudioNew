...
public class KeyIndex extends DTMAxisIteratorBase {
  ...
  /**
   * An iterator representing the result of a reference to either the XSLT <code>key</code> function
   * or the XPath <code>id</code> function.
   */
  public class KeyIndexIterator extends MultiValuedNodeHeapIterator {

    /**
     * A reference to the <code>key</code> function that only has one key value or to the <code>id
     * </code> function that has only one string argument can be optimized to ignore the
     * multi-valued heap. This field will be <code>null</code> otherwise.
     */
    private IntegerArray _nodes;

    /**
     * This field contains the iterator representing a node set key value argument to the <code>key
     * </code> function or a node set argument to the <code>id</code> function.
     *
    ...
    /**
     * This field contains the iterator representing a non-node-set key value argument to the <code>
     * key</code> function or a non-node-set argument to the <code>id</code> function.
     *
    ...
    /**
     * Indicates whether this object represents the result of a reference to the <code>key</code>
     * function (<code>true</code>) or the <code>id</code> function (<code>false</code>).
     */
    ...
    protected class KeyIndexHeapNode extends MultiValuedNodeHeapIterator.HeapNode {
      /**
       * {@link IntegerArray} of DTM nodes retrieved for one key value. Must contain no duplicates
       * and be stored in document order.
       */
      private IntegerArray _nodes;
      ...
      /**
       * Create a heap node representing DTM nodes retrieved for one key value in a reference to the
       * <code>key</code> function or string argument to the <code>id</code> function.
       */
       ...
       * KeyIndexIterator#setStartNode(int)} method should create new instances of this class to
       * represent the effect of changing the context.
       */
    ...
    /**
     * Constructor used when the argument to <code>key</code> or <code>id</code> is not a node set.
     *
     * @param keyValue the argument to <code>key</code> or <code>id</code> cast to a <code>String
     *     </code>
