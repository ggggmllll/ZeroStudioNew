...
public class Resolver extends Catalog {
   ...
   *
   * <p>This is a bit of a hack. There's no actual SYSTEMREVERSE entry, but this entry type is used
   * to indicate that a reverse lookup is being performed. (This allows the Resolver to implement
   ...
   *
   * <p>If one or more SYSTEM entries exists in the Catalog for the system ID specified, return the
   * mapped values.
   *
   ...
   *
   * <p>If one or more SYSTEM entries exists in the catalog file for the system ID specified, return
   * the mapped values.
   *
   * @param systemId The system ID to locate in the catalog
   ...
   *
   * <p>This method searches the Catalog and returns all of the system identifiers specified for the
   * given entity type with the given name, public, and system identifiers. In some contexts, these
   * may be null.
   *
