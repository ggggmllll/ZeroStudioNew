...
public class TreeWalkerImpl implements TreeWalker {
  ...
  /**
   * Return the first child Node from the current node, after applying filter, whatToshow. If result
  ...
  /**
   * Return the last child Node from the current node, after applying filter, whatToshow. If result
   * is not null, set the current Node.
   */
  ...
  /**
   * Return the previous Node from the current node, after applying filter, whatToshow. If result is
   * not null, set the current Node.
   */
  ...
  /**
   * Return the next Node from the current node, after applying filter, whatToshow. If result is not
   * null, set the current Node.
   */
  ...
  /**
   * Internal function. Return the previous sibling Node, from the input node after applying filter,
   * whatToshow. The current node is not consulted or set.
   */
