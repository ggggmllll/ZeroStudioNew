...
public class XSLTErrorResources_zh_CN extends ListResourceBundle {
  ...
  public Object[][] getContents() {
    return new Object[][] {
      ...
      {
        ER_XMLSPACE_ILLEGAL_VAL, "(StylesheetHandler) xml:space \u5177\u6709\u975E\u6CD5\u503C: {0}"
      },
      ...
      },
      {
        ...
        "\u65E0\u6CD5\u5C06 DTMLiaison \u7528\u4E8E\u8F93\u51FA DOM \u8282\u70B9..."
            + " \u8BF7\u6539\u4E3A\u4F20\u9012 com.sun.org.apache.xpath.internal.DOM2Helper!"
      },
      {
      ...
      {ER_CANNOT_INIT_DEFAULT_TEMPLATES, "\u65E0\u6CD5\u521D\u59CB\u5316\u9ED8\u8BA4\u6A21\u677F"},
      ...
      {ER_OUTPUT_PROPERTY_NOT_RECOGNIZED, "\u65E0\u6CD5\u8BC6\u522B\u8F93\u51FA\u5C5E\u6027: {0}"},
      ...
      {
        ER_PARSER_ARG_CANNOT_BE_NULL, "\u89E3\u6790\u5668\u53C2\u6570\u4E0D\u80FD\u4E3A\u7A7A\u503C"
      },
      {ER_FEATURE, "\u529F\u80FD: {0}"},
      {ER_PROPERTY, "\u5C5E\u6027: {0}"},
      ...
      {
        ER_INVALID_NAMESPACE_URI_VALUE_FOR_RESULT_PREFIX_FOR_DEFAULT,
        "xsl:namespace-alias \u5143\u7D20\u7684 result-prefix \u5C5E\u6027\u5177\u6709\u503C"
            + " '#default',"
      ...
      {
        ER_XPATH_RESOLVER_NULL_QNAME, "\u51FD\u6570\u540D\u79F0\u4E0D\u80FD\u4E3A\u7A7A\u503C\u3002"
      },
      ...
      {WG_CANNOT_LOAD_REQUESTED_DOC, "\u65E0\u6CD5\u52A0\u8F7D\u8BF7\u6C42\u7684\u6587\u6863: {0}"},
      ...
      {
        "optionINCREMENTAL",
        "   [-INCREMENTAL (\u901A\u8FC7\u5C06 http://xml.apache.org/xalan/features/incremental"
            + " \u8BBE\u7F6E\u4E3A\u201C\u771F\u201D\u6765\u8BF7\u6C42\u589E\u91CF DTM"
            + " \u6784\u5EFA\u3002)]"
      },
      {
        "optionNOOPTIMIMIZE",
        "   [-NOOPTIMIMIZE (\u901A\u8FC7\u5C06 http://xml.apache.org/xalan/features/optimize"
            + " \u8BBE\u7F6E\u4E3A\u201C\u5047\u201D\u6765\u8BF7\u6C42\u4E0D\u6267\u884C\u6837\u5F0F\u8868\u4F18\u5316\u5904\u7406\u3002)]"
      },
      {
        "optionRL",
      ...
      {
        "optionXJ",
        "   [-XJ jarfile (\u5C06 translet \u7C7B\u6253\u5305\u5230\u540D\u4E3A <jarfile> \u7684 jar"
            + " \u6587\u4EF6\u4E2D)]"
      },
      {
        "optionXP",
