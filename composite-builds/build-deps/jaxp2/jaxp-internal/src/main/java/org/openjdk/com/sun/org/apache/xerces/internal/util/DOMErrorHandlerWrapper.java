...
public class DOMErrorHandlerWrapper implements XMLErrorHandler, DOMErrorHandler {
  ...
  private static class DOMErrorTypeMap {
    ...
    static {
      // initialize error type table: internal error codes (represented by domain and key) need to
      // be mapped to a DOM error type.

      // REVISIT: do well-formedness issues involving XML declaration <?xml ... ?> need to be added
      // to hash table (no XML declaration node in DOM, but Document includes xmlEncoding,
      // xmlStandalone, xmlVersion, etc.
      ...
      fgDOMErrorTypeTable.put(
          ...
          "wf-invalid-character-in-node-name");
      fgDOMErrorTypeTable.put(
          new XMLErrorCode(XMLMessageFormatter.XML_DOMAIN, "MarkupNotRecognizedInContent"),
          "wf-invalid-character");
      fgDOMErrorTypeTable.put(
      ...
      fgDOMErrorTypeTable.put(
          new XMLErrorCode(XMLMessageFormatter.XML_DOMAIN, "EncodingByteOrderUnsupported"),
          "unsupported-encoding");
      fgDOMErrorTypeTable.put(
      ...
      fgDOMErrorTypeTable.put(
          ...
          "wf-invalid-character-in-node-name"); // considered error in name of node (which follows
      // !DOCTYPE)
      fgDOMErrorTypeTable.put(
          new XMLErrorCode(XMLMessageFormatter.XML_DOMAIN, "MSG_ROOT_ELEMENT_TYPE_REQUIRED"),
          "wf-invalid-character-in-node-name");
      fgDOMErrorTypeTable.put(
      ...
      fgDOMErrorTypeTable.put(
          ...
          "wf-invalid-character");
      fgDOMErrorTypeTable.put(
          new XMLErrorCode(XMLMessageFormatter.XML_DOMAIN, "MSG_MARKUP_NOT_RECOGNIZED_IN_DTD"),
          "wf-invalid-character");
      fgDOMErrorTypeTable.put(
          new XMLErrorCode(
              XMLMessageFormatter.XML_DOMAIN,
      ...
      fgDOMErrorTypeTable.put(
          new XMLErrorCode(
              XMLMessageFormatter.XML_DOMAIN, "MSG_ELEMENT_TYPE_REQUIRED_IN_ELEMENTDECL"),
          "wf-invalid-character");
      fgDOMErrorTypeTable.put(
          new XMLErrorCode(
              XMLMessageFormatter.XML_DOMAIN,
      ...
      fgDOMErrorTypeTable.put(
          new XMLErrorCode(
              XMLMessageFormatter.XML_DOMAIN, "MSG_CONTENTSPEC_REQUIRED_IN_ELEMENTDECL"),
          "wf-invalid-character");
      fgDOMErrorTypeTable.put(
      ...
      fgDOMErrorTypeTable.put(
          new XMLErrorCode(
              XMLMessageFormatter.XML_DOMAIN, "MSG_ELEMENT_TYPE_REQUIRED_IN_MIXED_CONTENT"),
          "wf-invalid-character");
      fgDOMErrorTypeTable.put(
      ...
      fgDOMErrorTypeTable.put(
          new XMLErrorCode(
              XMLMessageFormatter.XML_DOMAIN, "MSG_SPACE_REQUIRED_BEFORE_ATTRIBUTE_NAME_IN_ATTDEF"),
          "wf-invalid-character");
      fgDOMErrorTypeTable.put(
      ...
      fgDOMErrorTypeTable.put(
          new XMLErrorCode(
              XMLMessageFormatter.XML_DOMAIN, "MSG_SPACE_REQUIRED_BEFORE_ATTTYPE_IN_ATTDEF"),
          "wf-invalid-character");
      fgDOMErrorTypeTable.put(
      ...
      fgDOMErrorTypeTable.put(
          new XMLErrorCode(
              XMLMessageFormatter.XML_DOMAIN, "MSG_SPACE_REQUIRED_AFTER_NOTATION_IN_NOTATIONTYPE"),
          "wf-invalid-character");
      fgDOMErrorTypeTable.put(
          new XMLErrorCode(
      ...
      fgDOMErrorTypeTable.put(
          new XMLErrorCode(
              XMLMessageFormatter.XML_DOMAIN, "MSG_SPACE_REQUIRED_AFTER_FIXED_IN_DEFAULTDECL"),
          "wf-invalid-character");
      fgDOMErrorTypeTable.put(
      ...
      fgDOMErrorTypeTable.put(
          ...
          "wf-invalid-character");
      fgDOMErrorTypeTable.put(
          new XMLErrorCode(XMLMessageFormatter.XML_DOMAIN, "SemicolonRequiredInPEReference"),
          "wf-invalid-character");
      fgDOMErrorTypeTable.put(
          new XMLErrorCode(
              XMLMessageFormatter.XML_DOMAIN,
      ...
      fgDOMErrorTypeTable.put(
          new XMLErrorCode(
              XMLMessageFormatter.XML_DOMAIN, "MSG_SPACE_REQUIRED_BEFORE_PERCENT_IN_PEDECL"),
          "wf-invalid-character-in-node-name"); // considered error in name of node (which follows
      // !ENTITY %)
      fgDOMErrorTypeTable.put(
          new XMLErrorCode(
              XMLMessageFormatter.XML_DOMAIN, "MSG_SPACE_REQUIRED_BEFORE_ENTITY_NAME_IN_PEDECL"),
          "wf-invalid-character-in-node-name"); // considered error in name of node (which follows
      // !ENTITY %)
      fgDOMErrorTypeTable.put(
          new XMLErrorCode(
              XMLMessageFormatter.XML_DOMAIN, "MSG_ENTITY_NAME_REQUIRED_IN_ENTITYDECL"),
          "wf-invalid-character-in-node-name"); // considered error in name of node (which follows
      // !ENTITY)
      fgDOMErrorTypeTable.put(
          new XMLErrorCode(
              XMLMessageFormatter.XML_DOMAIN, "MSG_SPACE_REQUIRED_AFTER_ENTITY_NAME_IN_ENTITYDECL"),
      ...
      fgDOMErrorTypeTable.put(
          new XMLErrorCode(
              XMLMessageFormatter.XML_DOMAIN, "MSG_NOTATION_NAME_REQUIRED_FOR_UNPARSED_ENTITYDECL"),
          "wf-invalid-character");
      fgDOMErrorTypeTable.put(
          new XMLErrorCode(XMLMessageFormatter.XML_DOMAIN, "EntityDeclUnterminated"),
          "wf-invalid-character-in-node-name");
      fgDOMErrorTypeTable.put(
          new XMLErrorCode(XMLMessageFormatter.XML_DOMAIN, "MSG_DUPLICATE_ENTITY_DEFINITION"),
          "wf-invalid-character-in-node-name");
      fgDOMErrorTypeTable.put(
      ...
      fgDOMErrorTypeTable.put(
          ...
          "wf-invalid-character");
      fgDOMErrorTypeTable.put(
          new XMLErrorCode(XMLMessageFormatter.XML_DOMAIN, "MSG_URI_FRAGMENT_IN_SYSTEMID"),
          "wf-invalid-character");
      fgDOMErrorTypeTable.put(
          new XMLErrorCode(
              XMLMessageFormatter.XML_DOMAIN,
      ...
      // !NOTATION
      fgDOMErrorTypeTable.put(
          new XMLErrorCode(XMLMessageFormatter.XML_DOMAIN, "ExternalIDorPublicIDRequired"),
          "wf-invalid-character");
      fgDOMErrorTypeTable.put(
