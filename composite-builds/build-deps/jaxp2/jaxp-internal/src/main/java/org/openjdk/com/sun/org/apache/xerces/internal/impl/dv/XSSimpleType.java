...
public interface XSSimpleType extends XSSimpleTypeDefinition {
  ...
  /**
   * return an ID representing the built-in primitive base type. REVISIT: This method is (currently)
   * for internal use only. the constants returned from this method are not finalized yet. the names
   * and values might change in the further.
   *
   ...
   * @param presentFacet bit combination value of the costraining facet constants which are present.
  ...
  /**
   * Check whether this type is or is derived from ID. REVISIT: this method makes ID special, which
   * is not a good design. but since ID is not a primitive, there doesn't seem to be a clean way of
   * doing it except to define special method like this.
   *
