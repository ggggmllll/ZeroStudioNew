...
public abstract class AbstractTranslet implements Translet {
  ...
  /**
   * This method is used to pass the largest DOM size to the translet. Needed to make sure that the
   * translet can index the whole DOM.
   */
  ...
  /**
   * Returns the DOM cache used for this translet. Used by the LoadDocument class (if present) when
   * the document() function is used.
   */
