...
public interface XMLDTDContentModelHandler {
  ...
  /**
   * This occurrence count limits the element, choice, or sequence in a children content model to
   * zero or more. In other words, the child may appear an arbitrary number of times, or not at all.
   * This occurrence count is also used for mixed content models.
   *
   * <p>For example:
   *
   * <pre>
  ...
  /**
   * This occurrence count limits the element, choice, or sequence in a children content model to
   * one or more. In other words, the child may appear an arbitrary number of times, but must appear
   * at least once.
   *
   * <p>For example:
   *
