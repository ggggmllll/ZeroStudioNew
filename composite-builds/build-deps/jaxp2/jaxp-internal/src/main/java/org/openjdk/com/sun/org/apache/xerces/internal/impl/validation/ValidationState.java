...
public class ValidationState implements ValidationContext {
  ...
  /**
   * return null if all IDREF values have a corresponding ID value; otherwise return the first IDREF
   * value without a matching ID value.
   */
   ...
   * Entity/Namespace/Symbol are shared, but each validation root needs its own id/idref tables. So
   * we need this method to reset only the two tables.
   */
