...
public class RETest {
  ...
  /**
   * Main program entrypoint. If an argument is given, it will be compiled and interactive matching
   * will ensue. If no argument is given, the file RETest.txt will be used as automated testing
   * input.
   *
