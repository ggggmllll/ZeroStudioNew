...
public class ErrorMessages_de extends ListResourceBundle {
  ...
  public Object[][] getContents() {
    return new Object[][] {
       ...
       */
      {
        BasisLibrary.EXTERNAL_FUNC_ERR, "Externe Funktion \"{0}\" nicht unterst\u00FCtzt von XSLTC."
      },
       ...
       */
      {BasisLibrary.FORMAT_NUMBER_ERR, "Versuch, Zahl \"{0}\" mit Muster \"{1}\" zu formatieren."},
       ...
       */
      {
        ...
        "Das angegebene Translet \"{0}\" wurde mit einer neueren Version von XSLTC als die"
            + " verwendete Version der XSLTC-Laufzeit erstellt. Sie m\u00FCssen das Stylesheet neu"
            + " kompilieren oder eine aktuellere Version von XSLTC verwenden, um dieses Translet"
            + " auszuf\u00FChren."
      },
      ...
      },
      {
        ...
        "Verwendung der Erweiterungsfunktion \"{0}\" ist nicht zul\u00E4ssig, wenn das Feature"
