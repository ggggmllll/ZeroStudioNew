...
public class MonthDV extends AbstractDateTimeDV {
   ...
   *
   * <p>REVISIT: this one is lack of the third parameter: boolean strict, so it doesn't override the
   * method in the base. But maybe this method is not correctly implemented, and I did encounter
   * errors when trying to add the extra parameter. I'm leaving it as is. -SG
   *
   * @param date1
   * @param date2
