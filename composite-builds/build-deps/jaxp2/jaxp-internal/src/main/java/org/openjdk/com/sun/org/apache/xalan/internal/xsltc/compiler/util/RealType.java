...
public final class RealType extends NumberType {
  ...
  /**
   * Translates a real into an object of internal type <code>type</code>. The translation to int is
   ...
   * returns branchhandle list to be appended to the false list. A NaN must be converted to "false".
   *
  ...
  /**
   * Translates a real into the Java type denoted by <code>clazz</code>. Expects a real on the stack
   * and pushes a number of the appropriate type after coercion.
   */
