  ...
  private static final Object[][] _contents =
      new Object[][] {
        ...
        {ER_CURRENT_TAKES_NO_ARGS, "La fonction current() n'accepte pas d'argument."},
        {
          ...
          "L'impl\u00E9mentation de la fonction document() a \u00E9t\u00E9 remplac\u00E9e par"
        ...
        {ER_ERROR_OCCURED, "Une erreur est survenue."},
        {
          ...
          "L''\u00E9l\u00E9ment VariableReference indiqu\u00E9 pour la variable est hors contexte"
              + " ou sans d\u00E9finition. Nom = {0}"
        },
        {
          ER_AXES_NOT_ALLOWED,
          "Seuls les axes child:: et attribute:: sont autoris\u00E9s dans des mod\u00E8les de"
              + " recherche. Axes en cause = {0}"
        },
        ...
        {ER_PREFIX_MUST_RESOLVE, "Le pr\u00E9fixe doit produire un espace de noms : {0}"},
        {
          ...
          "analyse (source InputSource) non prise en charge dans XPathContext. Impossible d''ouvrir"
              + " {0}"
        },
        {
        ...
        // the characters specified by the substitution text were encountered instead.
        {
          ...
          "Un chemin d''acc\u00E8s \u00E9tait attendu, mais le jeton suivant a \u00E9t\u00E9"
              + " d\u00E9tect\u00E9 : {0}"
        },
        ...
        // to a value of type boolean.
        {
          ...
          "L''\u00E9l\u00E9ment XPathResult de l''expression XPath ''{0}'' comporte un"
              + " \u00E9l\u00E9ment XPathResultType de {1} qui ne peut pas \u00EAtre converti en"
              + " valeur bool\u00E9enne."
        },
        ...
        // FIRST_ORDERED_NODE_TYPE.
        {
          ...
          "L''\u00E9l\u00E9ment XPathResult de l''expression XPath ''{0}'' comporte un"
              + " \u00E9l\u00E9ment XPathResultType de {1} qui ne peut pas \u00EAtre converti en"
              + " noeud unique. La m\u00E9thode getSingleNodeValue est applicable uniquement aux"
              + " types ANY_UNORDERED_NODE_TYPE et FIRST_ORDERED_NODE_TYPE."
        },
        ...
        // ORDERED_NODE_SNAPSHOT_TYPE.
        {
          ...
          "La m\u00E9thode getSnapshotLength ne peut pas \u00EAtre appel\u00E9e sur"
              ...
              + " \u00E9l\u00E9ment XPathResultType est {1}. Cette m\u00E9thode est applicable"
              + " uniquement aux types UNORDERED_NODE_SNAPSHOT_TYPE et ORDERED_NODE_SNAPSHOT_TYPE."
        },
        {
          ER_NON_ITERATOR_TYPE,
          "La m\u00E9thode iterateNext ne peut pas \u00EAtre appel\u00E9e sur l''\u00E9l\u00E9ment"
              + " XPathResult de l''expression XPath ''{0}'' car son \u00E9l\u00E9ment"
              + " XPathResultType est {1}. Cette m\u00E9thode est applicable uniquement aux types"
              + " UNORDERED_NODE_ITERATOR_TYPE et ORDERED_NODE_ITERATOR_TYPE."
        },
        ...
        {ER_EMPTY_XPATH_RESULT, "Objet de r\u00E9sultat XPath vide"},
        {
          ...
          "L''\u00E9l\u00E9ment XPathResult de l''expression XPath ''{0}'' comporte un"
              + " \u00E9l\u00E9ment XPathResultType de {1} qui ne peut pas \u00EAtre forc\u00E9"
              + " dans l''\u00E9l\u00E9ment XPathResultType de {2} indiqu\u00E9."
        },
        {
          ER_NULL_RESOLVER,
        ...
        // UNORDERED_NODE_SNAPSHOT_TYPE and ORDERED_NODE_SNAPSHOT_TYPE.
        {
          ...
          "La m\u00E9thode snapshotItem ne peut pas \u00EAtre appel\u00E9e sur l''\u00E9l\u00E9ment"
              + " XPathResult de l''expression XPath ''{0}'' car son \u00E9l\u00E9ment"
              + " XPathResultType est {1}. Cette m\u00E9thode est applicable uniquement aux types"
              + " UNORDERED_NODE_SNAPSHOT_TYPE et ORDERED_NODE_SNAPSHOT_TYPE."
        },
        ...
        /** Field ER_EXTENSION_FUNCTION_CANNOT_BE_INVOKED */
        {
          ...
          "La fonction d''extension ''{0}'' ne peut pas \u00EAtre appel\u00E9e lorsque la"
              + " fonctionnalit\u00E9 XMLConstants.FEATURE_SECURE_PROCESSING est d\u00E9finie sur"
              + " True."
        },
        ...
        /** Field ER_OBJECT_MODEL_NULL */
        {
          ...
          "{0}#isObjectModelSupported(String objectModel) ne peut pas \u00EAtre appel\u00E9 avec"
              + " objectModel == null"
        },
        ...
        },
        {
          ...
          "FEATURE_SECURE_PROCESSING : impossible de d\u00E9finir la fonctionnalit\u00E9 sur False"
              + " en pr\u00E9sence du gestionnaire de s\u00E9curit\u00E9 : {1}#setFeature({0},{2})"
        },

        /** Field ER_NULL_XPATH_FUNCTION_RESOLVER */
        {
          ER_NULL_XPATH_FUNCTION_RESOLVER,
          "Tentative de d\u00E9finition d''un \u00E9l\u00E9ment XPathFunctionResolver NULL :"
        ...
        /** Field ER_NULL_XPATH_VARIABLE_RESOLVER */
        {
          ...
          "Tentative de d\u00E9finition d''un \u00E9l\u00E9ment XPathVariableResolver NULL :"
...

        {
          ...
          "le nom d'environnement local de la fonction format-number n'est pas encore pris en"
              + " charge."
        },
        ...
        },
        {
          ...
          "Exception SecurityException g\u00E9n\u00E9r\u00E9e lors de la tentative d''acc\u00E8s"
              + " \u00E0 la propri\u00E9t\u00E9 syst\u00E8me XSL : {0}"
        },
        {
