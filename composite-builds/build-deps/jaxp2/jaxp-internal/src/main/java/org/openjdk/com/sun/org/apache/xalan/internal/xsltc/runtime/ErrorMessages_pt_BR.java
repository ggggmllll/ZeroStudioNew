...
public class ErrorMessages_pt_BR extends ListResourceBundle {
  ...
  public Object[][] getContents() {
    return new Object[][] {
       ...
       */
      {
        BasisLibrary.TYPED_AXIS_SUPPORT_ERR, "Iterador do eixo digitado ''{0}'' n\u00E3o suportado."
      },
       ...
       */
      {BasisLibrary.NAMESPACE_PREFIX_ERR, "O namespace do prefixo ''{0}'' n\u00E3o foi declarado."},
       ...
       */
      {
        ...
        "O parser SAX que voc\u00EA est\u00E1 usando n\u00E3o trata eventos de declara\u00E7\u00E3o"
            + " de DTD."
      },
       ...
       */
      {
        ...
        "O parser SAX que voc\u00EA est\u00E1 usando n\u00E3o tem suporte para os Namespaces de"
            + " XML."
      },
       ...
       */
      {
        ...
        "O translet especificado, ''{0}'', foi criado usando uma vers\u00E3o do XSLTC mais recente"
            + " que a vers\u00E3o de runtime de XSLTC em uso. Recompile a folha de estilos ou use"
            + " uma vers\u00E3o mais recente de XSLTC para executar este translet."
      },
      ...
      },
      {
        ...
        "O uso da fun\u00E7\u00E3o da extens\u00E3o ''{0}'' n\u00E3o ser\u00E1 permitido quando o"
