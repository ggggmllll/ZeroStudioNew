...
public class DOMBuilder implements ContentHandler, LexicalHandler {
   ...
   * each-other: all startPrefixMapping events will occur before the corresponding startElement
   * event, and all endPrefixMapping events will occur after the corresponding endElement event, but
   ...
   * the values of the http://xml.org/sax/features/external-general-entities and the
