...
public class FuncExtFunction extends Function {
  ...
  /**
   * Unique method key, which is passed to ExtensionsTable#extFunction in order to allow caching of
   * the method.
   *
   * @serial
   */
  ...
  /**
   * Create a new FuncExtFunction based on the qualified name of the extension, and a unique method
   * key.
   *
