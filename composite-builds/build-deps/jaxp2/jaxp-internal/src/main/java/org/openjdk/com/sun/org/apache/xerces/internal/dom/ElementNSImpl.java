...
public class ElementNSImpl extends ElementImpl {
  ...
  private void setName(String namespaceURI, String qname) {
    ...
    if (colon1 < 0) {
      ...
      if (ownerDocument.errorChecking) {
        if (namespaceURI == null
            || (prefix.equals("xml") && !namespaceURI.equals(NamespaceContext.XML_URI))) {
          String msg =
              DOMMessageFormatter.formatMessage(
                  DOMMessageFormatter.DOM_DOMAIN, "NAMESPACE_ERR", null);
          throw new DOMException(DOMException.NAMESPACE_ERR, msg);
   ...
   * @exception INVALID_CHARACTER_ERR Raised if the specified prefix contains an invalid character.
