...
public class DatatypeFactoryImpl extends DatatypeFactory {
   ...
   * availabe using the <code>get</code> methods of the created {@link Duration}. The values conform
   ...
   * the namespace {@link org.openjdk.javax.xml.XMLConstants#W3C_XPATH_DATATYPE_NS_URI}.
   *
   ...
   *     XMLGregorianCalendar} or if the composite values constitute an invalid <code>
