...
public class XSModelGroupImpl implements XSModelGroup {
   ...
   * methods are used to return min/max range for a particle. They are not exactly the same as it's
   * described in the spec, but all the values from the spec are retrievable by these methods.
   */
