...
public abstract class DTDParser extends XMLGrammarParser
   ...
   * of the DTD entity by calling the startEntity method with the entity name "[dtd]"
   ...
   * content, then this method will not be called for that model. However, if this method is called
   ...
   *
   * <p><strong>Note:</strong> Children groups can be nested and have associated occurrence counts.
   *
   * @throws XNIException Thrown by handler to signal an error.
   * @see XMLElementDecl#TYPE_CHILDREN
   */
