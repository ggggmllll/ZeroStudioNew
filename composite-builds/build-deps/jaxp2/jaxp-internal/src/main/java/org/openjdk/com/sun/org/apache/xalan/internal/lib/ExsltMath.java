...
public class ExsltMath extends ExsltBase {
   ...
   * maximum value is defined as follows. The node set passed as an argument is sorted in descending
   * order as it would be by xsl:sort with a data type of number. The maximum is the result of
   * converting the string value of the first node in this sorted list to a number using the number
   * function.
   *
   ...
   * minimum value is defined as follows. The node set passed as an argument is sorted in ascending
   * order as it would be by xsl:sort with a data type of number. The minimum is the result of
   * converting the string value of the first node in this sorted list to a number using the number
   * function.
   *
   * <p>If the node set is empty, or if the result of converting the string values of any of the
   ...
   * for the node set. The maximum value for the node set is the same as the value as calculated by
   * math:max. A node has this maximum value if the result of converting its string value to a
   ...
   * return NaN. The definition numeric comparisons entails that NaN != NaN. Therefore if any of the
   * nodes in the node set has a non-numeric value, math:highest will return an empty node set.
   *
   * @param nl The NodeList for the node-set to be evaluated.
  ...
  /**
   * The math:lowest function returns the nodes in the node set whose value is the minimum value for
   * the node set. The minimum value for the node set is the same as the value as calculated by
   * math:min. A node has this minimum value if the result of converting its string value to a
   ...
   * return NaN. The definition numeric comparisons entails that NaN != NaN. Therefore if any of the
   * nodes in the node set has a non-numeric value, math:lowest will return an empty node set.
   *
   * @param nl The NodeList for the node-set to be evaluated.
