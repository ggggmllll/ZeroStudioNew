...
public class TransformerHandlerImpl implements TransformerHandler, DeclHandler {
  ...
  /**
   * Implements org.openjdk.javax.xml.transform.sax.TransformerHandler.getSystemId() Get the base ID
  ...
  /**
   * Implements org.openjdk.javax.xml.transform.sax.TransformerHandler.setSystemId() Get the base ID
   * (URI or system ID) from where relative URLs will be resolved.
   *
   ...
   * Transformer associated with this handler, which is needed in order to set parameters and output
   * properties.
   *
  ...
  /**
   * Implements org.openjdk.javax.xml.transform.sax.TransformerHandler.setResult() Enables the user
   * of the TransformerHandler to set the to set the Result for the transformation.
   *
