...
public class Constants extends org.openjdk.com.sun.org.apache.xml.internal.utils.Constants {
  ...
  /**
   * IDs for XSL element types. These are associated with the string literals in the TransformerImpl
   * class. Don't change the numbers. NOTE THAT THESE ARE NOT IN ALPHABETICAL ORDER! (It's a pity
   * Java doesn't have a real Enumerated Mnemonic datatype... or a C-like preprocessor in lieu
   * thereof which could be used to generate and maintain synch between these lists.)
   */
  ...
  /**
   * Literals for XSL element names. Note that there are more names than IDs, because some names map
   * to the same ID.
   */
   ...
   * TransformerImpl class. Don't change the numbers. NOTE THAT THESE ARE NOT IN ALPHABETICAL ORDER!
   */
   ...
   *       produce the output document. Generally the right choice if your stylesheet wants to take
   *       over _all_ the details of formatting, most often when producing something that isn't an
