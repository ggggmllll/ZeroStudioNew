...
public class XSAnnotationImpl implements XSAnnotation {
   ...
   * </code> object is a DOM in-scope namespace declarations for <code>annotation</code> element are
   * added as attributes nodes of the serialized <code>annotation</code>, otherwise the
   ...
   *     </code>, <code>org.xml.sax.ContentHandler</code>.
  ...
  /**
   * A namespace schema information item corresponding to the target namespace of the component, if
   * it's globally declared; or null otherwise.
   */
