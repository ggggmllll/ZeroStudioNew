...
public class XMLStreamReaderImpl implements org.openjdk.javax.xml.stream.XMLStreamReader {
  ...
  public XMLStreamReaderImpl(InputStream inputStream, String encoding, PropertyManager props)
    ...
    XMLInputSource inputSource =
        new XMLInputSource(null, null, null, new BufferedInputStream(inputStream), encoding);
    // pass the input source to document scanner impl.
    setInputSource(inputSource);
  }
  ...
  public void reset() {
    ...
    fBindNamespaces =
        ((Boolean) fPropertyManager.getProperty(XMLInputFactory.IS_NAMESPACE_AWARE)).booleanValue();
    versionStr = null;
  }
  ...
  public String getLocalName() {
    ...
    throw new IllegalStateException(
        "Method getLocalName() cannot be called for " + getEventTypeString(fEventType) + " event.");
  } // getLocalName()
  ...
  public void require(int type, String namespaceURI, String localName) throws XMLStreamException {
    ...
    if (localName != null && !localName.equals(getLocalName()))
      throw new XMLStreamException(
          "LocalName " + localName + " specified did not match with " + "current local name");
    return;
  }
  ...
  public int getTextCharacters(int sourceStart, char[] target, int targetStart, int length)
    ...
    System.arraycopy(
        getTextCharacters(), getTextStart() + sourceStart, target, targetStart, copiedLength);
    return copiedLength;
  }
   ...
   * END_ELEMENT is reached. If other than space characters are encountered, an exception is thrown.
   * This method should be used when processing element-only content because the parser is not able
   * to recognize ignorable whitespace if then DTD is missing or not interpreted.
   *
  ...
  public boolean standaloneSet() {
    // xxx: it requires if the standalone was set in the document ? This is different that if the
    // document
    // is standalone
