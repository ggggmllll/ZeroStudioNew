...
final class DocumentCall extends FunctionCall {
  ...
  /**
   * Type checks the arguments passed to the document() function. The first argument can be any type
   * (we must cast it to a string) and contains the URI of the document
   */
  ...
  public void translate(ClassGenerator classGen, MethodGenerator methodGen) {
    ...
    if (ac == 1) {
      ...
      docParamList =
          "(" + OBJECT_SIG + STRING_SIG + TRANSLET_SIG + DOM_INTF_SIG + ")" + NODE_ITERATOR_SIG;
