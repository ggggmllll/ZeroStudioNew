      ...
      if (isSAXSource || isStreamSource) {
        ...
        try {
          ...
          // Create the basic SAX2DTM.
            ...
            dtm =
                new SAX2DTM(this, source, documentID, whiteSpaceFilter, xstringFactory, doIndexing);
          }
  ...
  public synchronized int getDTMHandleFromNode(org.w3c.dom.Node node) {
    ...
    if (node instanceof DTMNodeProxy) return ((DTMNodeProxy) node).getDTMNodeNumber();
      ...
      DOM2DTM dtm =
          (DOM2DTM)
              getDTM(
                  new org.openjdk.javax.xml.transform.dom.DOMSource(root), false, null, true, true);
