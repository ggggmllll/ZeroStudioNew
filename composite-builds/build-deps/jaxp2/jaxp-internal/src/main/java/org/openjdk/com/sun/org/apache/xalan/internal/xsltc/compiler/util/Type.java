...
public abstract class Type implements Constants {
  ...
  /**
   * Translates an object of this type to an object of type <code>type</code>. Expects an object of
   * the former type and pushes an object of the latter.
   */
  ...
  /**
   * Translates object of this type to an object of type <code>type</code>. Expects an object of the
   * former type and pushes an object of the latter if not boolean. If type <code>type</code> is
   * boolean then a branchhandle list (to be appended to the false list) is returned.
   */
