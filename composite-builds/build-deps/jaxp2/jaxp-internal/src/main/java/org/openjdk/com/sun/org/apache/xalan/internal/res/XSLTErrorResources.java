  ...
  public Object[][] getContents() {
    return new Object[][] {
      ...
      },
      {
        ...
        "Redirect extension: Could not get filename - file or select attribute must return vald"
            + " string."
      },
      {
        ER_CANNOT_BUILD_FORMATTERLISTENER_IN_REDIRECT,
      ...
      {
        INVALID_TCHAR,
        "Illegal value: {1} used for CHAR attribute: {0}.  An attribute of type CHAR must be only 1"
            + " character!"
      },
      ...
      {
        ER_INVALID_NAMESPACE_URI_VALUE_FOR_RESULT_PREFIX_FOR_DEFAULT,
        "The result-prefix attribute of an xsl:namespace-alias element has the value '#default',"
            + " but there is no declaration of the default namespace in scope for the element"
      },
      {
        ER_INVALID_NAMESPACE_URI_VALUE_FOR_RESULT_PREFIX,
        "The result-prefix attribute of an xsl:namespace-alias element has the value ''{0}'', but"
            + " there is no namespace declaration for the prefix ''{0}'' in scope for the element."
      },
      {
        ER_SET_FEATURE_NULL_NAME,
        "The feature name cannot be null in TransformerFactory.setFeature(String name, boolean"
            + " value)."
      },
      {
      ...
      {
        ER_EXTENSION_ELEMENT_NOT_ALLOWED_IN_SECURE_PROCESSING,
        "Use of the extension element ''{0}'' is not allowed when the secure processing feature is"
            + " set to true."
      },
      ...
      {
        WG_EMPTY_SECOND_ARG,
        "Resulting nodeset from second argument of document function is empty. Return an empty"
            + " node-set."
      },
      ...
      {
        WG_PROCESSINGINSTRUCTION_NOTVALID_NCNAME,
        "The value of the ''name'' attribute of xsl:processing-instruction must be a valid NCName:"
            + " {0}"
      },
      ...
      // the attribute.
      {
        ...
        "Cannot add attribute {0} after child nodes or before an element is produced.  Attribute"
            + " will be ignored."
      },
      {
      ...
      {
        "xslProc_no_input",
        "Error: No stylesheet or input xml is specified. Run this command without any option for"
            + " usage instructions."
      },
