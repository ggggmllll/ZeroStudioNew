...
public class IncrementalSAXSource_Xerces implements IncrementalSAXSource {
  ...
  public IncrementalSAXSource_Xerces() throws NoSuchMethodException {
    try {
      ...
      Class fXniInputSourceClass =
          ObjectFactory.findProviderClass(
              "org.openjdk.com.sun.org.apache.xerces.internal.xni.parser.XMLInputSource", true);
  ...
  // ================================================================
  /**
   * Simple unit test. Attempt coroutine parsing of document indicated by first argument (as a URI),
   * report progress.
   */
