...
public abstract class CharacterDataImpl extends ChildNode {
   ...
   *
   * <p>This is important, because we do one type of Range fix-up, from the high-level functions in
   * CharacterData, and another type if the client simply calls setNodeValue(value).
   */
  ...
  /**
   * Sets the content, possibly firing related events, and updating ranges (via notification to the
   * document)
   */
