...
public class XMLEntityManager implements XMLComponent, XMLEntityResolver {
   ...
   * size property is not specified. REVISIT: do we need a property for internal entity buffer size?
   */
   ...
   *     the entity where <em>the entity being added</em> and is used to expand the system
   *     identifier when the system identifier is a relative URI. When null the system identifier of
   *     the first external entity on the stack is used instead.
   * @see SymbolTable
   */
  ...
  /**
   * Sets the entity handler. When an entity starts and ends, the entity handler is notified of the
   * change.
   *
  ...
  public StaxXMLInputSource resolveEntityAsPerStax(XMLResourceIdentifier resourceIdentifier)
    ...
    // this works for both stax & Xerces, if staxInputSource is null, it means parser need to revert
    ...
    if (staxInputSource == null) {
      ...
      // if (systemId != null)
      staxInputSource =
          new StaxXMLInputSource(new XMLInputSource(publicId, literalSystemId, baseSystemId));
  ...
  /**
   * Resolves the specified public and system identifiers. This method first attempts to resolve the
   * entity based on the EntityResolver registered by the application. If no entity resolver is
   * registered or if the registered entity handler is unable to resolve the entity, then default
   * entity resolution will occur.
   *
   * @param publicId The public identifier of the entity.
   * @param systemId The system identifier of the entity.
   * @param baseSystemId The base system identifier of the entity. This is the system identifier of
   *     the current entity and is used to expand the system identifier when the system identifier
   *     is a relative URI.
        ...
        if (fLoadExternalDTD) {
          String accessError =
              SecuritySupport.checkAccess(
                  expandedSystemId, fAccessExternalDTD, Constants.ACCESS_EXTERNAL_ALL);
          if (accessError != null) {
            fErrorReporter.reportError(
                this.getEntityScanner(),
                XMLMessageFormatter.XML_DOMAIN,
   ...
   * Starts an entity.
   *
   * <p>This method can be used to insert an application defined XML entity stream into the parsing
   * stream.
   *
   * @param name The name of the entity.
      ...
      try {
        if (fLimitAnalyzer != null) {
          fLimitAnalyzer.endEntity(
              XMLSecurityManager.Limit.GENERAL_ENTITY_SIZE_LIMIT, fCurrentEntity.name);
  ...
  public void reset(XMLComponentManager componentManager) throws XMLConfigurationException {
    ...
    fStaxEntityResolver =
        (StaxEntityResolverWrapper) componentManager.getProperty(STAX_ENTITY_RESOLVER, null);
  ...
  public static String expandSystemId(String systemId, String baseSystemId, boolean strict)
    ...
    try {
      ...
      /**
       * Xerces URI rejects unicode, try java.net.URI this is not ideal solution, but it covers
       * known cases which either Xerces URI or java.net.URI can handle alone will file bug against
       * java.net.URI
       */
      try {
  ...
  private static String expandSystemIdStrictOff(String systemId, String baseSystemId)
    ...
    if (systemURI.isAbsoluteURI()) {
      ...
      /**
       * If the scheme's length is only one character, it's likely that this was intended as a file
       * path. Fixing this up in expandSystemId to maintain backwards compatibility.
       */
   ...
   *
   * <p>The return value is the expanded system identifier of the document entity or of the external
   ...
   *
   * <p>The return value is the literal system identifier of the document entity or of the external
   * parsed entity in which the markup triggering the event appears.
   *
   * <p>
   *
  ...
  protected final class RewindableInputStream extends InputStream {
    ...
    public int read(byte[] b, int off, int len) throws IOException {
      ...
      if (bytesLeft == 0) {
         ...
         * //System.out.println("fInputStream = " + fInputStream ); // better get some more for the
         * voracious reader...
         */
