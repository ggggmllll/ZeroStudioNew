...
abstract class SetupAapt2Task : DefaultTask() {
  ...
  companion object {
    ...
    // private val AAPT2_CHECKSUMS = mapOf(
     // /** "arm64-v8a" */ BuildConfig.ABI_ARM64_V8A to "be2cea61814678f7a9e61bf818a6666e6097a7d67d6c19498a4d7aa690bc4151",
      // /*"armeabi-v7a"*/ BuildConfig.ABI_ARMEABI_V7A to "ba3413c680933dffd3c3d35da8d450c474ff5ccab95c4b9db28841c53b7a3cdf",
      // /**"x86_64"*/ BuildConfig.ABI_X86_64 to "4861171c1efcffe41f4466937e6a392b243ffb014813b4e60f0b77bb46ab254d"
    // )

    private val AAPT2_CHECKSUMS = mapOf(
     /** "arm64-v8a" */ BuildConfig.ABI_ARM64_V8A to BuildConfig.ABI_ARM64_V8A_AAPT2_CHECKSUMS, /**"be2cea61814678f7a9e61bf818a6666e6097a7d67d6c19498a4d7aa690bc4151",*/
      /*"armeabi-v7a"*/ BuildConfig.ABI_ARMEABI_V7A to BuildConfig.ABI_ARMEABI_V7A_AAPT2_CHECKSUMS, /**"ba3413c680933dffd3c3d35da8d450c474ff5ccab95c4b9db28841c53b7a3cdf",*/
      /**"x86_64"*/ BuildConfig.ABI_X86_64 to BuildConfig.ABI_X86_64_AAPT2_CHECKSUMS /**"4861171c1efcffe41f4466937e6a392b243ffb014813b4e60f0b77bb46ab254d"*/
    )

    private const val DEFAULT_VERSION = /*"34.0.4"*/ BuildConfig.SetupAapt2Task
