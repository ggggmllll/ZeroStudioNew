...
public class WrapperDefaults {
  public static final String SCRIPT_PATH = /**"gradlew"*/ BuildConfig.SCRIPT_PATH;
  public static final String JAR_FILE_PATH = BuildConfig.JAR_FILE_PATH /**"gradle/wrapper/gradle-wrapper.jar"*/;
